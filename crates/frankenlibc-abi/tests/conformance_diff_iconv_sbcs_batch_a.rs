//! Differential gate: batch A of newly-added ASCII-compatible single-byte codecs
//! (bd-4tgqly) — ISO_10367-BOX, IEC_P27-1, WIN-SAMI-2, ISO-IR-209 — plus their
...
#[test]
fn sbcs_batch_a_decode_encode_matches_glibc() {
    let gg = g();
