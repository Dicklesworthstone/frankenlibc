...
fn stable_keys() -> Vec<(c_int, &'static str)> {
    vec![
        ...
        (libc::_SC_XOPEN_REALTIME_THREADS, "_SC_XOPEN_REALTIME_THREADS"),
        ...
        (libc::_SC_THREAD_PRIORITY_SCHEDULING, "_SC_THREAD_PRIORITY_SCHEDULING"),
        ...
        (libc::_SC_THREAD_DESTRUCTOR_ITERATIONS, "_SC_THREAD_DESTRUCTOR_ITERATIONS"),
