//! Differential gate: f128 catanhf128 matches glibc bit-for-bit (bd-9z5ikz).
//! Was a garbage CDoubleComplex-ABI stub. The fix ports glibc's s_catanh
//! template (inf/NaN/zero lattice + large-operand + near-unit-circle branches)
//! over CFloat128Complex, built on byte-exact log/log1p/hypot/atan2/x2y2m1 →
//! byte-exact.
#![cfg(target_os = "linux")]
#![feature(f128)]
#![allow(unsafe_code)]
...
fn parts() -> Vec<f128> {
    ...
    let mut st: u64 = 0x6361_7461_6e68_3132;
    for _ in 0..30 {
