...
fn wchar_subprocess_child_invocation() {
    ...
    if helper == "wcwidth-utf8" {
        ...
        const CASES: &[(u32, &str)] = &[
            ...
            (0x0900, "DEVANAGARI SIGN INVERTED CANDRABINDU (Mn)"),
            (0x093C, "DEVANAGARI SIGN NUKTA (Mn)"),
            (0x094D, "DEVANAGARI SIGN VIRAMA (Mn)"),
            (0x0981, "BENGALI SIGN CANDRABINDU (Mn)"),
            (0x09CD, "BENGALI SIGN VIRAMA (Mn)"),
            (0x0A4D, "GURMUKHI SIGN VIRAMA (Mn)"),
            (0x0B4D, "ODIA SIGN VIRAMA (Mn)"),
            (0x0BCD, "TAMIL SIGN VIRAMA (Mn)"),
            (0x0C4D, "TELUGU SIGN VIRAMA (Mn)"),
            (0x0CCD, "KANNADA SIGN VIRAMA (Mn)"),
            (0x0D4D, "MALAYALAM SIGN VIRAMA (Mn)"),
            (0x0DCA, "SINHALA SIGN AL-LAKUNA (Mn)"),
            (0x0E31, "THAI CHARACTER MAI HAN-AKAT (Mn)"),
            (0x0E34, "THAI CHARACTER SARA I (Mn)"),
            (0x0E4E, "THAI CHARACTER YAMAKKAN (Mn)"),
            (0x0F71, "TIBETAN VOWEL SIGN AA (Mn)"),
