...
fn load_fixture() -> FixtureFile {
    let path = repo_root().join("tests/conformance/fixtures/unistd_process_filesystem_wave07.json");
...
#[test]
fn unistd_process_filesystem_wave07_fixture_exists_and_names_campaign() {
    let path = repo_root().join("tests/conformance/fixtures/unistd_process_filesystem_wave07.json");
    assert!(
        path.exists(),
...
#[test]
fn unistd_process_filesystem_wave07_covers_first_wave_in_both_modes() {
    let fixture = load_fixture();
...
#[test]
fn unistd_process_filesystem_wave07_logs_without_ambient_leaks() {
    let fixture = load_fixture();
    assert_eq!(
...
#[test]
fn unistd_process_filesystem_wave07_spec_reference_names_required_surfaces() {
    let fixture = load_fixture();
    for token in [
        "GNU dngettext",
        "GNU eaccess",
...
#[test]
fn unistd_process_filesystem_wave07_coverage_artifacts_bind_first_wave() {
...
#[test]
fn unistd_process_filesystem_wave07_executes_via_isolated_harness() {
    let fixture = load_fixture();
    assert!(
