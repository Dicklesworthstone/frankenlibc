...
#[test]
fn string_memory_hotpaths_wave06_fixture_exists_and_names_campaign() {
    let path = repo_root().join("tests/conformance/fixtures/string_memory_hotpaths_wave06.json");
    assert!(
        path.exists(),
...
#[test]
fn string_memory_hotpaths_wave06_covers_first_wave_in_both_modes() {
    let fixture = load_fixture();
...
#[test]
fn string_memory_hotpaths_wave06_logs_without_ambient_leaks() {
    let fixture = load_fixture();
    assert_eq!(
...
#[test]
fn string_memory_hotpaths_wave06_spec_reference_names_required_surfaces() {
    let fixture = load_fixture();
    assert!(
...
#[test]
fn string_memory_hotpaths_wave06_executes_via_isolated_harness() {
    let fixture = load_fixture();
    assert_eq!(
        fixture.cases.len(),
