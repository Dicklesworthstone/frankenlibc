...
#[test]
fn rpc_legacy_network_wave02_fixture_exists_and_names_campaign() -> Result<(), String> {
    let path = repo_root()?.join("tests/conformance/fixtures/rpc_legacy_network_wave02.json");
    assert!(
        path.exists(),
...
#[test]
fn rpc_legacy_network_wave02_covers_symbols_in_both_modes() -> Result<(), String> {
    let fixture = load_fixture()?;
...
#[test]
fn rpc_legacy_network_wave02_cases_bind_expected_behavior_and_log_fields() -> Result<(), String> {
    let fixture = load_fixture()?;
    assert_eq!(
...
#[test]
fn rpc_legacy_network_wave02_spec_reference_names_required_surfaces() -> Result<(), String> {
    let fixture = load_fixture()?;
    assert!(
...
#[test]
fn rpc_legacy_network_wave02_fixture_executes_via_isolated_harness() -> Result<(), String> {
    let fixture = load_fixture()?;
    assert_eq!(
        fixture.cases.len(),
