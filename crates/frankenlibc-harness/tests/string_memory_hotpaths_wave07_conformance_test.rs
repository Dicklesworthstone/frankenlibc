//! Deterministic wave-07 string/memory hot-path fixture tests.
//!
//! Run: cargo test -p frankenlibc-harness --test string_memory_hotpaths_wave07_conformance_test
...
fn string_memory_hotpaths_wave07_fixture_exists_and_names_campaign() -> Result<(), String> {
    ...
    assert_eq!(fixture.campaign.wave_id, "wave-07-string-memory-hotpaths");
    assert_eq!(
...
fn string_memory_hotpaths_wave07_spec_reference_names_required_surfaces() -> Result<(), String> {
    ...
    assert!(
        fixture.spec_reference.contains("GNU libc")
            ...
            && fixture.spec_reference.contains("mutation")
            && fixture.spec_reference.contains("iteration")
