...
fn claim_reconciliation_detects_readme_smoke_summary_drift_and_routes_owner() {
    ...
    let canonical = "Canonical checked smoke artifact: `tests/conformance/ld_preload_smoke_summary.v1.json` (run `rc0923-corpus-20260924T095919Z`, checked September 24, 2026) reports 162 passes / 0 fails / 4 skips overall, with strict 81/0/2 and hardened 81/0/2 across the curated preload smoke battery.";
