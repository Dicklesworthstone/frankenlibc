...
fn load_fixture() -> FixtureFile {
    let path = repo_root().join("tests/conformance/fixtures/unistd_process_filesystem_wave04.json");
...
#[test]
fn unistd_process_filesystem_wave04_fixture_exists_and_names_campaign() {
    let path = repo_root().join("tests/conformance/fixtures/unistd_process_filesystem_wave04.json");
    assert!(
        path.exists(),
...
#[test]
fn unistd_process_filesystem_wave04_covers_first_wave_in_both_modes() {
    let fixture = load_fixture();
...
#[test]
fn unistd_process_filesystem_wave04_logs_without_ambient_leaks() {
    let fixture = load_fixture();
    assert_eq!(
...
#[test]
fn unistd_process_filesystem_wave04_spec_reference_names_required_surfaces() {
    let fixture = load_fixture();
    assert!(
...
#[test]
fn unistd_process_filesystem_wave04_executes_via_isolated_harness() {
    let fixture = load_fixture();
    assert_eq!(
        fixture.cases.len(),
