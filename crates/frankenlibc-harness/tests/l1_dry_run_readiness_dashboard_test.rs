    ...
    let mut expected_rows: BTreeMap<&str, (&str, Value)> = [
        ...
        (
            ...
            (
                ...
                json!(
                    "The declared L1 interpose level remains the current taxonomy level, and the L1 objective gate passes: the real-world preload corpus (run rc0923-corpus-20260924T125933Z: git, sed, grep, awk, find, tar, make, perl, C++ and Python C-extension programs, TZ-aware time, GNU argp tools, iconv, named-locale formatting and collation, wide ctype, getaddrinfo ordering, glibc-mangled setjmp/longjmp, C++ exceptions through libc callbacks) is green in both strict and hardened modes with no tracked known failures."
                ),
            ),
        ),
        (
...
fn ld_preload_smoke_rows_are_explicit() -> TestResult {
    ...
    let mut expected_rows: BTreeMap<&str, (&str, Value)> = [
        ...
        (
            ...
            ("run_id", json!("rc0923-corpus-20260924T125933Z")),
        ),
        (
        ...
        (
            ...
            ("summary.total_cases", json!(188)),
        ),
        ("ld-preload-smoke-passes", ("summary.passes", json!(184))),
