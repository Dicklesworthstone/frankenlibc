...
//! `crates/frankenlibc-harness/tests/` references `tokio`
//! (bd-40rcy). Paired CLI contract gates are synchronous
//! Command-spawn-and-assert tests; tokio in a gate would indicate
//! async pollution from copy-paste of unrelated infrastructure
//! code, or a misguided attempt to parallelize what should already
//! be parallelized at the cargo test runner level.
