...
//! `crates/frankenlibc-harness/tests/` declares a `macro_rules!`
//! macro (bd-gcuq7). Paired gates should be straight-line code that
//! a reader can scan to verify the asserted invariant; macros at
//! the test-file level indicate over-engineering or accidentally
//! copy-pasted production helpers that belong elsewhere.
