//! Deterministic poll/event-loop fixture wave-02 tests.
//!
//! Run: cargo test -p frankenlibc-harness --test poll_event_loop_wave02_conformance_test
...
const FIRST_WAVE_SYMBOLS: &[&str] = &["timerfd_settime"];
...
fn load_fixture() -> Result<FixtureFile, String> {
    let path = repo_root()?.join("tests/conformance/fixtures/poll_event_loop_wave02.json");
...
#[test]
fn poll_event_loop_wave02_fixture_exists_and_names_campaign() -> Result<(), String> {
    let path = repo_root()?.join("tests/conformance/fixtures/poll_event_loop_wave02.json");
    assert!(
        path.exists(),
        "poll_event_loop_wave02.json fixture must exist"
    );

    let fixture = load_fixture()?;
    assert_eq!(fixture.version, "v1");
    assert_eq!(fixture.family, "poll_event_loop_wave02");
    assert_eq!(fixture.campaign.bead, "bd-r5k32.6");
    assert_eq!(fixture.campaign.campaign_id, "fcq-poll-event-loop");
    assert_eq!(fixture.campaign.wave_id, "wave-02-poll-event-loop");
    assert_eq!(
    ...
    assert!(
        fixture.description.contains("descriptor numbers")
            ...
            && fixture.description.contains("wall-clock samples")
...
#[test]
fn poll_event_loop_wave02_covers_first_wave_in_both_modes() -> Result<(), String> {
    let fixture = load_fixture()?;
...
#[test]
fn poll_event_loop_wave02_logs_without_ambient_leaks() -> Result<(), String> {
    let fixture = load_fixture()?;
    assert_eq!(
...
#[test]
fn poll_event_loop_wave02_spec_reference_names_required_surfaces() -> Result<(), String> {
    let fixture = load_fixture()?;
...
#[test]
fn poll_event_loop_wave02_executes_via_isolated_harness() -> Result<(), String> {
    let fixture = load_fixture()?;
    for case in &fixture.cases {
