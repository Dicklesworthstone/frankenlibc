...
#[test]
fn string_memory_hotpaths_wave12_fixture_exists_and_names_campaign() {
    let path = repo_root().join("tests/conformance/fixtures/string_memory_hotpaths_wave12.json");
    assert!(
        path.exists(),
...
#[test]
fn string_memory_hotpaths_wave12_covers_first_wave_in_both_modes() {
    let fixture = load_fixture();
...
#[test]
fn string_memory_hotpaths_wave12_logs_without_ambient_leaks() {
    let fixture = load_fixture();
    assert_eq!(
...
#[test]
fn string_memory_hotpaths_wave12_spec_reference_names_required_surfaces() {
    let fixture = load_fixture();
...
#[test]
fn string_memory_hotpaths_wave12_executes_via_isolated_harness() {
    let fixture = load_fixture();
    for case in &fixture.cases {
