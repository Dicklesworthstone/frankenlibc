...
#[test]
fn resolver_nss_core_wave01_fixture_exists_and_names_campaign() {
    let path = repo_root().join("tests/conformance/fixtures/resolver_nss_core_wave01.json");
    assert!(
        path.exists(),
...
#[test]
fn resolver_nss_core_wave01_covers_first_wave_in_both_modes() {
    let fixture = load_fixture();
...
#[test]
fn resolver_nss_core_wave01_logs_without_ambient_leaks() {
    let fixture = load_fixture();
    assert_eq!(
...
#[test]
fn resolver_nss_core_wave01_spec_reference_names_required_surfaces() {
    let fixture = load_fixture();
...
#[test]
fn resolver_nss_core_wave01_executes_via_isolated_harness() {
    let fixture = load_fixture();
    for case in &fixture.cases {
