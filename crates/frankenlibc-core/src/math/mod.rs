...
pub use float32::{
    ...
    hypotf, ilogbf, ldexpf, lgammaf, llrintf, llroundf, log1pf, log2f, log10f, logbf, logf, lrintf,
    lroundf, modff, nearbyintf, nextafterf, powf, remainderf, rintf, roundf, scalblnf, scalbnf,
    sinf, sinhf, sqrtf, tanf, tanhf, tgammaf, truncf,
};
