...
enum Encoding {
    ...
    /// CP424: EBCDIC Hebrew.
    Cp424,
    /// CP880: EBCDIC Cyrillic Multilingual.
    Cp880,
    ...
    /// CP1132: EBCDIC Lao.
    Cp1132,
    /// CP1137: EBCDIC Devanagari.
    Cp1137,
    /// CP1141: EBCDIC code page 1141.
    Cp1141,
    /// CP1142: EBCDIC code page 1142.
    Cp1142,
    /// CP1143: EBCDIC code page 1143.
    Cp1143,
    /// CP1144: EBCDIC code page 1144.
    Cp1144,
    /// CP1145: EBCDIC code page 1145.
    Cp1145,
    /// CP1146: EBCDIC code page 1146.
    Cp1146,
    /// CP1147: EBCDIC code page 1147.
    Cp1147,
    /// CP1148: EBCDIC code page 1148.
    Cp1148,
    /// CP1149: EBCDIC code page 1149.
    Cp1149,
    /// CP12712: EBCDIC code page 12712.
    Cp12712,
    /// CP16804: EBCDIC code page 16804.
    Cp16804,
    /// CP4517: EBCDIC code page 4517.
    Cp4517,
    /// CP4971: EBCDIC code page 4971.
    Cp4971,
    Cp866Nav,
    DecMcs,
    HpRoman9,
...
const PHASE1_CODEC_TABLE: [CodecSpec; 194] = [
    CodecSpec {
    ...
    CodecSpec {
        encoding: Encoding::Cp1025,
        canonical: "CP1025",
        normalized: "CP1025",
        aliases: &["CSIBM1025", "IBM1025"],
    },
    CodecSpec {
        encoding: Encoding::Cp1026,
        canonical: "CP1026",
        normalized: "CP1026",
        aliases: &["CSIBM1026", "IBM1026"],
    },
    CodecSpec {
        encoding: Encoding::Cp420,
        canonical: "CP420",
        normalized: "CP420",
        aliases: &["CSIBM420", "EBCDICCPAR1", "IBM420"],
    },
    CodecSpec {
        encoding: Encoding::Cp424,
        canonical: "CP424",
        normalized: "CP424",
        aliases: &["CSIBM424", "EBCDICCPHE", "IBM424"],
    },
    CodecSpec {
        encoding: Encoding::Cp880,
        canonical: "CP880",
        normalized: "CP880",
        aliases: &["CSIBM880", "EBCDICCYRILLIC", "IBM880"],
    },
    CodecSpec {
        encoding: Encoding::Cp1112,
        canonical: "CP1112",
        normalized: "CP1112",
        aliases: &["CSIBM1112", "IBM1112"],
    },
    CodecSpec {
        encoding: Encoding::Cp1122,
        canonical: "CP1122",
        normalized: "CP1122",
        aliases: &["CSIBM1122", "IBM1122"],
    },
    CodecSpec {
        encoding: Encoding::Cp1123,
        canonical: "CP1123",
        normalized: "CP1123",
        aliases: &["CSIBM1123", "IBM1123"],
    },
    CodecSpec {
        encoding: Encoding::Cp1130,
        canonical: "CP1130",
        normalized: "CP1130",
        aliases: &["CSIBM1130", "IBM1130"],
    },
    CodecSpec {
        encoding: Encoding::Cp1132,
        canonical: "CP1132",
        normalized: "CP1132",
        aliases: &["CSIBM1132", "IBM1132"],
    },
    CodecSpec {
        encoding: Encoding::Cp1137,
        canonical: "CP1137",
        normalized: "CP1137",
        aliases: &["CSIBM1137", "IBM1137"],
    },
    CodecSpec {
        encoding: Encoding::Cp1141,
        canonical: "CP1141",
        normalized: "CP1141",
        aliases: &["CSIBM1141", "IBM1141"],
    },
    CodecSpec {
        encoding: Encoding::Cp1142,
        canonical: "CP1142",
        normalized: "CP1142",
        aliases: &["CSIBM1142", "IBM1142"],
    },
    CodecSpec {
        encoding: Encoding::Cp1143,
        canonical: "CP1143",
        normalized: "CP1143",
        aliases: &["CSIBM1143", "IBM1143"],
    },
    CodecSpec {
        encoding: Encoding::Cp1144,
        canonical: "CP1144",
        normalized: "CP1144",
        aliases: &["CSIBM1144", "IBM1144"],
    },
    CodecSpec {
        encoding: Encoding::Cp1145,
        canonical: "CP1145",
        normalized: "CP1145",
        aliases: &["CSIBM1145", "IBM1145"],
    },
    CodecSpec {
        encoding: Encoding::Cp1146,
        canonical: "CP1146",
        normalized: "CP1146",
        aliases: &["CSIBM1146", "IBM1146"],
    },
    CodecSpec {
        encoding: Encoding::Cp1147,
        canonical: "CP1147",
        normalized: "CP1147",
        aliases: &["CSIBM1147", "IBM1147"],
    },
    CodecSpec {
        encoding: Encoding::Cp1148,
        canonical: "CP1148",
        normalized: "CP1148",
        aliases: &["CSIBM1148", "IBM1148"],
    },
    CodecSpec {
        encoding: Encoding::Cp1149,
        canonical: "CP1149",
        normalized: "CP1149",
        aliases: &["CSIBM1149", "IBM1149"],
    },
    CodecSpec {
        encoding: Encoding::Cp12712,
        canonical: "CP12712",
        normalized: "CP12712",
        aliases: &["CSIBM12712", "IBM12712"],
    },
    CodecSpec {
        encoding: Encoding::Cp16804,
        canonical: "CP16804",
        normalized: "CP16804",
        aliases: &["CSIBM16804", "IBM16804"],
    },
    CodecSpec {
        encoding: Encoding::Cp4517,
        canonical: "CP4517",
        normalized: "CP4517",
        aliases: &["CSIBM4517", "IBM4517"],
    },
    CodecSpec {
        encoding: Encoding::Cp4971,
        canonical: "CP4971",
        normalized: "CP4971",
        aliases: &["CSIBM4971", "IBM4971"],
    },
    CodecSpec {
...
/// Variable-length encoder for single-byte codecs whose glibc encode decomposes
/// some precomposed code points into a multi-byte (base + combining) sequence —
/// e.g. Windows/Vietnamese CP1258, TCVN, and Hebrew CP1255, where a precomposed
/// letter encodes to a spacing letter byte followed by a combining-mark byte.
/// `enc` is sorted by code point and maps each representable code point to its
/// exact glibc byte sequence (1-3 bytes). Code points absent from the table are
/// `Unrepresentable` (EILSEQ), matching glibc.
fn encode_sbcs_mb(ch: char, out: &mut [u8], enc: &[(u16, &[u8])]) -> Result<usize, EncodeError> {
    let cp = ch as u32;
    if cp > u32::from(u16::MAX) {
        return Err(EncodeError::Unrepresentable);
    }
...
const CP1255_FULL: [u16; 256] = [
    ...
    0x05B8, 0x05B9, 0xFFFF, 0x05BB, 0x05BC, 0x05BD, 0x05BE, 0x05BF, // C8-CF
...
const CP1255_MBENC: &[(u16, &[u8])] = &[
    ...
    (0x2122, &[0x99]), (0xFB1D, &[0xE9, 0xC4]), (0xFB1F, &[0xD6, 0xC7]), (0xFB2A, &[0xF9, 0xD1]),
    (0xFB2B, &[0xF9, 0xD2]), (0xFB2C, &[0xF9, 0xCC, 0xD1]), (0xFB2D, &[0xF9, 0xCC, 0xD2]), (0xFB2E, &[0xE0, 0xC7]),
    (0xFB2F, &[0xE0, 0xC8]), (0xFB30, &[0xE0, 0xCC]), (0xFB31, &[0xE1, 0xCC]), (0xFB32, &[0xE2, 0xCC]),
    (0xFB33, &[0xE3, 0xCC]), (0xFB34, &[0xE4, 0xCC]), (0xFB35, &[0xE5, 0xCC]), (0xFB36, &[0xE6, 0xCC]),
    (0xFB38, &[0xE8, 0xCC]), (0xFB39, &[0xE9, 0xCC]), (0xFB3A, &[0xEA, 0xCC]), (0xFB3B, &[0xEB, 0xCC]),
    (0xFB3C, &[0xEC, 0xCC]), (0xFB3E, &[0xEE, 0xCC]), (0xFB40, &[0xF0, 0xCC]), (0xFB41, &[0xF1, 0xCC]),
    (0xFB43, &[0xF3, 0xCC]), (0xFB44, &[0xF4, 0xCC]), (0xFB46, &[0xF6, 0xCC]), (0xFB47, &[0xF7, 0xCC]),
    (0xFB48, &[0xF8, 0xCC]), (0xFB49, &[0xF9, 0xCC]), (0xFB4A, &[0xFA, 0xCC]), (0xFB4B, &[0xE5, 0xC9]),
    (0xFB4C, &[0xE1, 0xCF]), (0xFB4D, &[0xEB, 0xCF]), (0xFB4E, &[0xF4, 0xCF]),
];

fn decode_cp1255(input: &[u8]) -> Result<(char, usize), DecodeError> {
    decode_sbcs_full(input, &CP1255_FULL)
}

fn encode_cp1255(ch: char, out: &mut [u8]) -> Result<usize, EncodeError> {
    encode_sbcs_mb(ch, out, CP1255_MBENC)
}
...
const CP1258_MBENC: &[(u16, &[u8])] = &[
    ...
    (0x00C0, &[0xC0]), (0x00C1, &[0xC1]), (0x00C2, &[0xC2]), (0x00C3, &[0x41, 0xDE]),
    (0x00C4, &[0xC4]), (0x00C5, &[0xC5]), (0x00C6, &[0xC6]), (0x00C7, &[0xC7]),
    (0x00C8, &[0xC8]), (0x00C9, &[0xC9]), (0x00CA, &[0xCA]), (0x00CB, &[0xCB]),
    (0x00CC, &[0x49, 0xCC]), (0x00CD, &[0xCD]), (0x00CE, &[0xCE]), (0x00CF, &[0xCF]),
    (0x00D1, &[0xD1]), (0x00D2, &[0x4F, 0xCC]), (0x00D3, &[0xD3]), (0x00D4, &[0xD4]),
    (0x00D5, &[0x4F, 0xDE]), (0x00D6, &[0xD6]), (0x00D7, &[0xD7]), (0x00D8, &[0xD8]),
    (0x00D9, &[0xD9]), (0x00DA, &[0xDA]), (0x00DB, &[0xDB]), (0x00DC, &[0xDC]),
    (0x00DD, &[0x59, 0xEC]), (0x00DF, &[0xDF]), (0x00E0, &[0xE0]), (0x00E1, &[0xE1]),
    (0x00E2, &[0xE2]), (0x00E3, &[0x61, 0xDE]), (0x00E4, &[0xE4]), (0x00E5, &[0xE5]),
    (0x00E6, &[0xE6]), (0x00E7, &[0xE7]), (0x00E8, &[0xE8]), (0x00E9, &[0xE9]),
    (0x00EA, &[0xEA]), (0x00EB, &[0xEB]), (0x00EC, &[0x69, 0xCC]), (0x00ED, &[0xED]),
    (0x00EE, &[0xEE]), (0x00EF, &[0xEF]), (0x00F1, &[0xF1]), (0x00F2, &[0x6F, 0xCC]),
    (0x00F3, &[0xF3]), (0x00F4, &[0xF4]), (0x00F5, &[0x6F, 0xDE]), (0x00F6, &[0xF6]),
    (0x00F7, &[0xF7]), (0x00F8, &[0xF8]), (0x00F9, &[0xF9]), (0x00FA, &[0xFA]),
    (0x00FB, &[0xFB]), (0x00FC, &[0xFC]), (0x00FD, &[0x79, 0xEC]), (0x00FF, &[0xFF]),
    (0x0102, &[0xC3]), (0x0103, &[0xE3]), (0x0106, &[0x43, 0xEC]), (0x0107, &[0x63, 0xEC]),
    (0x0110, &[0xD0]), (0x0111, &[0xF0]), (0x0128, &[0x49, 0xDE]), (0x0129, &[0x69, 0xDE]),
    (0x0139, &[0x4C, 0xEC]), (0x013A, &[0x6C, 0xEC]), (0x0143, &[0x4E, 0xEC]), (0x0144, &[0x6E, 0xEC]),
    (0x0152, &[0x8C]), (0x0153, &[0x9C]), (0x0154, &[0x52, 0xEC]), (0x0155, &[0x72, 0xEC]),
    (0x015A, &[0x53, 0xEC]), (0x015B, &[0x73, 0xEC]), (0x0168, &[0x55, 0xDE]), (0x0169, &[0x75, 0xDE]),
    (0x0178, &[0x9F]), (0x0179, &[0x5A, 0xEC]), (0x017A, &[0x7A, 0xEC]), (0x0192, &[0x83]),
    (0x01A0, &[0xD5]), (0x01A1, &[0xF5]), (0x01AF, &[0xDD]), (0x01B0, &[0xFD]),
    (0x01D7, &[0xDC, 0xEC]), (0x01D8, &[0xFC, 0xEC]), (0x01DB, &[0xDC, 0xCC]), (0x01DC, &[0xFC, 0xCC]),
    (0x01F4, &[0x47, 0xEC]), (0x01F5, &[0x67, 0xEC]), (0x01F8, &[0x4E, 0xCC]), (0x01F9, &[0x6E, 0xCC]),
    (0x01FA, &[0xC5, 0xEC]), (0x01FB, &[0xE5, 0xEC]), (0x01FC, &[0xC6, 0xEC]), (0x01FD, &[0xE6, 0xEC]),
    (0x01FE, &[0xD8, 0xEC]), (0x01FF, &[0xF8, 0xEC]), (0x02C6, &[0x88]), (0x02DC, &[0x98]),
    (0x0300, &[0xCC]), (0x0301, &[0xEC]), (0x0303, &[0xDE]), (0x0309, &[0xD2]),
    (0x0323, &[0xF2]), (0x0340, &[0xCC]), (0x0341, &[0xEC]), (0x0385, &[0xA8, 0xEC]),
    (0x1E04, &[0x42, 0xF2]), (0x1E05, &[0x62, 0xF2]), (0x1E08, &[0xC7, 0xEC]), (0x1E09, &[0xE7, 0xEC]),
    (0x1E0C, &[0x44, 0xF2]), (0x1E0D, &[0x64, 0xF2]), (0x1E24, &[0x48, 0xF2]), (0x1E25, &[0x68, 0xF2]),
    (0x1E2E, &[0xCF, 0xEC]), (0x1E2F, &[0xEF, 0xEC]), (0x1E30, &[0x4B, 0xEC]), (0x1E31, &[0x6B, 0xEC]),
    (0x1E32, &[0x4B, 0xF2]), (0x1E33, &[0x6B, 0xF2]), (0x1E36, &[0x4C, 0xF2]), (0x1E37, &[0x6C, 0xF2]),
    (0x1E3E, &[0x4D, 0xEC]), (0x1E3F, &[0x6D, 0xEC]), (0x1E42, &[0x4D, 0xF2]), (0x1E43, &[0x6D, 0xF2]),
    (0x1E46, &[0x4E, 0xF2]), (0x1E47, &[0x6E, 0xF2]), (0x1E4C, &[0xD3, 0xDE]), (0x1E4D, &[0xF3, 0xDE]),
    (0x1E4E, &[0xD6, 0xDE]), (0x1E4F, &[0xF6, 0xDE]), (0x1E54, &[0x50, 0xEC]), (0x1E55, &[0x70, 0xEC]),
    (0x1E5A, &[0x52, 0xF2]), (0x1E5B, &[0x72, 0xF2]), (0x1E62, &[0x53, 0xF2]), (0x1E63, &[0x73, 0xF2]),
    (0x1E6C, &[0x54, 0xF2]), (0x1E6D, &[0x74, 0xF2]), (0x1E78, &[0xDA, 0xDE]), (0x1E79, &[0xFA, 0xDE]),
    (0x1E7C, &[0x56, 0xDE]), (0x1E7D, &[0x76, 0xDE]), (0x1E7E, &[0x56, 0xF2]), (0x1E7F, &[0x76, 0xF2]),
    (0x1E80, &[0x57, 0xCC]), (0x1E81, &[0x77, 0xCC]), (0x1E82, &[0x57, 0xEC]), (0x1E83, &[0x77, 0xEC]),
    (0x1E88, &[0x57, 0xF2]), (0x1E89, &[0x77, 0xF2]), (0x1E92, &[0x5A, 0xF2]), (0x1E93, &[0x7A, 0xF2]),
    (0x1EA0, &[0x41, 0xF2]), (0x1EA1, &[0x61, 0xF2]), (0x1EA2, &[0x41, 0xD2]), (0x1EA3, &[0x61, 0xD2]),
    (0x1EA4, &[0xC2, 0xEC]), (0x1EA5, &[0xE2, 0xEC]), (0x1EA6, &[0xC2, 0xCC]), (0x1EA7, &[0xE2, 0xCC]),
    (0x1EA8, &[0xC2, 0xD2]), (0x1EA9, &[0xE2, 0xD2]), (0x1EAA, &[0xC2, 0xDE]), (0x1EAB, &[0xE2, 0xDE]),
    (0x1EAC, &[0xC2, 0xF2]), (0x1EAD, &[0xE2, 0xF2]), (0x1EAE, &[0xC3, 0xEC]), (0x1EAF, &[0xE3, 0xEC]),
    (0x1EB0, &[0xC3, 0xCC]), (0x1EB1, &[0xE3, 0xCC]), (0x1EB2, &[0xC3, 0xD2]), (0x1EB3, &[0xE3, 0xD2]),
    (0x1EB4, &[0xC3, 0xDE]), (0x1EB5, &[0xE3, 0xDE]), (0x1EB6, &[0xC3, 0xF2]), (0x1EB7, &[0xE3, 0xF2]),
    (0x1EB8, &[0x45, 0xF2]), (0x1EB9, &[0x65, 0xF2]), (0x1EBA, &[0x45, 0xD2]), (0x1EBB, &[0x65, 0xD2]),
    (0x1EBC, &[0x45, 0xDE]), (0x1EBD, &[0x65, 0xDE]), (0x1EBE, &[0xCA, 0xEC]), (0x1EBF, &[0xEA, 0xEC]),
    (0x1EC0, &[0xCA, 0xCC]), (0x1EC1, &[0xEA, 0xCC]), (0x1EC2, &[0xCA, 0xD2]), (0x1EC3, &[0xEA, 0xD2]),
    (0x1EC4, &[0xCA, 0xDE]), (0x1EC5, &[0xEA, 0xDE]), (0x1EC6, &[0xCA, 0xF2]), (0x1EC7, &[0xEA, 0xF2]),
    (0x1EC8, &[0x49, 0xD2]), (0x1EC9, &[0x69, 0xD2]), (0x1ECA, &[0x49, 0xF2]), (0x1ECB, &[0x69, 0xF2]),
    (0x1ECC, &[0x4F, 0xF2]), (0x1ECD, &[0x6F, 0xF2]), (0x1ECE, &[0x4F, 0xD2]), (0x1ECF, &[0x6F, 0xD2]),
    (0x1ED0, &[0xD4, 0xEC]), (0x1ED1, &[0xF4, 0xEC]), (0x1ED2, &[0xD4, 0xCC]), (0x1ED3, &[0xF4, 0xCC]),
    (0x1ED4, &[0xD4, 0xD2]), (0x1ED5, &[0xF4, 0xD2]), (0x1ED6, &[0xD4, 0xDE]), (0x1ED7, &[0xF4, 0xDE]),
    (0x1ED8, &[0xD4, 0xF2]), (0x1ED9, &[0xF4, 0xF2]), (0x1EDA, &[0xD5, 0xEC]), (0x1EDB, &[0xF5, 0xEC]),
    (0x1EDC, &[0xD5, 0xCC]), (0x1EDD, &[0xF5, 0xCC]), (0x1EDE, &[0xD5, 0xD2]), (0x1EDF, &[0xF5, 0xD2]),
    (0x1EE0, &[0xD5, 0xDE]), (0x1EE1, &[0xF5, 0xDE]), (0x1EE2, &[0xD5, 0xF2]), (0x1EE3, &[0xF5, 0xF2]),
    (0x1EE4, &[0x55, 0xF2]), (0x1EE5, &[0x75, 0xF2]), (0x1EE6, &[0x55, 0xD2]), (0x1EE7, &[0x75, 0xD2]),
    (0x1EE8, &[0xDD, 0xEC]), (0x1EE9, &[0xFD, 0xEC]), (0x1EEA, &[0xDD, 0xCC]), (0x1EEB, &[0xFD, 0xCC]),
    (0x1EEC, &[0xDD, 0xD2]), (0x1EED, &[0xFD, 0xD2]), (0x1EEE, &[0xDD, 0xDE]), (0x1EEF, &[0xFD, 0xDE]),
    (0x1EF0, &[0xDD, 0xF2]), (0x1EF1, &[0xFD, 0xF2]), (0x1EF2, &[0x59, 0xCC]), (0x1EF3, &[0x79, 0xCC]),
    (0x1EF4, &[0x59, 0xF2]), (0x1EF5, &[0x79, 0xF2]), (0x1EF6, &[0x59, 0xD2]), (0x1EF7, &[0x79, 0xD2]),
    (0x1EF8, &[0x59, 0xDE]), (0x1EF9, &[0x79, 0xDE]), (0x1FED, &[0xA8, 0xCC]), (0x1FEE, &[0xA8, 0xEC]),
...
const CP864_FULL: [u16; 256] = [
    0x0000, 0x0001, 0x0002, 0x0003, 0x0004, 0x0005, 0x0006, 0x0007, // 00-07
    0x0008, 0x0009, 0x000A, 0x000B, 0x000C, 0x000D, 0x000E, 0x000F, // 08-0F
    0x0010, 0x0011, 0x0012, 0x0013, 0x0014, 0x0015, 0x0016, 0x0017, // 10-17
    0x0018, 0x0019, 0x001A, 0x001B, 0x001C, 0x001D, 0x001E, 0x001F, // 18-1F
    0x0020, 0x0021, 0x0022, 0x0023, 0x0024, 0x066A, 0x0026, 0x0027, // 20-27
    0x0028, 0x0029, 0x002A, 0x002B, 0x002C, 0x002D, 0x002E, 0x002F, // 28-2F
    0x0030, 0x0031, 0x0032, 0x0033, 0x0034, 0x0035, 0x0036, 0x0037, // 30-37
    0x0038, 0x0039, 0x003A, 0x003B, 0x003C, 0x003D, 0x003E, 0x003F, // 38-3F
    0x0040, 0x0041, 0x0042, 0x0043, 0x0044, 0x0045, 0x0046, 0x0047, // 40-47
...
const CP864_FULL_ENC: &[(u16, u8)] = &[
    ...
    (0x0020,0x20),(0x0021,0x21),(0x0022,0x22),(0x0023,0x23),(0x0024,0x24),(0x0026,0x26),(0x0027,0x27),(0x0028,0x28),
    (0x0029,0x29),(0x002A,0x2A),(0x002B,0x2B),(0x002C,0x2C),(0x002D,0x2D),(0x002E,0x2E),(0x002F,0x2F),(0x0030,0x30),
    (0x0031,0x31),(0x0032,0x32),(0x0033,0x33),(0x0034,0x34),(0x0035,0x35),(0x0036,0x36),(0x0037,0x37),(0x0038,0x38),
    (0x0039,0x39),(0x003A,0x3A),(0x003B,0x3B),(0x003C,0x3C),(0x003D,0x3D),(0x003E,0x3E),(0x003F,0x3F),(0x0040,0x40),
    (0x0041,0x41),(0x0042,0x42),(0x0043,0x43),(0x0044,0x44),(0x0045,0x45),(0x0046,0x46),(0x0047,0x47),(0x0048,0x48),
    (0x0049,0x49),(0x004A,0x4A),(0x004B,0x4B),(0x004C,0x4C),(0x004D,0x4D),(0x004E,0x4E),(0x004F,0x4F),(0x0050,0x50),
    (0x0051,0x51),(0x0052,0x52),(0x0053,0x53),(0x0054,0x54),(0x0055,0x55),(0x0056,0x56),(0x0057,0x57),(0x0058,0x58),
    (0x0059,0x59),(0x005A,0x5A),(0x005B,0x5B),(0x005C,0x5C),(0x005D,0x5D),(0x005E,0x5E),(0x005F,0x5F),(0x0060,0x60),
    ...
    (0x0079,0x79),(0x007A,0x7A),(0x007B,0x7B),(0x007C,0x7C),(0x007D,0x7D),(0x007E,0x7E),(0x007F,0x7F),(0x00A0,0xA0),
    (0x00A2,0xC0),(0x00A3,0xA3),(0x00A4,0xA4),(0x00A6,0xDB),(0x00AB,0x97),(0x00AC,0xDC),(0x00AD,0xA1),(0x00B0,0x80),
    (0x00B1,0x93),(0x00B7,0x81),(0x00BB,0x98),(0x00BC,0x95),(0x00BD,0x94),(0x00D7,0xDE),(0x00F7,0xDD),(0x03B2,0x90),
    (0x03C6,0x92),(0x060C,0xAC),(0x061B,0xBB),(0x061F,0xBF),(0x0640,0xE0),(0x0651,0xF1),(0x0660,0xB0),(0x0661,0xB1),
    (0x0662,0xB2),(0x0663,0xB3),(0x0664,0xB4),(0x0665,0xB5),(0x0666,0xB6),(0x0667,0xB7),(0x0668,0xB8),(0x0669,0xB9),
    (0x066A,0x25),(0x2219,0x82),(0x221A,0x83),(0x221E,0x91),(0x2248,0x96),(0x2500,0x85),(0x2502,0x86),(0x250C,0x8D),
    (0x2510,0x8C),(0x2514,0x8E),(0x2518,0x8F),(0x251C,0x8A),(0x2524,0x88),(0x252C,0x89),(0x2534,0x8B),(0x253C,0x87),
    (0x2592,0x84),(0x25A0,0xFE),(0xFE7D,0xF0),(0xFE80,0xC1),(0xFE81,0xC2),(0xFE82,0xA2),(0xFE83,0xC3),(0xFE84,0xA5),
    (0xFE85,0xC4),(0xFE8B,0xC6),(0xFE8D,0xC7),(0xFE8E,0xA8),(0xFE8F,0xA9),(0xFE91,0xC8),(0xFE93,0xC9),(0xFE95,0xAA),
    (0xFE97,0xCA),(0xFE99,0xAB),(0xFE9B,0xCB),(0xFE9D,0xAD),(0xFE9F,0xCC),(0xFEA1,0xAE),(0xFEA3,0xCD),(0xFEA5,0xAF),
    (0xFEA7,0xCE),(0xFEA9,0xCF),(0xFEAB,0xD0),(0xFEAD,0xD1),(0xFEAF,0xD2),(0xFEB1,0xBC),(0xFEB3,0xD3),(0xFEB5,0xBD),
    (0xFEB7,0xD4),(0xFEB9,0xBE),(0xFEBB,0xD5),(0xFEBD,0xEB),(0xFEBF,0xD6),(0xFEC1,0xD7),(0xFEC5,0xD8),(0xFEC9,0xDF),
    (0xFECA,0xC5),(0xFECB,0xD9),(0xFECC,0xEC),(0xFECD,0xEE),(0xFECE,0xED),(0xFECF,0xDA),(0xFED0,0xF7),(0xFED1,0xBA),
    (0xFED3,0xE1),(0xFED5,0xF8),(0xFED7,0xE2),(0xFED9,0xFC),(0xFEDB,0xE3),(0xFEDD,0xFB),(0xFEDF,0xE4),(0xFEE1,0xEF),
    (0xFEE3,0xE5),(0xFEE5,0xF2),(0xFEE7,0xE6),(0xFEE9,0xF3),(0xFEEB,0xE7),(0xFEEC,0xF4),(0xFEED,0xE8),(0xFEEF,0xE9),
    (0xFEF0,0xF5),(0xFEF1,0xFD),(0xFEF2,0xF6),(0xFEF3,0xEA),(0xFEF5,0xF9),(0xFEF6,0xFA),(0xFEF7,0x99),(0xFEF8,0x9A),
    (0xFEFB,0x9D),(0xFEFC,0x9E),
];

fn decode_cp864(input: &[u8]) -> Result<(char, usize), DecodeError> {
    decode_sbcs_full(input, &CP864_FULL)
}

fn encode_cp864(ch: char, out: &mut [u8]) -> Result<usize, EncodeError> {
    encode_sbcs_full(ch, out, CP864_FULL_ENC)
}
...
const VISCII_FULL: [u16; 256] = [
    0x0000, 0x0001, 0x1EB2, 0x0003, 0x0004, 0x1EB4, 0x1EAA, 0x0007, // 00-07
    0x0008, 0x0009, 0x000A, 0x000B, 0x000C, 0x000D, 0x000E, 0x000F, // 08-0F
    0x0010, 0x0011, 0x0012, 0x0013, 0x1EF6, 0x0015, 0x0016, 0x0017, // 10-17
    0x0018, 0x1EF8, 0x001A, 0x001B, 0x001C, 0x001D, 0x1EF4, 0x001F, // 18-1F
    0x0020, 0x0021, 0x0022, 0x0023, 0x0024, 0x0025, 0x0026, 0x0027, // 20-27
    0x0028, 0x0029, 0x002A, 0x002B, 0x002C, 0x002D, 0x002E, 0x002F, // 28-2F
    0x0030, 0x0031, 0x0032, 0x0033, 0x0034, 0x0035, 0x0036, 0x0037, // 30-37
    0x0038, 0x0039, 0x003A, 0x003B, 0x003C, 0x003D, 0x003E, 0x003F, // 38-3F
    ...
    0x0070, 0x0071, 0x0072, 0x0073, 0x0074, 0x0075, 0x0076, 0x0077, // 70-77
    0x0078, 0x0079, 0x007A, 0x007B, 0x007C, 0x007D, 0x007E, 0x007F, // 78-7F
    0x1EA0, 0x1EAE, 0x1EB0, 0x1EB6, 0x1EA4, 0x1EA6, 0x1EA8, 0x1EAC, // 80-87
    0x1EBC, 0x1EB8, 0x1EBE, 0x1EC0, 0x1EC2, 0x1EC4, 0x1EC6, 0x1ED0, // 88-8F
    0x1ED2, 0x1ED4, 0x1ED6, 0x1ED8, 0x1EE2, 0x1EDA, 0x1EDC, 0x1EDE, // 90-97
    0x1ECA, 0x1ECE, 0x1ECC, 0x1EC8, 0x1EE6, 0x0168, 0x1EE4, 0x1EF2, // 98-9F
    0x00D5, 0x1EAF, 0x1EB1, 0x1EB7, 0x1EA5, 0x1EA7, 0x1EA9, 0x1EAD, // A0-A7
    0x1EBD, 0x1EB9, 0x1EBF, 0x1EC1, 0x1EC3, 0x1EC5, 0x1EC7, 0x1ED1, // A8-AF
    0x1ED3, 0x1ED5, 0x1ED7, 0x1EE0, 0x01A0, 0x1ED9, 0x1EDD, 0x1EDF, // B0-B7
    0x1ECB, 0x1EF0, 0x1EE8, 0x1EEA, 0x1EEC, 0x01A1, 0x1EDB, 0x01AF, // B8-BF
    0x00C0, 0x00C1, 0x00C2, 0x00C3, 0x1EA2, 0x0102, 0x1EB3, 0x1EB5, // C0-C7
    0x00C8, 0x00C9, 0x00CA, 0x1EBA, 0x00CC, 0x00CD, 0x0128, 0x1EF3, // C8-CF
    0x0110, 0x1EE9, 0x00D2, 0x00D3, 0x00D4, 0x1EA1, 0x1EF7, 0x1EEB, // D0-D7
    0x1EED, 0x00D9, 0x00DA, 0x1EF9, 0x1EF5, 0x00DD, 0x1EE1, 0x01B0, // D8-DF
    0x00E0, 0x00E1, 0x00E2, 0x00E3, 0x1EA3, 0x0103, 0x1EEF, 0x1EAB, // E0-E7
    0x00E8, 0x00E9, 0x00EA, 0x1EBB, 0x00EC, 0x00ED, 0x0129, 0x1EC9, // E8-EF
    0x0111, 0x1EF1, 0x00F2, 0x00F3, 0x00F4, 0x00F5, 0x1ECF, 0x1ECD, // F0-F7
    0x1EE5, 0x00F9, 0x00FA, 0x0169, 0x1EE7, 0x00FD, 0x1EE3, 0x1EEE, // F8-FF
];

const VISCII_FULL_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0003,0x03),(0x0004,0x04),(0x0007,0x07),(0x0008,0x08),(0x0009,0x09),(0x000A,0x0A),
    (0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),(0x0010,0x10),(0x0011,0x11),(0x0012,0x12),
    (0x0013,0x13),(0x0015,0x15),(0x0016,0x16),(0x0017,0x17),(0x0018,0x18),(0x001A,0x1A),(0x001B,0x1B),(0x001C,0x1C),
    (0x001D,0x1D),(0x001F,0x1F),(0x0020,0x20),(0x0021,0x21),(0x0022,0x22),(0x0023,0x23),(0x0024,0x24),(0x0025,0x25),
    ...
    (0x003E,0x3E),(0x003F,0x3F),(0x0040,0x40),(0x0041,0x41),(0x0042,0x42),(0x0043,0x43),(0x0044,0x44),(0x0045,0x45),
    ...
    (0x0056,0x56),(0x0057,0x57),(0x0058,0x58),(0x0059,0x59),(0x005A,0x5A),(0x005B,0x5B),(0x005C,0x5C),(0x005D,0x5D),
    (0x005E,0x5E),(0x005F,0x5F),(0x0060,0x60),(0x0061,0x61),(0x0062,0x62),(0x0063,0x63),(0x0064,0x64),(0x0065,0x65),
    (0x0066,0x66),(0x0067,0x67),(0x0068,0x68),(0x0069,0x69),(0x006A,0x6A),(0x006B,0x6B),(0x006C,0x6C),(0x006D,0x6D),
    (0x006E,0x6E),(0x006F,0x6F),(0x0070,0x70),(0x0071,0x71),(0x0072,0x72),(0x0073,0x73),(0x0074,0x74),(0x0075,0x75),
    (0x0076,0x76),(0x0077,0x77),(0x0078,0x78),(0x0079,0x79),(0x007A,0x7A),(0x007B,0x7B),(0x007C,0x7C),(0x007D,0x7D),
    (0x007E,0x7E),(0x007F,0x7F),(0x00C0,0xC0),(0x00C1,0xC1),(0x00C2,0xC2),(0x00C3,0xC3),(0x00C8,0xC8),(0x00C9,0xC9),
    (0x00CA,0xCA),(0x00CC,0xCC),(0x00CD,0xCD),(0x00D2,0xD2),(0x00D3,0xD3),(0x00D4,0xD4),(0x00D5,0xA0),(0x00D9,0xD9),
    (0x00DA,0xDA),(0x00DD,0xDD),(0x00E0,0xE0),(0x00E1,0xE1),(0x00E2,0xE2),(0x00E3,0xE3),(0x00E8,0xE8),(0x00E9,0xE9),
    (0x00EA,0xEA),(0x00EC,0xEC),(0x00ED,0xED),(0x00F2,0xF2),(0x00F3,0xF3),(0x00F4,0xF4),(0x00F5,0xF5),(0x00F9,0xF9),
    (0x00FA,0xFA),(0x00FD,0xFD),(0x0102,0xC5),(0x0103,0xE5),(0x0110,0xD0),(0x0111,0xF0),(0x0128,0xCE),(0x0129,0xEE),
    (0x0168,0x9D),(0x0169,0xFB),(0x01A0,0xB4),(0x01A1,0xBD),(0x01AF,0xBF),(0x01B0,0xDF),(0x1EA0,0x80),(0x1EA1,0xD5),
    (0x1EA2,0xC4),(0x1EA3,0xE4),(0x1EA4,0x84),(0x1EA5,0xA4),(0x1EA6,0x85),(0x1EA7,0xA5),(0x1EA8,0x86),(0x1EA9,0xA6),
    (0x1EAA,0x06),(0x1EAB,0xE7),(0x1EAC,0x87),(0x1EAD,0xA7),(0x1EAE,0x81),(0x1EAF,0xA1),(0x1EB0,0x82),(0x1EB1,0xA2),
    (0x1EB2,0x02),(0x1EB3,0xC6),(0x1EB4,0x05),(0x1EB5,0xC7),(0x1EB6,0x83),(0x1EB7,0xA3),(0x1EB8,0x89),(0x1EB9,0xA9),
    (0x1EBA,0xCB),(0x1EBB,0xEB),(0x1EBC,0x88),(0x1EBD,0xA8),(0x1EBE,0x8A),(0x1EBF,0xAA),(0x1EC0,0x8B),(0x1EC1,0xAB),
    (0x1EC2,0x8C),(0x1EC3,0xAC),(0x1EC4,0x8D),(0x1EC5,0xAD),(0x1EC6,0x8E),(0x1EC7,0xAE),(0x1EC8,0x9B),(0x1EC9,0xEF),
    (0x1ECA,0x98),(0x1ECB,0xB8),(0x1ECC,0x9A),(0x1ECD,0xF7),(0x1ECE,0x99),(0x1ECF,0xF6),(0x1ED0,0x8F),(0x1ED1,0xAF),
    (0x1ED2,0x90),(0x1ED3,0xB0),(0x1ED4,0x91),(0x1ED5,0xB1),(0x1ED6,0x92),(0x1ED7,0xB2),(0x1ED8,0x93),(0x1ED9,0xB5),
    (0x1EDA,0x95),(0x1EDB,0xBE),(0x1EDC,0x96),(0x1EDD,0xB6),(0x1EDE,0x97),(0x1EDF,0xB7),(0x1EE0,0xB3),(0x1EE1,0xDE),
    (0x1EE2,0x94),(0x1EE3,0xFE),(0x1EE4,0x9E),(0x1EE5,0xF8),(0x1EE6,0x9C),(0x1EE7,0xFC),(0x1EE8,0xBA),(0x1EE9,0xD1),
    (0x1EEA,0xBB),(0x1EEB,0xD7),(0x1EEC,0xBC),(0x1EED,0xD8),(0x1EEE,0xFF),(0x1EEF,0xE6),(0x1EF0,0xB9),(0x1EF1,0xF1),
    (0x1EF2,0x9F),(0x1EF3,0xCF),(0x1EF4,0x1E),(0x1EF5,0xDC),(0x1EF6,0x14),(0x1EF7,0xD6),(0x1EF8,0x19),(0x1EF9,0xDB),
];

fn decode_viscii(input: &[u8]) -> Result<(char, usize), DecodeError> {
    decode_sbcs_full(input, &VISCII_FULL)
}

fn encode_viscii(ch: char, out: &mut [u8]) -> Result<usize, EncodeError> {
    encode_sbcs_full(ch, out, VISCII_FULL_ENC)
}

/// TCVN (TCVN5712-1, VN3 Vietnamese) to Unicode mapping for bytes 0x80-0xFF.
const TCVN_FULL: [u16; 256] = [
    0x0000, 0x00DA, 0x1EE4, 0x0003, 0x1EEA, 0x1EEC, 0x1EEE, 0x0007, // 00-07
    0x0008, 0x0009, 0x000A, 0x000B, 0x000C, 0x000D, 0x000E, 0x000F, // 08-0F
    0x0010, 0x1EE8, 0x1EF0, 0x1EF2, 0x1EF6, 0x1EF8, 0x00DD, 0x1EF4, // 10-17
    0x0018, 0x0019, 0x001A, 0x001B, 0x001C, 0x001D, 0x001E, 0x001F, // 18-1F
    0x0020, 0x0021, 0x0022, 0x0023, 0x0024, 0x0025, 0x0026, 0x0027, // 20-27
    0x0028, 0x0029, 0x002A, 0x002B, 0x002C, 0x002D, 0x002E, 0x002F, // 28-2F
    0x0030, 0x0031, 0x0032, 0x0033, 0x0034, 0x0035, 0x0036, 0x0037, // 30-37
    ...
    0x0070, 0x0071, 0x0072, 0x0073, 0x0074, 0x0075, 0x0076, 0x0077, // 70-77
    0x0078, 0x0079, 0x007A, 0x007B, 0x007C, 0x007D, 0x007E, 0x007F, // 78-7F
    0x00C0, 0x1EA2, 0x00C3, 0x00C1, 0x1EA0, 0x1EB6, 0x1EAC, 0x00C8, // 80-87
    0x1EBA, 0x1EBC, 0x00C9, 0x1EB8, 0x1EC6, 0x00CC, 0x1EC8, 0x0128, // 88-8F
    0x00CD, 0x1ECA, 0x00D2, 0x1ECE, 0x00D5, 0x00D3, 0x1ECC, 0x1ED8, // 90-97
    0x1EDC, 0x1EDE, 0x1EE0, 0x1EDA, 0x1EE2, 0x00D9, 0x1EE6, 0x0168, // 98-9F
    0x00A0, 0x0102, 0x00C2, 0x00CA, 0x00D4, 0x01A0, 0x01AF, 0x0110, // A0-A7
    0x0103, 0x00E2, 0x00EA, 0x00F4, 0x01A1, 0x01B0, 0x0111, 0x1EB0, // A8-AF
    0x0300, 0x0309, 0x0303, 0x0301, 0x0323, 0x00E0, 0x1EA3, 0x00E3, // B0-B7
    0x00E1, 0x1EA1, 0x1EB2, 0x1EB1, 0x1EB3, 0x1EB5, 0x1EAF, 0x1EB4, // B8-BF
    0x1EAE, 0x1EA6, 0x1EA8, 0x1EAA, 0x1EA4, 0x1EC0, 0x1EB7, 0x1EA7, // C0-C7
    0x1EA9, 0x1EAB, 0x1EA5, 0x1EAD, 0x00E8, 0x1EC2, 0x1EBB, 0x1EBD, // C8-CF
    0x00E9, 0x1EB9, 0x1EC1, 0x1EC3, 0x1EC5, 0x1EBF, 0x1EC7, 0x00EC, // D0-D7
    0x1EC9, 0x1EC4, 0x1EBE, 0x1ED2, 0x0129, 0x00ED, 0x1ECB, 0x00F2, // D8-DF
    0x1ED4, 0x1ECF, 0x00F5, 0x00F3, 0x1ECD, 0x1ED3, 0x1ED5, 0x1ED7, // E0-E7
    0x1ED1, 0x1ED9, 0x1EDD, 0x1EDF, 0x1EE1, 0x1EDB, 0x1EE3, 0x00F9, // E8-EF
    0x1ED6, 0x1EE7, 0x0169, 0x00FA, 0x1EE5, 0x1EEB, 0x1EED, 0x1EEF, // F0-F7
    0x1EE9, 0x1EF1, 0x1EF3, 0x1EF7, 0x1EF9, 0x00FD, 0x1EF5, 0x1ED0, // F8-FF
];

const TCVN_MBENC: &[(u16, &[u8])] = &[
    (0x0000, &[0x00]), (0x0003, &[0x03]), (0x0007, &[0x07]), (0x0008, &[0x08]),
    (0x0009, &[0x09]), (0x000A, &[0x0A]), (0x000B, &[0x0B]), (0x000C, &[0x0C]),
    (0x000D, &[0x0D]), (0x000E, &[0x0E]), (0x000F, &[0x0F]), (0x0010, &[0x10]),
    (0x0018, &[0x18]), (0x0019, &[0x19]), (0x001A, &[0x1A]), (0x001B, &[0x1B]),
    (0x001C, &[0x1C]), (0x001D, &[0x1D]), (0x001E, &[0x1E]), (0x001F, &[0x1F]),
    (0x0020, &[0x20]), (0x0021, &[0x21]), (0x0022, &[0x22]), (0x0023, &[0x23]),
    (0x0024, &[0x24]), (0x0025, &[0x25]), (0x0026, &[0x26]), (0x0027, &[0x27]),
    ...
    (0x0078, &[0x78]), (0x0079, &[0x79]), (0x007A, &[0x7A]), (0x007B, &[0x7B]),
    (0x007C, &[0x7C]), (0x007D, &[0x7D]), (0x007E, &[0x7E]), (0x007F, &[0x7F]),
    (0x00A0, &[0xA0]), (0x00C0, &[0x80]), (0x00C1, &[0x83]), (0x00C2, &[0xA2]),
    (0x00C3, &[0x82]), (0x00C8, &[0x87]), (0x00C9, &[0x8A]), (0x00CA, &[0xA3]),
    (0x00CC, &[0x8D]), (0x00CD, &[0x90]), (0x00D1, &[0x4E, 0xB2]), (0x00D2, &[0x92]),
    (0x00D3, &[0x95]), (0x00D4, &[0xA4]), (0x00D5, &[0x94]), (0x00D9, &[0x9D]),
    (0x00DA, &[0x01]), (0x00DD, &[0x16]), (0x00E0, &[0xB5]), (0x00E1, &[0xB8]),
    (0x00E2, &[0xA9]), (0x00E3, &[0xB7]), (0x00E8, &[0xCC]), (0x00E9, &[0xD0]),
    (0x00EA, &[0xAA]), (0x00EC, &[0xD7]), (0x00ED, &[0xDD]), (0x00F1, &[0x6E, 0xB2]),
    (0x00F2, &[0xDF]), (0x00F3, &[0xE3]), (0x00F4, &[0xAB]), (0x00F5, &[0xE2]),
    (0x00F9, &[0xEF]), (0x00FA, &[0xF3]), (0x00FD, &[0xFD]), (0x0102, &[0xA1]),
    (0x0103, &[0xA8]), (0x0106, &[0x43, 0xB3]), (0x0107, &[0x63, 0xB3]), (0x0110, &[0xA7]),
    (0x0111, &[0xAE]), (0x0128, &[0x8F]), (0x0129, &[0xDC]), (0x0139, &[0x4C, 0xB3]),
    (0x013A, &[0x6C, 0xB3]), (0x0143, &[0x4E, 0xB3]), (0x0144, &[0x6E, 0xB3]), (0x0154, &[0x52, 0xB3]),
    (0x0155, &[0x72, 0xB3]), (0x015A, &[0x53, 0xB3]), (0x015B, &[0x73, 0xB3]), (0x0168, &[0x9F]),
    (0x0169, &[0xF2]), (0x0179, &[0x5A, 0xB3]), (0x017A, &[0x7A, 0xB3]), (0x01A0, &[0xA5]),
    (0x01A1, &[0xAC]), (0x01AF, &[0xA6]), (0x01B0, &[0xAD]), (0x01F4, &[0x47, 0xB3]),
    (0x01F5, &[0x67, 0xB3]), (0x01F8, &[0x4E, 0xB0]), (0x01F9, &[0x6E, 0xB0]), (0x0300, &[0xB0]),
    (0x0301, &[0xB3]), (0x0303, &[0xB2]), (0x0309, &[0xB1]), (0x0323, &[0xB4]),
    (0x1E04, &[0x42, 0xB4]), (0x1E05, &[0x62, 0xB4]), (0x1E0C, &[0x44, 0xB4]), (0x1E0D, &[0x64, 0xB4]),
    (0x1E24, &[0x48, 0xB4]), (0x1E25, &[0x68, 0xB4]), (0x1E30, &[0x4B, 0xB3]), (0x1E31, &[0x6B, 0xB3]),
    (0x1E32, &[0x4B, 0xB4]), (0x1E33, &[0x6B, 0xB4]), (0x1E36, &[0x4C, 0xB4]), (0x1E37, &[0x6C, 0xB4]),
    (0x1E3E, &[0x4D, 0xB3]), (0x1E3F, &[0x6D, 0xB3]), (0x1E42, &[0x4D, 0xB4]), (0x1E43, &[0x6D, 0xB4]),
    (0x1E46, &[0x4E, 0xB4]), (0x1E47, &[0x6E, 0xB4]), (0x1E54, &[0x50, 0xB3]), (0x1E55, &[0x70, 0xB3]),
    (0x1E5A, &[0x52, 0xB4]), (0x1E5B, &[0x72, 0xB4]), (0x1E62, &[0x53, 0xB4]), (0x1E63, &[0x73, 0xB4]),
    (0x1E6C, &[0x54, 0xB4]), (0x1E6D, &[0x74, 0xB4]), (0x1E7C, &[0x56, 0xB2]), (0x1E7D, &[0x76, 0xB2]),
    (0x1E7E, &[0x56, 0xB4]), (0x1E7F, &[0x76, 0xB4]), (0x1E80, &[0x57, 0xB0]), (0x1E81, &[0x77, 0xB0]),
    (0x1E82, &[0x57, 0xB3]), (0x1E83, &[0x77, 0xB3]), (0x1E88, &[0x57, 0xB4]), (0x1E89, &[0x77, 0xB4]),
    (0x1E92, &[0x5A, 0xB4]), (0x1E93, &[0x7A, 0xB4]), (0x1EA0, &[0x84]), (0x1EA1, &[0xB9]),
    (0x1EA2, &[0x81]), (0x1EA3, &[0xB6]), (0x1EA4, &[0xC4]), (0x1EA5, &[0xCA]),
    (0x1EA6, &[0xC1]), (0x1EA7, &[0xC7]), (0x1EA8, &[0xC2]), (0x1EA9, &[0xC8]),
    (0x1EAA, &[0xC3]), (0x1EAB, &[0xC9]), (0x1EAC, &[0x86]), (0x1EAD, &[0xCB]),
    (0x1EAE, &[0xC0]), (0x1EAF, &[0xBE]), (0x1EB0, &[0xAF]), (0x1EB1, &[0xBB]),
    (0x1EB2, &[0xBA]), (0x1EB3, &[0xBC]), (0x1EB4, &[0xBF]), (0x1EB5, &[0xBD]),
    (0x1EB6, &[0x85]), (0x1EB7, &[0xC6]), (0x1EB8, &[0x8B]), (0x1EB9, &[0xD1]),
    (0x1EBA, &[0x88]), (0x1EBB, &[0xCE]), (0x1EBC, &[0x89]), (0x1EBD, &[0xCF]),
    (0x1EBE, &[0xDA]), (0x1EBF, &[0xD5]), (0x1EC0, &[0xC5]), (0x1EC1, &[0xD2]),
    (0x1EC2, &[0xCD]), (0x1EC3, &[0xD3]), (0x1EC4, &[0xD9]), (0x1EC5, &[0xD4]),
    (0x1EC6, &[0x8C]), (0x1EC7, &[0xD6]), (0x1EC8, &[0x8E]), (0x1EC9, &[0xD8]),
    (0x1ECA, &[0x91]), (0x1ECB, &[0xDE]), (0x1ECC, &[0x96]), (0x1ECD, &[0xE4]),
    (0x1ECE, &[0x93]), (0x1ECF, &[0xE1]), (0x1ED0, &[0xFF]), (0x1ED1, &[0xE8]),
    (0x1ED2, &[0xDB]), (0x1ED3, &[0xE5]), (0x1ED4, &[0xE0]), (0x1ED5, &[0xE6]),
    (0x1ED6, &[0xF0]), (0x1ED7, &[0xE7]), (0x1ED8, &[0x97]), (0x1ED9, &[0xE9]),
    (0x1EDA, &[0x9B]), (0x1EDB, &[0xED]), (0x1EDC, &[0x98]), (0x1EDD, &[0xEA]),
    (0x1EDE, &[0x99]), (0x1EDF, &[0xEB]), (0x1EE0, &[0x9A]), (0x1EE1, &[0xEC]),
    (0x1EE2, &[0x9C]), (0x1EE3, &[0xEE]), (0x1EE4, &[0x02]), (0x1EE5, &[0xF4]),
    (0x1EE6, &[0x9E]), (0x1EE7, &[0xF1]), (0x1EE8, &[0x11]), (0x1EE9, &[0xF8]),
    (0x1EEA, &[0x04]), (0x1EEB, &[0xF5]), (0x1EEC, &[0x05]), (0x1EED, &[0xF6]),
    (0x1EEE, &[0x06]), (0x1EEF, &[0xF7]), (0x1EF0, &[0x12]), (0x1EF1, &[0xF9]),
    (0x1EF2, &[0x13]), (0x1EF3, &[0xFA]), (0x1EF4, &[0x17]), (0x1EF5, &[0xFE]),
    (0x1EF6, &[0x14]), (0x1EF7, &[0xFB]), (0x1EF8, &[0x15]), (0x1EF9, &[0xFC]),
];

fn decode_tcvn(input: &[u8]) -> Result<(char, usize), DecodeError> {
    decode_sbcs_full(input, &TCVN_FULL)
}

fn encode_tcvn(ch: char, out: &mut [u8]) -> Result<usize, EncodeError> {
    encode_sbcs_mb(ch, out, TCVN_MBENC)
}
...
const ARMSCII8_TO_UNICODE: [u16; 128] = [
    ...
    0x00A0, 0xFFFF, 0x0587, 0x0589, 0x0029, 0x0028, 0x00BB, 0x00AB, // A0-A7
    0x2014, 0x002E, 0x055D, 0x002C, 0x002D, 0x058A, 0x2026, 0x055C, // A8-AF
    0x055B, 0x055E, 0x0531, 0x0561, 0x0532, 0x0562, 0x0533, 0x0563, // B0-B7
    0x0534, 0x0564, 0x0535, 0x0565, 0x0536, 0x0566, 0x0537, 0x0567, // B8-BF
    0x0538, 0x0568, 0x0539, 0x0569, 0x053A, 0x056A, 0x053B, 0x056B, // C0-C7
    0x053C, 0x056C, 0x053D, 0x056D, 0x053E, 0x056E, 0x053F, 0x056F, // C8-CF
    0x0540, 0x0570, 0x0541, 0x0571, 0x0542, 0x0572, 0x0543, 0x0573, // D0-D7
    0x0544, 0x0574, 0x0545, 0x0575, 0x0546, 0x0576, 0x0547, 0x0577, // D8-DF
    0x0548, 0x0578, 0x0549, 0x0579, 0x054A, 0x057A, 0x054B, 0x057B, // E0-E7
    0x054C, 0x057C, 0x054D, 0x057D, 0x054E, 0x057E, 0x054F, 0x057F, // E8-EF
    0x0550, 0x0580, 0x0551, 0x0581, 0x0552, 0x0582, 0x0553, 0x0583, // F0-F7
    0x0554, 0x0584, 0x0555, 0x0585, 0x0556, 0x0586, 0x055A, 0xFFFF, // F8-FF
];
...
const CP1161_FULL: [u16; 256] = [
    0x0000, 0x0001, 0x0002, 0x0003, 0x0004, 0x0005, 0x0006, 0x0007, // 00-07
    0x0008, 0x0009, 0x000A, 0x000B, 0x000C, 0x000D, 0x000E, 0x000F, // 08-0F
    0x0010, 0x0011, 0x0012, 0x0013, 0x0014, 0x0015, 0x0016, 0x0017, // 10-17
    0x0018, 0x0019, 0x001C, 0x001B, 0x007F, 0x001D, 0x001E, 0x001F, // 18-1F
    0x0020, 0x0021, 0x0022, 0x0023, 0x0024, 0x0025, 0x0026, 0x0027, // 20-27
    0x0028, 0x0029, 0x002A, 0x002B, 0x002C, 0x002D, 0x002E, 0x002F, // 28-2F
    0x0030, 0x0031, 0x0032, 0x0033, 0x0034, 0x0035, 0x0036, 0x0037, // 30-37
    0x0038, 0x0039, 0x003A, 0x003B, 0x003C, 0x003D, 0x003E, 0x003F, // 38-3F
    ...
    0x0068, 0x0069, 0x006A, 0x006B, 0x006C, 0x006D, 0x006E, 0x006F, // 68-6F
    0x0070, 0x0071, 0x0072, 0x0073, 0x0074, 0x0075, 0x0076, 0x0077, // 70-77
    0x0078, 0x0079, 0x007A, 0x007B, 0x007C, 0x007D, 0x007E, 0x001A, // 78-7F
    0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, // 80-87
    0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, // 88-8F
    0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, // 90-97
    0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, // 98-9F
...
const CP1161_FULL_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x04),(0x0005,0x05),(0x0006,0x06),(0x0007,0x07),
    (0x0008,0x08),(0x0009,0x09),(0x000A,0x0A),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x14),(0x0015,0x15),(0x0016,0x16),(0x0017,0x17),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x7F),(0x001B,0x1B),(0x001C,0x1A),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    ...
    (0x0078,0x78),(0x0079,0x79),(0x007A,0x7A),(0x007B,0x7B),(0x007C,0x7C),(0x007D,0x7D),(0x007E,0x7E),(0x007F,0x1C),
    (0x00A0,0xFF),(0x00A2,0xFC),(0x00A6,0xFE),(0x00AC,0xFD),(0x0E01,0xA1),(0x0E02,0xA2),(0x0E03,0xA3),(0x0E04,0xA4),
    (0x0E05,0xA5),(0x0E06,0xA6),(0x0E07,0xA7),(0x0E08,0xA8),(0x0E09,0xA9),(0x0E0A,0xAA),(0x0E0B,0xAB),(0x0E0C,0xAC),
    (0x0E0D,0xAD),(0x0E0E,0xAE),(0x0E0F,0xAF),(0x0E10,0xB0),(0x0E11,0xB1),(0x0E12,0xB2),(0x0E13,0xB3),(0x0E14,0xB4),
    (0x0E15,0xB5),(0x0E16,0xB6),(0x0E17,0xB7),(0x0E18,0xB8),(0x0E19,0xB9),(0x0E1A,0xBA),(0x0E1B,0xBB),(0x0E1C,0xBC),
    (0x0E1D,0xBD),(0x0E1E,0xBE),(0x0E1F,0xBF),(0x0E20,0xC0),(0x0E21,0xC1),(0x0E22,0xC2),(0x0E23,0xC3),(0x0E24,0xC4),
    (0x0E25,0xC5),(0x0E26,0xC6),(0x0E27,0xC7),(0x0E28,0xC8),(0x0E29,0xC9),(0x0E2A,0xCA),(0x0E2B,0xCB),(0x0E2C,0xCC),
    (0x0E2D,0xCD),(0x0E2E,0xCE),(0x0E2F,0xCF),(0x0E30,0xD0),(0x0E31,0xD1),(0x0E32,0xD2),(0x0E33,0xD3),(0x0E34,0xD4),
    (0x0E35,0xD5),(0x0E36,0xD6),(0x0E37,0xD7),(0x0E38,0xD8),(0x0E39,0xD9),(0x0E3A,0xDA),(0x0E3F,0xDF),(0x0E40,0xE0),
    (0x0E41,0xE1),(0x0E42,0xE2),(0x0E43,0xE3),(0x0E44,0xE4),(0x0E45,0xE5),(0x0E46,0xE6),(0x0E47,0xE7),(0x0E48,0xE8),
    (0x0E49,0xE9),(0x0E4A,0xEA),(0x0E4B,0xEB),(0x0E4C,0xEC),(0x0E4D,0xED),(0x0E4E,0xEE),(0x0E4F,0xEF),(0x0E50,0xF0),
    (0x0E51,0xF1),(0x0E52,0xF2),(0x0E53,0xF3),(0x0E54,0xF4),(0x0E55,0xF5),(0x0E56,0xF6),(0x0E57,0xF7),(0x0E58,0xF8),
    (0x0E59,0xF9),(0x0E5A,0xFA),(0x0E5B,0xFB),(0x20AC,0xDE),
];

fn decode_cp1161(input: &[u8]) -> Result<(char, usize), DecodeError> {
    decode_sbcs_full(input, &CP1161_FULL)
}

fn encode_cp1161(ch: char, out: &mut [u8]) -> Result<usize, EncodeError> {
    encode_sbcs_full(ch, out, CP1161_FULL_ENC)
}
...
const MIK_TO_UNICODE: [u16; 128] = [
    ...
    0x2591, 0x2592, 0x2593, 0x2502, 0x2524, 0x2116, 0x00A7, 0x2557, // D0-D7
    0x255D, 0x2518, 0x250C, 0x2588, 0x2584, 0x258C, 0x2590, 0x2580, // D8-DF
    0x03B1, 0x00DF, 0x0393, 0x03C0, 0x03A3, 0x03C3, 0x00B5, 0x03C4, // E0-E7
    0x03A6, 0x0398, 0x03A9, 0x03B4, 0x221E, 0x03C6, 0x03B5, 0x2229, // E8-EF
    0x2261, 0x00B1, 0x2265, 0x2264, 0x2320, 0x2321, 0x00F7, 0x2248, // F0-F7
    0x00B0, 0x2219, 0x00B7, 0x221A, 0x207F, 0x00B2, 0x25A0, 0x00A0, // F8-FF
...
/// CP1025 (EBCDIC Cyrillic) — full 256-entry EBCDIC table (host-generated).
const CP1025_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
    ...
    0x0090,0x0091,0x0016,0x0093,0x0094,0x0095,0x0096,0x0004, // 30-37
    0x0098,0x0099,0x009A,0x009B,0x0014,0x0015,0x009E,0x001A, // 38-3F
    0x0020,0x00A0,0x0452,0x0453,0x0451,0x0454,0x0455,0x0456, // 40-47
    0x0457,0x0458,0x005B,0x002E,0x003C,0x0028,0x002B,0x0021, // 48-4F
    0x0026,0x0459,0x045A,0x045B,0x045C,0x045E,0x045F,0x042A, // 50-57
    0x2116,0x0402,0x005D,0x0024,0x002A,0x0029,0x003B,0x005E, // 58-5F
    0x002D,0x002F,0x0403,0x0401,0x0404,0x0405,0x0406,0x0407, // 60-67
    0x0408,0x0409,0x007C,0x002C,0x0025,0x005F,0x003E,0x003F, // 68-6F
    0x040A,0x040B,0x040C,0x00AD,0x040E,0x040F,0x044E,0x0430, // 70-77
    0x0431,0x0060,0x003A,0x0023,0x0040,0x0027,0x003D,0x0022, // 78-7F
    0x0446,0x0061,0x0062,0x0063,0x0064,0x0065,0x0066,0x0067, // 80-87
    0x0068,0x0069,0x0434,0x0435,0x0444,0x0433,0x0445,0x0438, // 88-8F
    0x0439,0x006A,0x006B,0x006C,0x006D,0x006E,0x006F,0x0070, // 90-97
    0x0071,0x0072,0x043A,0x043B,0x043C,0x043D,0x043E,0x043F, // 98-9F
    0x044F,0x007E,0x0073,0x0074,0x0075,0x0076,0x0077,0x0078, // A0-A7
    0x0079,0x007A,0x0440,0x0441,0x0442,0x0443,0x0436,0x0432, // A8-AF
    0x044C,0x044B,0x0437,0x0448,0x044D,0x0449,0x0447,0x044A, // B0-B7
    0x042E,0x0410,0x0411,0x0426,0x0414,0x0415,0x0424,0x0413, // B8-BF
    0x007B,0x0041,0x0042,0x0043,0x0044,0x0045,0x0046,0x0047, // C0-C7
    0x0048,0x0049,0x0425,0x0418,0x0419,0x041A,0x041B,0x041C, // C8-CF
    0x007D,0x004A,0x004B,0x004C,0x004D,0x004E,0x004F,0x0050, // D0-D7
    0x0051,0x0052,0x041D,0x041E,0x041F,0x042F,0x0420,0x0421, // D8-DF
    0x005C,0x00A7,0x0053,0x0054,0x0055,0x0056,0x0057,0x0058, // E0-E7
    0x0059,0x005A,0x0422,0x0423,0x0416,0x0412,0x042C,0x042B, // E8-EF
    0x0030,0x0031,0x0032,0x0033,0x0034,0x0035,0x0036,0x0037, // F0-F7
    0x0038,0x0039,0x0417,0x0428,0x042D,0x0429,0x0427,0x009F, // F8-FF
];

/// CP1026 (EBCDIC Turkish) — full 256-entry EBCDIC table (host-generated).
const CP1026_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
    ...
    0x0098,0x0099,0x009A,0x009B,0x0014,0x0015,0x009E,0x001A, // 38-3F
    0x0020,0x00A0,0x00E2,0x00E4,0x00E0,0x00E1,0x00E3,0x00E5, // 40-47
    0x007B,0x00F1,0x00C7,0x002E,0x003C,0x0028,0x002B,0x0021, // 48-4F
    0x0026,0x00E9,0x00EA,0x00EB,0x00E8,0x00ED,0x00EE,0x00EF, // 50-57
    0x00EC,0x00DF,0x011E,0x0130,0x002A,0x0029,0x003B,0x005E, // 58-5F
    0x002D,0x002F,0x00C2,0x00C4,0x00C0,0x00C1,0x00C3,0x00C5, // 60-67
    0x005B,0x00D1,0x015F,0x002C,0x0025,0x005F,0x003E,0x003F, // 68-6F
    0x00F8,0x00C9,0x00CA,0x00CB,0x00C8,0x00CD,0x00CE,0x00CF, // 70-77
    0x00CC,0x0131,0x003A,0x00D6,0x015E,0x0027,0x003D,0x00DC, // 78-7F
    0x00D8,0x0061,0x0062,0x0063,0x0064,0x0065,0x0066,0x0067, // 80-87
    0x0068,0x0069,0x00AB,0x00BB,0x007D,0x0060,0x00A6,0x00B1, // 88-8F
    0x00B0,0x006A,0x006B,0x006C,0x006D,0x006E,0x006F,0x0070, // 90-97
    0x0071,0x0072,0x00AA,0x00BA,0x00E6,0x02DB,0x00C6,0x00A4, // 98-9F
    0x00B5,0x00F6,0x0073,0x0074,0x0075,0x0076,0x0077,0x0078, // A0-A7
    0x0079,0x007A,0x00A1,0x00BF,0x005D,0x0024,0x0040,0x00AE, // A8-AF
    0x00A2,0x00A3,0x00A5,0x00B7,0x00A9,0x00A7,0x00B6,0x00BC, // B0-B7
    0x00BD,0x00BE,0x00AC,0x007C,0x2014,0x00A8,0x00B4,0x00D7, // B8-BF
    0x00E7,0x0041,0x0042,0x0043,0x0044,0x0045,0x0046,0x0047, // C0-C7
    0x0048,0x0049,0x00AD,0x00F4,0x007E,0x00F2,0x00F3,0x00F5, // C8-CF
    0x011F,0x004A,0x004B,0x004C,0x004D,0x004E,0x004F,0x0050, // D0-D7
    0x0051,0x0052,0x00B9,0x00FB,0x005C,0x00F9,0x00FA,0x00FF, // D8-DF
    0x00FC,0x00F7,0x0053,0x0054,0x0055,0x0056,0x0057,0x0058, // E0-E7
    0x0059,0x005A,0x00B2,0x00D4,0x0023,0x00D2,0x00D3,0x00D5, // E8-EF
    0x0030,0x0031,0x0032,0x0033,0x0034,0x0035,0x0036,0x0037, // F0-F7
    0x0038,0x0039,0x00B3,0x00DB,0x0022,0x00D9,0x00DA,0x009F, // F8-FF
];

/// CP420 (EBCDIC Arabic) — full 256-entry EBCDIC table (host-generated).
const CP420_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
    ...
    0x0090,0x0091,0x0016,0x0093,0x0094,0x0095,0x0096,0x0004, // 30-37
    0x0098,0x0099,0x009A,0x009B,0x0014,0x0015,0x009E,0x001A, // 38-3F
    0x0020,0x00A0,0x0651,0xFE7D,0x0640,0xFFFF,0x0621,0x0622, // 40-47
    0xFE82,0x0623,0x00A2,0x002E,0x003C,0x0028,0x002B,0x007C, // 48-4F
    0x0026,0xFE84,0x0624,0xFFFF,0xFFFF,0x0626,0x0627,0xFE8E, // 50-57
    0x0628,0xFE91,0x0021,0x0024,0x002A,0x0029,0x003B,0x00AC, // 58-5F
    0x002D,0x002F,0x0629,0x062A,0xFE97,0x062B,0xFE9B,0x062C, // 60-67
    0xFE9F,0x062D,0x00A6,0x002C,0x0025,0x005F,0x003E,0x003F, // 68-6F
    0xFEA3,0x062E,0xFEA7,0x062F,0x0630,0x0631,0x0632,0x0633, // 70-77
    0xFEB3,0x060C,0x003A,0x0023,0x0040,0x0027,0x003D,0x0022, // 78-7F
    0x0634,0x0061,0x0062,0x0063,0x0064,0x0065,0x0066,0x0067, // 80-87
    0x0068,0x0069,0xFEB7,0x0635,0xFEBB,0x0636,0xFEBF,0x0637, // 88-8F
    0x0638,0x006A,0x006B,0x006C,0x006D,0x006E,0x006F,0x0070, // 90-97
    0x0071,0x0072,0x0639,0xFECA,0xFECB,0xFECC,0x063A,0xFECE, // 98-9F
    0xFECF,0x00F7,0x0073,0x0074,0x0075,0x0076,0x0077,0x0078, // A0-A7
    0x0079,0x007A,0xFED0,0x0641,0xFED3,0x0642,0xFED7,0x0643, // A8-AF
    0xFEDB,0x0644,0xFEF5,0xFEF6,0xFEF7,0xFEF8,0xFFFF,0xFFFF, // B0-B7
    0xFEFB,0xFEFC,0xFEDF,0x0645,0xFEE3,0x0646,0xFEE7,0x0647, // B8-BF
    0x061B,0x0041,0x0042,0x0043,0x0044,0x0045,0x0046,0x0047, // C0-C7
    0x0048,0x0049,0x00AD,0xFEEB,0xFFFF,0xFEEC,0xFFFF,0x0648, // C8-CF
    0x061F,0x004A,0x004B,0x004C,0x004D,0x004E,0x004F,0x0050, // D0-D7
    0x0051,0x0052,0x0649,0xFEF0,0x064A,0xFEF2,0xFEF3,0x0660, // D8-DF
    0x00D7,0xFFFF,0x0053,0x0054,0x0055,0x0056,0x0057,0x0058, // E0-E7
    0x0059,0x005A,0x0661,0x0662,0xFFFF,0x0663,0x0664,0x0665, // E8-EF
    0x0030,0x0031,0x0032,0x0033,0x0034,0x0035,0x0036,0x0037, // F0-F7
    0x0038,0x0039,0xFFFF,0x0666,0x0667,0x0668,0x0669,0x009F, // F8-FF
];

/// CP424 (EBCDIC Hebrew) — full 256-entry EBCDIC table (host-generated).
const CP424_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
    ...
    0x0090,0x0091,0x0016,0x0093,0x0094,0x0095,0x0096,0x0004, // 30-37
    0x0098,0x0099,0x009A,0x009B,0x0014,0x0015,0x009E,0x001A, // 38-3F
    0x0020,0x05D0,0x05D1,0x05D2,0x05D3,0x05D4,0x05D5,0x05D6, // 40-47
    0x05D7,0x05D8,0x00A2,0x002E,0x003C,0x0028,0x002B,0x007C, // 48-4F
    0x0026,0x05D9,0x05DA,0x05DB,0x05DC,0x05DD,0x05DE,0x05DF, // 50-57
    0x05E0,0x05E1,0x0021,0x0024,0x002A,0x0029,0x003B,0x00AC, // 58-5F
    0x002D,0x002F,0x05E2,0x05E3,0x05E4,0x05E5,0x05E6,0x05E7, // 60-67
    0x05E8,0x05E9,0x00A6,0x002C,0x0025,0x005F,0x003E,0x003F, // 68-6F
    0xFFFF,0x05EA,0xFFFF,0xFFFF,0x00A0,0xFFFF,0xFFFF,0xFFFF, // 70-77
    0x21D4,0x0060,0x003A,0x0023,0x0040,0x0027,0x003D,0x0022, // 78-7F
    0xFFFF,0x0061,0x0062,0x0063,0x0064,0x0065,0x0066,0x0067, // 80-87
    0x0068,0x0069,0x00AB,0x00BB,0xFFFF,0xFFFF,0xFFFF,0xFFFF, // 88-8F
    0x00B0,0x006A,0x006B,0x006C,0x006D,0x006E,0x006F,0x0070, // 90-97
    0x0071,0x0072,0xFFFF,0xFFFF,0xFFFF,0x00B8,0xFFFF,0x00A4, // 98-9F
    0x00B5,0x007E,0x0073,0x0074,0x0075,0x0076,0x0077,0x0078, // A0-A7
    0x0079,0x007A,0xFFFF,0xFFFF,0xFFFF,0xFFFF,0xFFFF,0x00AE, // A8-AF
    0x005E,0x00A3,0x00A5,0x00B7,0x00A9,0x00A7,0x00B6,0x00BC, // B0-B7
    0x00BD,0x00BE,0x005B,0x005D,0x00AF,0x00A8,0x00B4,0x00D7, // B8-BF
    0x007B,0x0041,0x0042,0x0043,0x0044,0x0045,0x0046,0x0047, // C0-C7
    0x0048,0x0049,0x00AD,0xFFFF,0xFFFF,0xFFFF,0xFFFF,0xFFFF, // C8-CF
    0x007D,0x004A,0x004B,0x004C,0x004D,0x004E,0x004F,0x0050, // D0-D7
    0x0051,0x0052,0x00B9,0xFFFF,0xFFFF,0xFFFF,0xFFFF,0xFFFF, // D8-DF
    0x005C,0x00F7,0x0053,0x0054,0x0055,0x0056,0x0057,0x0058, // E0-E7
    0x0059,0x005A,0x00B2,0xFFFF,0xFFFF,0xFFFF,0xFFFF,0xFFFF, // E8-EF
    0x0030,0x0031,0x0032,0x0033,0x0034,0x0035,0x0036,0x0037, // F0-F7
    0x0038,0x0039,0x00B3,0xFFFF,0xFFFF,0xFFFF,0xFFFF,0x009F, // F8-FF
];

/// CP880 (EBCDIC Cyrillic Multilingual) — full 256-entry EBCDIC table (host-generated).
const CP880_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
    ...
    0x0090,0x0091,0x0016,0x0093,0x0094,0x0095,0x0096,0x0004, // 30-37
    0x0098,0x0099,0x009A,0x009B,0x0014,0x0015,0x009E,0x001A, // 38-3F
    0x0020,0xFFFF,0x0452,0x0453,0x0451,0xFFFF,0x0455,0x0456, // 40-47
    0x0457,0x0458,0x005B,0x002E,0x003C,0x0028,0x002B,0x0021, // 48-4F
    0x0026,0x0459,0x045A,0x045B,0x045C,0xFFFF,0x045F,0x042A, // 50-57
    0x2116,0x0402,0x005D,0x0024,0x002A,0x0029,0x003B,0x005E, // 58-5F
    0x002D,0x002F,0x0403,0x0401,0xFFFF,0x0405,0x0406,0x0407, // 60-67
    0x0408,0x0409,0x00A6,0x002C,0x0025,0x005F,0x003E,0x003F, // 68-6F
    0x040A,0x040B,0x040C,0xFFFF,0xFFFF,0x040F,0x044E,0x0430, // 70-77
    0x0431,0xFFFF,0x003A,0x0023,0x0040,0x0027,0x003D,0x0022, // 78-7F
    0x0446,0x0061,0x0062,0x0063,0x0064,0x0065,0x0066,0x0067, // 80-87
    0x0068,0x0069,0x0434,0x0435,0x0444,0x0433,0x0445,0x0438, // 88-8F
    0x0439,0x006A,0x006B,0x006C,0x006D,0x006E,0x006F,0x0070, // 90-97
    0x0071,0x0072,0x043A,0x043B,0x043C,0x043D,0x043E,0x043F, // 98-9F
    0x044F,0xFFFF,0x0073,0x0074,0x0075,0x0076,0x0077,0x0078, // A0-A7
    0x0079,0x007A,0x0440,0x0441,0x0442,0x0443,0x0436,0x0432, // A8-AF
    0x044C,0x044B,0x0437,0x0448,0x044D,0x0449,0x0447,0x044A, // B0-B7
    0x042E,0x0410,0x0411,0x0426,0x0414,0x0415,0x0424,0x0413, // B8-BF
    0xFFFF,0x0041,0x0042,0x0043,0x0044,0x0045,0x0046,0x0047, // C0-C7
    0x0048,0x0049,0x0425,0x0418,0x0419,0x041A,0x041B,0x041C, // C8-CF
    0xFFFF,0x004A,0x004B,0x004C,0x004D,0x004E,0x004F,0x0050, // D0-D7
    0x0051,0x0052,0x041D,0x041E,0x041F,0x042F,0x0420,0x0421, // D8-DF
    0x005C,0x00A4,0x0053,0x0054,0x0055,0x0056,0x0057,0x0058, // E0-E7
    0x0059,0x005A,0x0422,0x0423,0x0416,0x0412,0x042C,0x042B, // E8-EF
    0x0030,0x0031,0x0032,0x0033,0x0034,0x0035,0x0036,0x0037, // F0-F7
    0x0038,0x0039,0x0417,0x0428,0x042D,0x0429,0x0427,0x009F, // F8-FF
];

/// CP1112 (EBCDIC Baltic) — full 256-entry EBCDIC table (host-generated).
const CP1112_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
    ...
    0x0090,0x0091,0x0016,0x0093,0x0094,0x0095,0x0096,0x0004, // 30-37
    0x0098,0x0099,0x009A,0x009B,0x0014,0x0015,0x009E,0x001A, // 38-3F
    0x0020,0x00A0,0x0161,0x00E4,0x0105,0x012F,0x016B,0x00E5, // 40-47
    0x0113,0x017E,0x00A2,0x002E,0x003C,0x0028,0x002B,0x007C, // 48-4F
    0x0026,0x00E9,0x0119,0x0117,0x010D,0x0173,0x201E,0x201C, // 50-57
    0x0123,0x00DF,0x0021,0x0024,0x002A,0x0029,0x003B,0x00AC, // 58-5F
    0x002D,0x002F,0x0160,0x00C4,0x0104,0x012E,0x016A,0x00C5, // 60-67
    0x0112,0x017D,0x00A6,0x002C,0x0025,0x005F,0x003E,0x003F, // 68-6F
    0x00F8,0x00C9,0x0118,0x0116,0x010C,0x0172,0x012A,0x013B, // 70-77
    0x0122,0x0060,0x003A,0x0023,0x0040,0x0027,0x003D,0x0022, // 78-7F
    0x00D8,0x0061,0x0062,0x0063,0x0064,0x0065,0x0066,0x0067, // 80-87
    0x0068,0x0069,0x00AB,0x00BB,0x0101,0x017C,0x0144,0x00B1, // 88-8F
    0x00B0,0x006A,0x006B,0x006C,0x006D,0x006E,0x006F,0x0070, // 90-97
    0x0071,0x0072,0x0156,0x0157,0x00E6,0x0137,0x00C6,0x00A4, // 98-9F
    0x00B5,0x007E,0x0073,0x0074,0x0075,0x0076,0x0077,0x0078, // A0-A7
    0x0079,0x007A,0x201D,0x017A,0x0100,0x017B,0x0143,0x00AE, // A8-AF
    0x005E,0x00A3,0x012B,0x00B7,0x00A9,0x00A7,0x00B6,0x00BC, // B0-B7
    0x00BD,0x00BE,0x005B,0x005D,0x0179,0x0136,0x013C,0x00D7, // B8-BF
    0x007B,0x0041,0x0042,0x0043,0x0044,0x0045,0x0046,0x0047, // C0-C7
    0x0048,0x0049,0x00AD,0x014D,0x00F6,0x0146,0x00F3,0x00F5, // C8-CF
    0x007D,0x004A,0x004B,0x004C,0x004D,0x004E,0x004F,0x0050, // D0-D7
    0x0051,0x0052,0x00B9,0x0107,0x00FC,0x0142,0x015B,0x2019, // D8-DF
    0x005C,0x00F7,0x0053,0x0054,0x0055,0x0056,0x0057,0x0058, // E0-E7
    0x0059,0x005A,0x00B2,0x014C,0x00D6,0x0145,0x00D3,0x00D5, // E8-EF
    0x0030,0x0031,0x0032,0x0033,0x0034,0x0035,0x0036,0x0037, // F0-F7
    0x0038,0x0039,0x00B3,0x0106,0x00DC,0x0141,0x015A,0x009F, // F8-FF
];

/// CP1122 (EBCDIC Estonia) — full 256-entry EBCDIC table (host-generated).
const CP1122_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
    ...
    0x002D,0x002F,0x00C2,0x0023,0x00C0,0x00C1,0x00C3,0x0024, // 60-67
    0x00C7,0x00D1,0x00F6,0x002C,0x0025,0x005F,0x003E,0x003F, // 68-6F
    0x00F8,0x005C,0x00CA,0x00CB,0x00C8,0x00CD,0x00CE,0x00CF, // 70-77
    0x00CC,0x00E9,0x003A,0x00C4,0x00D6,0x0027,0x003D,0x0022, // 78-7F
    0x00D8,0x0061,0x0062,0x0063,0x0064,0x0065,0x0066,0x0067, // 80-87
    0x0068,0x0069,0x00AB,0x00BB,0x0161,0x00FD,0x017E,0x00B1, // 88-8F
    0x00B0,0x006A,0x006B,0x006C,0x006D,0x006E,0x006F,0x0070, // 90-97
    0x0071,0x0072,0x00AA,0x00BA,0x00E6,0x00B8,0x00C6,0x005D, // 98-9F
    0x00B5,0x00FC,0x0073,0x0074,0x0075,0x0076,0x0077,0x0078, // A0-A7
    0x0079,0x007A,0x00A1,0x00BF,0x0160,0x00DD,0x017D,0x00AE, // A8-AF
    0x00A2,0x00A3,0x00A5,0x00B7,0x00A9,0x005B,0x00B6,0x00BC, // B0-B7
    0x00BD,0x00BE,0x00AC,0x007C,0x00AF,0x00A8,0x00B4,0x00D7, // B8-BF
    0x00E4,0x0041,0x0042,0x0043,0x0044,0x0045,0x0046,0x0047, // C0-C7
    0x0048,0x0049,0x00AD,0x00F4,0x00A6,0x00F2,0x00F3,0x00F5, // C8-CF
    0x00E5,0x004A,0x004B,0x004C,0x004D,0x004E,0x004F,0x0050, // D0-D7
    0x0051,0x0052,0x00B9,0x00FB,0x007E,0x00F9,0x00FA,0x00FF, // D8-DF
    0x00C9,0x00F7,0x0053,0x0054,0x0055,0x0056,0x0057,0x0058, // E0-E7
    0x0059,0x005A,0x00B2,0x00D4,0x0040,0x00D2,0x00D3,0x00D5, // E8-EF
    0x0030,0x0031,0x0032,0x0033,0x0034,0x0035,0x0036,0x0037, // F0-F7
    0x0038,0x0039,0x00B3,0x00DB,0x00DC,0x00D9,0x00DA,0x009F, // F8-FF
];

/// CP1123 (EBCDIC Ukraine) — full 256-entry EBCDIC table (host-generated).
const CP1123_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
    ...
    0x0090,0x0091,0x0016,0x0093,0x0094,0x0095,0x0096,0x0004, // 30-37
    0x0098,0x0099,0x009A,0x009B,0x0014,0x0015,0x009E,0x001A, // 38-3F
    0x0020,0x00A0,0x0452,0x0491,0x0451,0x0454,0x0455,0x0456, // 40-47
    0x0457,0x0458,0x005B,0x002E,0x003C,0x0028,0x002B,0x0021, // 48-4F
    0x0026,0x0459,0x045A,0x045B,0x045C,0x045E,0x045F,0x042A, // 50-57
    0x2116,0x0402,0x005D,0x0024,0x002A,0x0029,0x003B,0x005E, // 58-5F
    0x002D,0x002F,0x0490,0x0401,0x0404,0x0405,0x0406,0x0407, // 60-67
    0x0408,0x0409,0x007C,0x002C,0x0025,0x005F,0x003E,0x003F, // 68-6F
    0x040A,0x040B,0x040C,0x00AD,0x040E,0x040F,0x044E,0x0430, // 70-77
    0x0431,0x0060,0x003A,0x0023,0x0040,0x0027,0x003D,0x0022, // 78-7F
    0x0446,0x0061,0x0062,0x0063,0x0064,0x0065,0x0066,0x0067, // 80-87
...
/// CP1130 (EBCDIC Vietnamese) — full 256-entry EBCDIC table (host-generated).
const CP1130_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
    ...
    0x0090,0x0091,0x0016,0x0093,0x0094,0x0095,0x0096,0x0004, // 30-37
    0x0098,0x0099,0x009A,0x009B,0x0014,0x0015,0x009E,0x001A, // 38-3F
    0x0020,0x00A0,0x00E2,0x00E4,0x00E0,0x00E1,0x0103,0x00E5, // 40-47
    0x00E7,0x00F1,0x005B,0x002E,0x003C,0x0028,0x002B,0x0021, // 48-4F
    0x0026,0x00E9,0x00EA,0x00EB,0x00E8,0x00ED,0x00EE,0x00EF, // 50-57
    0x0303,0x00DF,0x005D,0x0024,0x002A,0x0029,0x003B,0x005E, // 58-5F
    0x002D,0x002F,0x00C2,0x00C4,0x00C0,0x00C1,0x0102,0x00C5, // 60-67
    0x00C7,0x00D1,0x00A6,0x002C,0x0025,0x005F,0x003E,0x003F, // 68-6F
    0x00F8,0x00C9,0x00CA,0x00CB,0x00C8,0x00CD,0x00CE,0x00CF, // 70-77
    0x20AB,0x0060,0x003A,0x0023,0x0040,0x0027,0x003D,0x0022, // 78-7F
    0x00D8,0x0061,0x0062,0x0063,0x0064,0x0065,0x0066,0x0067, // 80-87
    0x0068,0x0069,0x00AB,0x00BB,0x0111,0x0309,0x0300,0x00B1, // 88-8F
    0x00B0,0x006A,0x006B,0x006C,0x006D,0x006E,0x006F,0x0070, // 90-97
    0x0071,0x0072,0x00AA,0x00BA,0x00E6,0x0152,0x00C6,0x00A4, // 98-9F
    0x00B5,0x007E,0x0073,0x0074,0x0075,0x0076,0x0077,0x0078, // A0-A7
    0x0079,0x007A,0x00A1,0x00BF,0x0110,0x0323,0x0301,0x00AE, // A8-AF
    0x00A2,0x00A3,0x00A5,0x00B7,0x00A9,0x00A7,0x00B6,0x00BC, // B0-B7
    0x00BD,0x00BE,0x00AC,0x007C,0x00AF,0x0153,0x0178,0x00D7, // B8-BF
    0x007B,0x0041,0x0042,0x0043,0x0044,0x0045,0x0046,0x0047, // C0-C7
    0x0048,0x0049,0x00AD,0x00F4,0x00F6,0x01B0,0x00F3,0x01A1, // C8-CF
    0x007D,0x004A,0x004B,0x004C,0x004D,0x004E,0x004F,0x0050, // D0-D7
    0x0051,0x0052,0x00B9,0x00FB,0x00FC,0x00F9,0x00FA,0x00FF, // D8-DF
    0x005C,0x00F7,0x0053,0x0054,0x0055,0x0056,0x0057,0x0058, // E0-E7
    0x0059,0x005A,0x00B2,0x00D4,0x00D6,0x01AF,0x00D3,0x01A0, // E8-EF
    0x0030,0x0031,0x0032,0x0033,0x0034,0x0035,0x0036,0x0037, // F0-F7
    0x0038,0x0039,0x00B3,0x00DB,0x00DC,0x00D9,0x00DA,0x009F, // F8-FF
];

/// CP1132 (EBCDIC Lao) — full 256-entry EBCDIC table (host-generated).
const CP1132_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
    ...
    0x0090,0x0091,0x0016,0x0093,0x0094,0x0095,0x0096,0x0004, // 30-37
    0x0098,0x0099,0x009A,0x009B,0x0014,0x0015,0x009E,0x001A, // 38-3F
    0x0020,0x00A0,0x0E81,0x0E82,0x0E84,0x0E87,0x0E88,0x0EAA, // 40-47
    0x0E8A,0x005B,0x00A2,0x002E,0x003C,0x0028,0x002B,0x007C, // 48-4F
    0x0026,0xFFFF,0x0E8D,0x0E94,0x0E95,0x0E96,0x0E97,0x0E99, // 50-57
    0x0E9A,0x005D,0x0021,0x0024,0x002A,0x0029,0x003B,0x00AC, // 58-5F
    0x002D,0x002F,0x0E9B,0x0E9C,0x0E9D,0x0E9E,0x0E9F,0x0EA1, // 60-67
    0x0EA2,0x005E,0x00A6,0x002C,0x0025,0x005F,0x003E,0x003F, // 68-6F
    0x006B,0xFFFF,0x0EA3,0x0EA5,0x0EA7,0x0EAB,0x0EAD,0x0EAE, // 70-77
    0xFFFF,0x0060,0x003A,0x0023,0x0040,0x0027,0x003D,0x0022, // 78-7F
    0xFFFF,0x0061,0x0062,0x0063,0x0064,0x0065,0x0066,0x0067, // 80-87
    0x0068,0x0069,0xFFFF,0xFFFF,0x0EAF,0x0EB0,0x0EB2,0x0EB3, // 88-8F
    0xFFFF,0x006A,0x006B,0x006C,0x006D,0x006E,0x006F,0x0070, // 90-97
    0x0071,0x0072,0x0EB4,0x0EB5,0x0EB6,0x0EB7,0x0EB8,0x0EB9, // 98-9F
    0xFFFF,0x007E,0x0073,0x0074,0x0075,0x0076,0x0077,0x0078, // A0-A7
    0x0079,0x007A,0x0EBC,0x0EB1,0x0EBB,0x0EBD,0xFFFF,0xFFFF, // A8-AF
    0x0ED0,0x0ED1,0x0ED2,0x0ED3,0x0ED4,0x0ED5,0x0ED6,0x0ED7, // B0-B7
    0x0ED8,0x0ED9,0xFFFF,0x0EC0,0x0EC1,0x0EC2,0x0EC3,0x0EC4, // B8-BF
    0x007B,0x0041,0x0042,0x0043,0x0044,0x0045,0x0046,0x0047, // C0-C7
    0x0048,0x0049,0xFFFF,0x0EC8,0x0EC9,0x0ECA,0x0ECB,0x0ECC, // C8-CF
    0x007D,0x004A,0x004B,0x004C,0x004D,0x004E,0x004F,0x0050, // D0-D7
    0x0051,0x0052,0x0ECD,0x0EC6,0xFFFF,0x0EDC,0x0EDD,0xFFFF, // D8-DF
    0x005C,0xFFFF,0x0053,0x0054,0x0055,0x0056,0x0057,0x0058, // E0-E7
    0x0059,0x005A,0xFFFF,0xFFFF,0xFFFF,0xFFFF,0xFFFF,0xFFFF, // E8-EF
    0x0030,0x0031,0x0032,0x0033,0x0034,0x0035,0x0036,0x0037, // F0-F7
    0x0038,0x0039,0xFFFF,0xFFFF,0xFFFF,0xFFFF,0xFFFF,0x009F, // F8-FF
];

/// CP1137 (EBCDIC Devanagari) — full 256-entry EBCDIC table (host-generated).
const CP1137_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
    ...
    0x0090,0x0091,0x0016,0x0093,0x0094,0x0095,0x0096,0x0004, // 30-37
    0x0098,0x0099,0x009A,0x009B,0x0014,0x0015,0x009E,0x001A, // 38-3F
    0x0020,0x00A0,0x0901,0x0902,0x0903,0x0905,0x0906,0x0907, // 40-47
    0x0908,0x0909,0x090A,0x002E,0x003C,0x0028,0x002B,0x007C, // 48-4F
    0x0026,0x090B,0x090C,0x090D,0x090E,0x090F,0x0910,0x0911, // 50-57
    0x0912,0x0913,0x0021,0x0024,0x002A,0x0029,0x003B,0x005E, // 58-5F
    0x002D,0x002F,0x0914,0x0915,0x0916,0x0917,0x0918,0x0919, // 60-67
    0x091A,0x091B,0x091C,0x002C,0x0025,0x005F,0x003E,0x003F, // 68-6F
    0x091D,0x091E,0x091F,0x0920,0x0921,0x0922,0x0923,0x0924, // 70-77
    0x0925,0x0060,0x003A,0x0023,0x0040,0x0027,0x003D,0x0022, // 78-7F
    0x0926,0x0061,0x0062,0x0063,0x0064,0x0065,0x0066,0x0067, // 80-87
    0x0068,0x0069,0x0927,0x0928,0x092A,0x092B,0x092C,0x092D, // 88-8F
    0x092E,0x006A,0x006B,0x006C,0x006D,0x006E,0x006F,0x0070, // 90-97
    0x0071,0x0072,0x092F,0x0930,0x0932,0x0933,0x0935,0x0936, // 98-9F
    0x200C,0x007E,0x0073,0x0074,0x0075,0x0076,0x0077,0x0078, // A0-A7
    0x0079,0x007A,0x0937,0x0938,0x0939,0x005B,0x093C,0x093D, // A8-AF
    0x093E,0x093F,0x0940,0x0941,0x0942,0x0943,0x0944,0x0945, // B0-B7
    0x0946,0x0947,0x0948,0x0949,0x094A,0x005D,0x094B,0x094C, // B8-BF
    0x007B,0x0041,0x0042,0x0043,0x0044,0x0045,0x0046,0x0047, // C0-C7
    0x0048,0x0049,0x094D,0x0950,0x0951,0x0952,0xFFFF,0xFFFF, // C8-CF
    0x007D,0x004A,0x004B,0x004C,0x004D,0x004E,0x004F,0x0050, // D0-D7
    0x0051,0x0052,0x0960,0x0961,0x0962,0x0963,0x0964,0x0965, // D8-DF
    0x005C,0x200D,0x0053,0x0054,0x0055,0x0056,0x0057,0x0058, // E0-E7
    0x0059,0x005A,0x0966,0x0967,0x0968,0x0969,0x096A,0x096B, // E8-EF
    0x0030,0x0031,0x0032,0x0033,0x0034,0x0035,0x0036,0x0037, // F0-F7
    0x0038,0x0039,0x096C,0x096D,0x096E,0x096F,0x0970,0x009F, // F8-FF
];

/// CP1141 (EBCDIC code page 1141) — full 256-entry EBCDIC table (host-generated).
const CP1141_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
...
/// CP1142 (EBCDIC code page 1142) — full 256-entry EBCDIC table (host-generated).
const CP1142_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
    ...
    0x00E7,0x00F1,0x0023,0x002E,0x003C,0x0028,0x002B,0x0021, // 48-4F
    0x0026,0x00E9,0x00EA,0x00EB,0x00E8,0x00ED,0x00EE,0x00EF, // 50-57
    0x00EC,0x00DF,0x20AC,0x00C5,0x002A,0x0029,0x003B,0x005E, // 58-5F
    0x002D,0x002F,0x00C2,0x00C4,0x00C0,0x00C1,0x00C3,0x0024, // 60-67
    0x00C7,0x00D1,0x00F8,0x002C,0x0025,0x005F,0x003E,0x003F, // 68-6F
    0x00A6,0x00C9,0x00CA,0x00CB,0x00C8,0x00CD,0x00CE,0x00CF, // 70-77
    0x00CC,0x0060,0x003A,0x00C6,0x00D8,0x0027,0x003D,0x0022, // 78-7F
...
/// CP1143 (EBCDIC code page 1143) — full 256-entry EBCDIC table (host-generated).
const CP1143_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
...
/// CP1144 (EBCDIC code page 1144) — full 256-entry EBCDIC table (host-generated).
const CP1144_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
...
/// CP1145 (EBCDIC code page 1145) — full 256-entry EBCDIC table (host-generated).
const CP1145_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
...
/// CP1146 (EBCDIC code page 1146) — full 256-entry EBCDIC table (host-generated).
const CP1146_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
    ...
    0x00B0,0x006A,0x006B,0x006C,0x006D,0x006E,0x006F,0x0070, // 90-97
    0x0071,0x0072,0x00AA,0x00BA,0x00E6,0x00B8,0x00C6,0x20AC, // 98-9F
    0x00B5,0x00AF,0x0073,0x0074,0x0075,0x0076,0x0077,0x0078, // A0-A7
    0x0079,0x007A,0x00A1,0x00BF,0x00D0,0x00DD,0x00DE,0x00AE, // A8-AF
    0x00A2,0x005B,0x00A5,0x00B7,0x00A9,0x00A7,0x00B6,0x00BC, // B0-B7
    0x00BD,0x00BE,0x005E,0x005D,0x007E,0x00A8,0x00B4,0x00D7, // B8-BF
    0x007B,0x0041,0x0042,0x0043,0x0044,0x0045,0x0046,0x0047, // C0-C7
...
/// CP1147 (EBCDIC code page 1147) — full 256-entry EBCDIC table (host-generated).
const CP1147_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
...
/// CP1148 (EBCDIC code page 1148) — full 256-entry EBCDIC table (host-generated).
const CP1148_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
...
/// CP1149 (EBCDIC code page 1149) — full 256-entry EBCDIC table (host-generated).
const CP1149_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
    ...
    0x0098,0x0099,0x009A,0x009B,0x0014,0x0015,0x009E,0x001A, // 38-3F
    0x0020,0x00A0,0x00E2,0x00E4,0x00E0,0x00E1,0x00E3,0x00E5, // 40-47
    0x00E7,0x00F1,0x00DE,0x002E,0x003C,0x0028,0x002B,0x0021, // 48-4F
    0x0026,0x00E9,0x00EA,0x00EB,0x00E8,0x00ED,0x00EE,0x00EF, // 50-57
    0x00EC,0x00DF,0x00C6,0x0024,0x002A,0x0029,0x003B,0x00D6, // 58-5F
    0x002D,0x002F,0x00C2,0x00C4,0x00C0,0x00C1,0x00C3,0x00C5, // 60-67
    0x00C7,0x00D1,0x00A6,0x002C,0x0025,0x005F,0x003E,0x003F, // 68-6F
    ...
    0x0068,0x0069,0x00AB,0x00BB,0x0060,0x00FD,0x007B,0x00B1, // 88-8F
    0x00B0,0x006A,0x006B,0x006C,0x006D,0x006E,0x006F,0x0070, // 90-97
    0x0071,0x0072,0x00AA,0x00BA,0x007D,0x00B8,0x005D,0x20AC, // 98-9F
    0x00B5,0x00F6,0x0073,0x0074,0x0075,0x0076,0x0077,0x0078, // A0-A7
    0x0079,0x007A,0x00A1,0x00BF,0x0040,0x00DD,0x005B,0x00AE, // A8-AF
    0x00A2,0x00A3,0x00A5,0x00B7,0x00A9,0x00A7,0x00B6,0x00BC, // B0-B7
    0x00BD,0x00BE,0x00AC,0x007C,0x00AF,0x00A8,0x005C,0x00D7, // B8-BF
    0x00FE,0x0041,0x0042,0x0043,0x0044,0x0045,0x0046,0x0047, // C0-C7
    0x0048,0x0049,0x00AD,0x00F4,0x007E,0x00F2,0x00F3,0x00F5, // C8-CF
    0x00E6,0x004A,0x004B,0x004C,0x004D,0x004E,0x004F,0x0050, // D0-D7
    0x0051,0x0052,0x00B9,0x00FB,0x00FC,0x00F9,0x00FA,0x00FF, // D8-DF
    0x00B4,0x00F7,0x0053,0x0054,0x0055,0x0056,0x0057,0x0058, // E0-E7
...
/// CP12712 (EBCDIC code page 12712) — full 256-entry EBCDIC table (host-generated).
const CP12712_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
    ...
    0x05E8,0x05E9,0x00A6,0x002C,0x0025,0x005F,0x003E,0x003F, // 68-6F
    0xFFFF,0x05EA,0xFFFF,0xFFFF,0x00A0,0xFFFF,0xFFFF,0xFFFF, // 70-77
    0x2017,0x0060,0x003A,0x0023,0x0040,0x0027,0x003D,0x0022, // 78-7F
    0xFFFF,0x0061,0x0062,0x0063,0x0064,0x0065,0x0066,0x0067, // 80-87
    0x0068,0x0069,0x00AB,0x00BB,0xFFFF,0xFFFF,0xFFFF,0x00B1, // 88-8F
    0x00B0,0x006A,0x006B,0x006C,0x006D,0x006E,0x006F,0x0070, // 90-97
    0x0071,0x0072,0xFFFF,0xFFFF,0x20AC,0x00B8,0x20AA,0x00A4, // 98-9F
    0x00B5,0x007E,0x0073,0x0074,0x0075,0x0076,0x0077,0x0078, // A0-A7
    0x0079,0x007A,0xFFFF,0xFFFF,0xFFFF,0xFFFF,0xFFFF,0x00AE, // A8-AF
    0x005E,0x00A3,0x00A5,0x2022,0x00A9,0x00A7,0x00B6,0x00BC, // B0-B7
    0x00BD,0x00BE,0x005B,0x005D,0x203E,0x00A8,0x00B4,0x00D7, // B8-BF
    0x007B,0x0041,0x0042,0x0043,0x0044,0x0045,0x0046,0x0047, // C0-C7
    0x0048,0x0049,0x00AD,0xFFFF,0xFFFF,0xFFFF,0xFFFF,0xFFFF, // C8-CF
    0x007D,0x004A,0x004B,0x004C,0x004D,0x004E,0x004F,0x0050, // D0-D7
    0x0051,0x0052,0x00B9,0x202D,0x202E,0x202C,0xFFFF,0xFFFF, // D8-DF
    0x005C,0x00F7,0x0053,0x0054,0x0055,0x0056,0x0057,0x0058, // E0-E7
    0x0059,0x005A,0x00B2,0xFFFF,0xFFFF,0xFFFF,0xFFFF,0xFFFF, // E8-EF
    0x0030,0x0031,0x0032,0x0033,0x0034,0x0035,0x0036,0x0037, // F0-F7
    0x0038,0x0039,0x00B3,0x202A,0x202B,0x200E,0x200F,0x009F, // F8-FF
];

/// CP16804 (EBCDIC code page 16804) — full 256-entry EBCDIC table (host-generated).
const CP16804_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
    ...
    0x0090,0x0091,0x0016,0x0093,0x0094,0x0095,0x0096,0x0004, // 30-37
    0x0098,0x0099,0x009A,0x009B,0x0014,0x0015,0x009E,0x001A, // 38-3F
    0x0020,0x00A0,0x0651,0xFE7D,0x0640,0x200B,0x0621,0x0622, // 40-47
    0xFE82,0x0623,0x00A2,0x002E,0x003C,0x0028,0x002B,0x007C, // 48-4F
    0x0026,0xFE84,0x0624,0xFFFF,0xFFFF,0x0626,0x0627,0xFE8E, // 50-57
    0x0628,0xFE91,0x0021,0x0024,0x002A,0x0029,0x003B,0x00AC, // 58-5F
    0x002D,0x002F,0x0629,0x062A,0xFE97,0x062B,0xFE9B,0x062C, // 60-67
    ...
    0x061F,0x004A,0x004B,0x004C,0x004D,0x004E,0x004F,0x0050, // D0-D7
    0x0051,0x0052,0x0649,0xFEF0,0x064A,0xFEF2,0xFEF3,0x0660, // D8-DF
    0x00D7,0x2007,0x0053,0x0054,0x0055,0x0056,0x0057,0x0058, // E0-E7
    0x0059,0x005A,0x0661,0x0662,0xFFFF,0x0663,0x0664,0x0665, // E8-EF
    0x0030,0x0031,0x0032,0x0033,0x0034,0x0035,0x0036,0x0037, // F0-F7
    0x0038,0x0039,0x20AC,0x0666,0x0667,0x0668,0x0669,0x009F, // F8-FF
];

/// CP4517 (EBCDIC code page 4517) — full 256-entry EBCDIC table (host-generated).
const CP4517_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
    ...
    0x0090,0x0091,0x0016,0x0093,0x0094,0x0095,0x0096,0x0004, // 30-37
    0x0098,0x0099,0x009A,0x009B,0x0014,0x0015,0x009E,0x001A, // 38-3F
    0x0020,0x00A0,0xFE7C,0xFE7D,0x0640,0x200B,0xFE80,0xFE81, // 40-47
    0xFE82,0xFE83,0x00B0,0x002E,0x003C,0x0028,0x002B,0x0021, // 48-4F
    0x0026,0xFE84,0xFE85,0xFFFF,0xFFFF,0xFE8B,0xFE8D,0xFE8E, // 50-57
    0xFE8F,0xFE91,0x00A7,0x0024,0x002A,0x0029,0x003B,0x005E, // 58-5F
    0x002D,0x002F,0xFE93,0xFE95,0xFE97,0xFE99,0xFE9B,0xFE9D, // 60-67
    0xFE9F,0xFEA1,0x00FA,0x002C,0x0025,0x005F,0x003E,0x003F, // 68-6F
    0xFEA3,0xFEA5,0xFEA7,0xFEA9,0xFEAB,0xFEAD,0xFEAF,0xFEB1, // 70-77
    0xFEB3,0x00A3,0x003A,0x00B5,0x00E1,0x0027,0x003D,0x0022, // 78-7F
    0xFEB5,0x0061,0x0062,0x0063,0x0064,0x0065,0x0066,0x0067, // 80-87
    0x0068,0x0069,0xFEB7,0xFEB9,0xFEBB,0xFEBD,0xFEBF,0xFEC3, // 88-8F
    0xFEC7,0x006A,0x006B,0x006C,0x006D,0x006E,0x006F,0x0070, // 90-97
    0x0071,0x0072,0xFEC9,0xFECA,0xFECB,0xFECC,0xFECD,0xFECE, // 98-9F
    0xFECF,0x00A8,0x0073,0x0074,0x0075,0x0076,0x0077,0x0078, // A0-A7
    0x0079,0x007A,0xFED0,0xFED1,0xFED3,0xFED5,0xFED7,0xFED9, // A8-AF
    0xFEDB,0xFEDD,0xFEF5,0xFEF6,0xFEF7,0xFEF8,0xFFFF,0xFFFF, // B0-B7
    0xFEFB,0xFEFC,0xFEDF,0xFEE1,0xFEE3,0xFEE5,0xFEE7,0xFEE9, // B8-BF
    0x00E9,0x0041,0x0042,0x0043,0x0044,0x0045,0x0046,0x0047, // C0-C7
    0x0048,0x0049,0x00AD,0xFEEB,0xFFFF,0xFEEC,0xFFFF,0xFEED, // C8-CF
    0x00E8,0x004A,0x004B,0x004C,0x004D,0x004E,0x004F,0x0050, // D0-D7
    0x0051,0x0052,0xFEEF,0xFEF0,0xFEF1,0xFEF2,0xFEF3,0xFFFF, // D8-DF
    0x00E7,0x2007,0x0053,0x0054,0x0055,0x0056,0x0057,0x0058, // E0-E7
    0x0059,0x005A,0x00F7,0x060C,0xFFFF,0x00D7,0x061F,0x061B, // E8-EF
    0x0030,0x0031,0x0032,0x0033,0x0034,0x0035,0x0036,0x0037, // F0-F7
    0x0038,0x0039,0xFFFF,0xFFFF,0xFFFF,0xFFFF,0xFFFF,0x009F, // F8-FF
];

/// CP4971 (EBCDIC code page 4971) — full 256-entry EBCDIC table (host-generated).
const CP4971_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
    ...
    0x03A1,0x03A3,0x005D,0x0024,0x002A,0x0029,0x003B,0x005E, // 58-5F
    0x002D,0x002F,0x03A4,0x03A5,0x03A6,0x03A7,0x03A8,0x03A9, // 60-67
    0x03AA,0x03AB,0x007C,0x002C,0x0025,0x005F,0x003E,0x003F, // 68-6F
    0x00A8,0x0386,0x0388,0x0389,0x00A0,0x038A,0x038C,0x038E, // 70-77
    0x038F,0x0060,0x003A,0x0023,0x0040,0x0027,0x003D,0x0022, // 78-7F
    0x0385,0x0061,0x0062,0x0063,0x0064,0x0065,0x0066,0x0067, // 80-87
    0x0068,0x0069,0x03B1,0x03B2,0x03B3,0x03B4,0x03B5,0x03B6, // 88-8F
    0x00B0,0x006A,0x006B,0x006C,0x006D,0x006E,0x006F,0x0070, // 90-97
    ...
    0x0048,0x0049,0x00AD,0x03C9,0x0390,0x03B0,0x2018,0x2015, // C8-CF
    0x007D,0x004A,0x004B,0x004C,0x004D,0x004E,0x004F,0x0050, // D0-D7
    0x0051,0x0052,0x00B1,0x00BD,0xFFFF,0x0387,0x2019,0x00A6, // D8-DF
    0x005C,0xFFFF,0x0053,0x0054,0x0055,0x0056,0x0057,0x0058, // E0-E7
    0x0059,0x005A,0x00B2,0x00A7,0xFFFF,0xFFFF,0x00AB,0x00AC, // E8-EF
    0x0030,0x0031,0x0032,0x0033,0x0034,0x0035,0x0036,0x0037, // F0-F7
    0x0038,0x0039,0x00B3,0x00A9,0x20AC,0xFFFF,0x00BB,0x009F, // F8-FF
];

const CP1025_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    ...
    (0x0090,0x30),(0x0091,0x31),(0x0092,0x1A),(0x0093,0x33),(0x0094,0x34),(0x0095,0x35),(0x0096,0x36),(0x0097,0x08),
    (0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),
    (0x00A0,0x41),(0x00A7,0xE1),(0x00AD,0x73),(0x0401,0x63),(0x0402,0x59),(0x0403,0x62),(0x0404,0x64),(0x0405,0x65),
    (0x0406,0x66),(0x0407,0x67),(0x0408,0x68),(0x0409,0x69),(0x040A,0x70),(0x040B,0x71),(0x040C,0x72),(0x040E,0x74),
    (0x040F,0x75),(0x0410,0xB9),(0x0411,0xBA),(0x0412,0xED),(0x0413,0xBF),(0x0414,0xBC),(0x0415,0xBD),(0x0416,0xEC),
    (0x0417,0xFA),(0x0418,0xCB),(0x0419,0xCC),(0x041A,0xCD),(0x041B,0xCE),(0x041C,0xCF),(0x041D,0xDA),(0x041E,0xDB),
    (0x041F,0xDC),(0x0420,0xDE),(0x0421,0xDF),(0x0422,0xEA),(0x0423,0xEB),(0x0424,0xBE),(0x0425,0xCA),(0x0426,0xBB),
    (0x0427,0xFE),(0x0428,0xFB),(0x0429,0xFD),(0x042A,0x57),(0x042B,0xEF),(0x042C,0xEE),(0x042D,0xFC),(0x042E,0xB8),
    (0x042F,0xDD),(0x0430,0x77),(0x0431,0x78),(0x0432,0xAF),(0x0433,0x8D),(0x0434,0x8A),(0x0435,0x8B),(0x0436,0xAE),
    (0x0437,0xB2),(0x0438,0x8F),(0x0439,0x90),(0x043A,0x9A),(0x043B,0x9B),(0x043C,0x9C),(0x043D,0x9D),(0x043E,0x9E),
    (0x043F,0x9F),(0x0440,0xAA),(0x0441,0xAB),(0x0442,0xAC),(0x0443,0xAD),(0x0444,0x8C),(0x0445,0x8E),(0x0446,0x80),
    (0x0447,0xB6),(0x0448,0xB3),(0x0449,0xB5),(0x044A,0xB7),(0x044B,0xB1),(0x044C,0xB0),(0x044D,0xB4),(0x044E,0x76),
    (0x044F,0xA0),(0x0451,0x44),(0x0452,0x42),(0x0453,0x43),(0x0454,0x45),(0x0455,0x46),(0x0456,0x47),(0x0457,0x48),
    (0x0458,0x49),(0x0459,0x51),(0x045A,0x52),(0x045B,0x53),(0x045C,0x54),(0x045E,0x55),(0x045F,0x56),(0x2116,0x58),
];

const CP1026_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    (0x0020,0x40),(0x0021,0x4F),(0x0022,0xFC),(0x0023,0xEC),(0x0024,0xAD),(0x0025,0x6C),(0x0026,0x50),(0x0027,0x7D),
    (0x0028,0x4D),(0x0029,0x5D),(0x002A,0x5C),(0x002B,0x4E),(0x002C,0x6B),(0x002D,0x60),(0x002E,0x4B),(0x002F,0x61),
    (0x0030,0xF0),(0x0031,0xF1),(0x0032,0xF2),(0x0033,0xF3),(0x0034,0xF4),(0x0035,0xF5),(0x0036,0xF6),(0x0037,0xF7),
    (0x0038,0xF8),(0x0039,0xF9),(0x003A,0x7A),(0x003B,0x5E),(0x003C,0x4C),(0x003D,0x7E),(0x003E,0x6E),(0x003F,0x6F),
    (0x0040,0xAE),(0x0041,0xC1),(0x0042,0xC2),(0x0043,0xC3),(0x0044,0xC4),(0x0045,0xC5),(0x0046,0xC6),(0x0047,0xC7),
    (0x0048,0xC8),(0x0049,0xC9),(0x004A,0xD1),(0x004B,0xD2),(0x004C,0xD3),(0x004D,0xD4),(0x004E,0xD5),(0x004F,0xD6),
    (0x0050,0xD7),(0x0051,0xD8),(0x0052,0xD9),(0x0053,0xE2),(0x0054,0xE3),(0x0055,0xE4),(0x0056,0xE5),(0x0057,0xE6),
    (0x0058,0xE7),(0x0059,0xE8),(0x005A,0xE9),(0x005B,0x68),(0x005C,0xDC),(0x005D,0xAC),(0x005E,0x5F),(0x005F,0x6D),
    (0x0060,0x8D),(0x0061,0x81),(0x0062,0x82),(0x0063,0x83),(0x0064,0x84),(0x0065,0x85),(0x0066,0x86),(0x0067,0x87),
    (0x0068,0x88),(0x0069,0x89),(0x006A,0x91),(0x006B,0x92),(0x006C,0x93),(0x006D,0x94),(0x006E,0x95),(0x006F,0x96),
    (0x0070,0x97),(0x0071,0x98),(0x0072,0x99),(0x0073,0xA2),(0x0074,0xA3),(0x0075,0xA4),(0x0076,0xA5),(0x0077,0xA6),
    (0x0078,0xA7),(0x0079,0xA8),(0x007A,0xA9),(0x007B,0x48),(0x007C,0xBB),(0x007D,0x8C),(0x007E,0xCC),(0x007F,0x07),
    (0x0080,0x20),(0x0081,0x21),(0x0082,0x22),(0x0083,0x23),(0x0084,0x24),(0x0085,0x15),(0x0086,0x06),(0x0087,0x17),
    (0x0088,0x28),(0x0089,0x29),(0x008A,0x2A),(0x008B,0x2B),(0x008C,0x2C),(0x008D,0x09),(0x008E,0x0A),(0x008F,0x1B),
    (0x0090,0x30),(0x0091,0x31),(0x0092,0x1A),(0x0093,0x33),(0x0094,0x34),(0x0095,0x35),(0x0096,0x36),(0x0097,0x08),
    (0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),
    (0x00A0,0x41),(0x00A1,0xAA),(0x00A2,0xB0),(0x00A3,0xB1),(0x00A4,0x9F),(0x00A5,0xB2),(0x00A6,0x8E),(0x00A7,0xB5),
    (0x00A8,0xBD),(0x00A9,0xB4),(0x00AA,0x9A),(0x00AB,0x8A),(0x00AC,0xBA),(0x00AD,0xCA),(0x00AE,0xAF),(0x00B0,0x90),
    (0x00B1,0x8F),(0x00B2,0xEA),(0x00B3,0xFA),(0x00B4,0xBE),(0x00B5,0xA0),(0x00B6,0xB6),(0x00B7,0xB3),(0x00B9,0xDA),
    (0x00BA,0x9B),(0x00BB,0x8B),(0x00BC,0xB7),(0x00BD,0xB8),(0x00BE,0xB9),(0x00BF,0xAB),(0x00C0,0x64),(0x00C1,0x65),
    (0x00C2,0x62),(0x00C3,0x66),(0x00C4,0x63),(0x00C5,0x67),(0x00C6,0x9E),(0x00C7,0x4A),(0x00C8,0x74),(0x00C9,0x71),
    (0x00CA,0x72),(0x00CB,0x73),(0x00CC,0x78),(0x00CD,0x75),(0x00CE,0x76),(0x00CF,0x77),(0x00D1,0x69),(0x00D2,0xED),
    (0x00D3,0xEE),(0x00D4,0xEB),(0x00D5,0xEF),(0x00D6,0x7B),(0x00D7,0xBF),(0x00D8,0x80),(0x00D9,0xFD),(0x00DA,0xFE),
    (0x00DB,0xFB),(0x00DC,0x7F),(0x00DF,0x59),(0x00E0,0x44),(0x00E1,0x45),(0x00E2,0x42),(0x00E3,0x46),(0x00E4,0x43),
    (0x00E5,0x47),(0x00E6,0x9C),(0x00E7,0xC0),(0x00E8,0x54),(0x00E9,0x51),(0x00EA,0x52),(0x00EB,0x53),(0x00EC,0x58),
    (0x00ED,0x55),(0x00EE,0x56),(0x00EF,0x57),(0x00F1,0x49),(0x00F2,0xCD),(0x00F3,0xCE),(0x00F4,0xCB),(0x00F5,0xCF),
    (0x00F6,0xA1),(0x00F7,0xE1),(0x00F8,0x70),(0x00F9,0xDD),(0x00FA,0xDE),(0x00FB,0xDB),(0x00FC,0xE0),(0x00FF,0xDF),
    (0x011E,0x5A),(0x011F,0xD0),(0x0130,0x5B),(0x0131,0x79),(0x015E,0x7C),(0x015F,0x6A),(0x02DB,0x9D),(0x2014,0xBC),
];

const CP420_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    ...
    (0x0048,0xC8),(0x0049,0xC9),(0x004A,0xD1),(0x004B,0xD2),(0x004C,0xD3),(0x004D,0xD4),(0x004E,0xD5),(0x004F,0xD6),
    (0x0050,0xD7),(0x0051,0xD8),(0x0052,0xD9),(0x0053,0xE2),(0x0054,0xE3),(0x0055,0xE4),(0x0056,0xE5),(0x0057,0xE6),
    (0x0058,0xE7),(0x0059,0xE8),(0x005A,0xE9),(0x005F,0x6D),(0x0061,0x81),(0x0062,0x82),(0x0063,0x83),(0x0064,0x84),
    (0x0065,0x85),(0x0066,0x86),(0x0067,0x87),(0x0068,0x88),(0x0069,0x89),(0x006A,0x91),(0x006B,0x92),(0x006C,0x93),
    (0x006D,0x94),(0x006E,0x95),(0x006F,0x96),(0x0070,0x97),(0x0071,0x98),(0x0072,0x99),(0x0073,0xA2),(0x0074,0xA3),
    (0x0075,0xA4),(0x0076,0xA5),(0x0077,0xA6),(0x0078,0xA7),(0x0079,0xA8),(0x007A,0xA9),(0x007C,0x4F),(0x007F,0x07),
    (0x0080,0x20),(0x0081,0x21),(0x0082,0x22),(0x0083,0x23),(0x0084,0x24),(0x0085,0x15),(0x0086,0x06),(0x0087,0x17),
    (0x0088,0x28),(0x0089,0x29),(0x008A,0x2A),(0x008B,0x2B),(0x008C,0x2C),(0x008D,0x09),(0x008E,0x0A),(0x008F,0x1B),
    (0x0090,0x30),(0x0091,0x31),(0x0092,0x1A),(0x0093,0x33),(0x0094,0x34),(0x0095,0x35),(0x0096,0x36),(0x0097,0x08),
    (0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),
    (0x00A0,0x41),(0x00A2,0x4A),(0x00A6,0x6A),(0x00AC,0x5F),(0x00AD,0xCA),(0x00D7,0xE0),(0x00F7,0xA1),(0x060C,0x79),
    (0x061B,0xC0),(0x061F,0xD0),(0x0621,0x46),(0x0622,0x47),(0x0623,0x49),(0x0624,0x52),(0x0626,0x55),(0x0627,0x56),
    (0x0628,0x58),(0x0629,0x62),(0x062A,0x63),(0x062B,0x65),(0x062C,0x67),(0x062D,0x69),(0x062E,0x71),(0x062F,0x73),
    (0x0630,0x74),(0x0631,0x75),(0x0632,0x76),(0x0633,0x77),(0x0634,0x80),(0x0635,0x8B),(0x0636,0x8D),(0x0637,0x8F),
    (0x0638,0x90),(0x0639,0x9A),(0x063A,0x9E),(0x0640,0x44),(0x0641,0xAB),(0x0642,0xAD),(0x0643,0xAF),(0x0644,0xB1),
    (0x0645,0xBB),(0x0646,0xBD),(0x0647,0xBF),(0x0648,0xCF),(0x0649,0xDA),(0x064A,0xDC),(0x0651,0x42),(0x0660,0xDF),
    (0x0661,0xEA),(0x0662,0xEB),(0x0663,0xED),(0x0664,0xEE),(0x0665,0xEF),(0x0666,0xFB),(0x0667,0xFC),(0x0668,0xFD),
    (0x0669,0xFE),(0xFE7D,0x43),(0xFE82,0x48),(0xFE84,0x51),(0xFE8E,0x57),(0xFE91,0x59),(0xFE97,0x64),(0xFE9B,0x66),
    (0xFE9F,0x68),(0xFEA3,0x70),(0xFEA7,0x72),(0xFEB3,0x78),(0xFEB7,0x8A),(0xFEBB,0x8C),(0xFEBF,0x8E),(0xFECA,0x9B),
    (0xFECB,0x9C),(0xFECC,0x9D),(0xFECE,0x9F),(0xFECF,0xA0),(0xFED0,0xAA),(0xFED3,0xAC),(0xFED7,0xAE),(0xFEDB,0xB0),
    (0xFEDF,0xBA),(0xFEE3,0xBC),(0xFEE7,0xBE),(0xFEEB,0xCB),(0xFEEC,0xCD),(0xFEF0,0xDB),(0xFEF2,0xDD),(0xFEF3,0xDE),
    (0xFEF5,0xB2),(0xFEF6,0xB3),(0xFEF7,0xB4),(0xFEF8,0xB5),(0xFEFB,0xB8),(0xFEFC,0xB9),
];

const CP424_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    ...
    (0x0090,0x30),(0x0091,0x31),(0x0092,0x1A),(0x0093,0x33),(0x0094,0x34),(0x0095,0x35),(0x0096,0x36),(0x0097,0x08),
    (0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),
    (0x00A0,0x74),(0x00A2,0x4A),(0x00A3,0xB1),(0x00A4,0x9F),(0x00A5,0xB2),(0x00A6,0x6A),(0x00A7,0xB5),(0x00A8,0xBD),
    (0x00A9,0xB4),(0x00AB,0x8A),(0x00AC,0x5F),(0x00AD,0xCA),(0x00AE,0xAF),(0x00AF,0xBC),(0x00B0,0x90),(0x00B2,0xEA),
    (0x00B3,0xFA),(0x00B4,0xBE),(0x00B5,0xA0),(0x00B6,0xB6),(0x00B7,0xB3),(0x00B8,0x9D),(0x00B9,0xDA),(0x00BB,0x8B),
    (0x00BC,0xB7),(0x00BD,0xB8),(0x00BE,0xB9),(0x00D7,0xBF),(0x00F7,0xE1),(0x05D0,0x41),(0x05D1,0x42),(0x05D2,0x43),
    (0x05D3,0x44),(0x05D4,0x45),(0x05D5,0x46),(0x05D6,0x47),(0x05D7,0x48),(0x05D8,0x49),(0x05D9,0x51),(0x05DA,0x52),
    (0x05DB,0x53),(0x05DC,0x54),(0x05DD,0x55),(0x05DE,0x56),(0x05DF,0x57),(0x05E0,0x58),(0x05E1,0x59),(0x05E2,0x62),
    (0x05E3,0x63),(0x05E4,0x64),(0x05E5,0x65),(0x05E6,0x66),(0x05E7,0x67),(0x05E8,0x68),(0x05E9,0x69),(0x05EA,0x71),
    (0x21D4,0x78),
];

const CP880_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    ...
    (0x0050,0xD7),(0x0051,0xD8),(0x0052,0xD9),(0x0053,0xE2),(0x0054,0xE3),(0x0055,0xE4),(0x0056,0xE5),(0x0057,0xE6),
    (0x0058,0xE7),(0x0059,0xE8),(0x005A,0xE9),(0x005B,0x4A),(0x005C,0xE0),(0x005D,0x5A),(0x005E,0x5F),(0x005F,0x6D),
    (0x0061,0x81),(0x0062,0x82),(0x0063,0x83),(0x0064,0x84),(0x0065,0x85),(0x0066,0x86),(0x0067,0x87),(0x0068,0x88),
    (0x0069,0x89),(0x006A,0x91),(0x006B,0x92),(0x006C,0x93),(0x006D,0x94),(0x006E,0x95),(0x006F,0x96),(0x0070,0x97),
    (0x0071,0x98),(0x0072,0x99),(0x0073,0xA2),(0x0074,0xA3),(0x0075,0xA4),(0x0076,0xA5),(0x0077,0xA6),(0x0078,0xA7),
    (0x0079,0xA8),(0x007A,0xA9),(0x007F,0x07),(0x0080,0x20),(0x0081,0x21),(0x0082,0x22),(0x0083,0x23),(0x0084,0x24),
    (0x0085,0x15),(0x0086,0x06),(0x0087,0x17),(0x0088,0x28),(0x0089,0x29),(0x008A,0x2A),(0x008B,0x2B),(0x008C,0x2C),
    (0x008D,0x09),(0x008E,0x0A),(0x008F,0x1B),(0x0090,0x30),(0x0091,0x31),(0x0092,0x1A),(0x0093,0x33),(0x0094,0x34),
    (0x0095,0x35),(0x0096,0x36),(0x0097,0x08),(0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),
    (0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),(0x00A4,0xE1),(0x00A6,0x6A),(0x0401,0x63),(0x0402,0x59),(0x0403,0x62),
    (0x0405,0x65),(0x0406,0x66),(0x0407,0x67),(0x0408,0x68),(0x0409,0x69),(0x040A,0x70),(0x040B,0x71),(0x040C,0x72),
    (0x040F,0x75),(0x0410,0xB9),(0x0411,0xBA),(0x0412,0xED),(0x0413,0xBF),(0x0414,0xBC),(0x0415,0xBD),(0x0416,0xEC),
    (0x0417,0xFA),(0x0418,0xCB),(0x0419,0xCC),(0x041A,0xCD),(0x041B,0xCE),(0x041C,0xCF),(0x041D,0xDA),(0x041E,0xDB),
    (0x041F,0xDC),(0x0420,0xDE),(0x0421,0xDF),(0x0422,0xEA),(0x0423,0xEB),(0x0424,0xBE),(0x0425,0xCA),(0x0426,0xBB),
    (0x0427,0xFE),(0x0428,0xFB),(0x0429,0xFD),(0x042A,0x57),(0x042B,0xEF),(0x042C,0xEE),(0x042D,0xFC),(0x042E,0xB8),
    ...
    (0x043F,0x9F),(0x0440,0xAA),(0x0441,0xAB),(0x0442,0xAC),(0x0443,0xAD),(0x0444,0x8C),(0x0445,0x8E),(0x0446,0x80),
    (0x0447,0xB6),(0x0448,0xB3),(0x0449,0xB5),(0x044A,0xB7),(0x044B,0xB1),(0x044C,0xB0),(0x044D,0xB4),(0x044E,0x76),
    (0x044F,0xA0),(0x0451,0x44),(0x0452,0x42),(0x0453,0x43),(0x0455,0x46),(0x0456,0x47),(0x0457,0x48),(0x0458,0x49),
    (0x0459,0x51),(0x045A,0x52),(0x045B,0x53),(0x045C,0x54),(0x045F,0x56),(0x2116,0x58),
];

const CP1112_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    ...
    (0x0090,0x30),(0x0091,0x31),(0x0092,0x1A),(0x0093,0x33),(0x0094,0x34),(0x0095,0x35),(0x0096,0x36),(0x0097,0x08),
    (0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),
    (0x00A0,0x41),(0x00A2,0x4A),(0x00A3,0xB1),(0x00A4,0x9F),(0x00A6,0x6A),(0x00A7,0xB5),(0x00A9,0xB4),(0x00AB,0x8A),
    (0x00AC,0x5F),(0x00AD,0xCA),(0x00AE,0xAF),(0x00B0,0x90),(0x00B1,0x8F),(0x00B2,0xEA),(0x00B3,0xFA),(0x00B5,0xA0),
    (0x00B6,0xB6),(0x00B7,0xB3),(0x00B9,0xDA),(0x00BB,0x8B),(0x00BC,0xB7),(0x00BD,0xB8),(0x00BE,0xB9),(0x00C4,0x63),
    (0x00C5,0x67),(0x00C6,0x9E),(0x00C9,0x71),(0x00D3,0xEE),(0x00D5,0xEF),(0x00D6,0xEC),(0x00D7,0xBF),(0x00D8,0x80),
    (0x00DC,0xFC),(0x00DF,0x59),(0x00E4,0x43),(0x00E5,0x47),(0x00E6,0x9C),(0x00E9,0x51),(0x00F3,0xCE),(0x00F5,0xCF),
    (0x00F6,0xCC),(0x00F7,0xE1),(0x00F8,0x70),(0x00FC,0xDC),(0x0100,0xAC),(0x0101,0x8C),(0x0104,0x64),(0x0105,0x44),
    (0x0106,0xFB),(0x0107,0xDB),(0x010C,0x74),(0x010D,0x54),(0x0112,0x68),(0x0113,0x48),(0x0116,0x73),(0x0117,0x53),
    (0x0118,0x72),(0x0119,0x52),(0x0122,0x78),(0x0123,0x58),(0x012A,0x76),(0x012B,0xB2),(0x012E,0x65),(0x012F,0x45),
    (0x0136,0xBD),(0x0137,0x9D),(0x013B,0x77),(0x013C,0xBE),(0x0141,0xFD),(0x0142,0xDD),(0x0143,0xAE),(0x0144,0x8E),
    (0x0145,0xED),(0x0146,0xCD),(0x014C,0xEB),(0x014D,0xCB),(0x0156,0x9A),(0x0157,0x9B),(0x015A,0xFE),(0x015B,0xDE),
    (0x0160,0x62),(0x0161,0x42),(0x016A,0x66),(0x016B,0x46),(0x0172,0x75),(0x0173,0x55),(0x0179,0xBC),(0x017A,0xAB),
    (0x017B,0xAD),(0x017C,0x8D),(0x017D,0x69),(0x017E,0x49),(0x2019,0xDF),(0x201C,0x57),(0x201D,0xAA),(0x201E,0x56),
];

const CP1122_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    ...
    (0x0048,0xC8),(0x0049,0xC9),(0x004A,0xD1),(0x004B,0xD2),(0x004C,0xD3),(0x004D,0xD4),(0x004E,0xD5),(0x004F,0xD6),
    (0x0050,0xD7),(0x0051,0xD8),(0x0052,0xD9),(0x0053,0xE2),(0x0054,0xE3),(0x0055,0xE4),(0x0056,0xE5),(0x0057,0xE6),
    (0x0058,0xE7),(0x0059,0xE8),(0x005A,0xE9),(0x005B,0xB5),(0x005C,0x71),(0x005D,0x9F),(0x005E,0x5F),(0x005F,0x6D),
    (0x0060,0x51),(0x0061,0x81),(0x0062,0x82),(0x0063,0x83),(0x0064,0x84),(0x0065,0x85),(0x0066,0x86),(0x0067,0x87),
    (0x0068,0x88),(0x0069,0x89),(0x006A,0x91),(0x006B,0x92),(0x006C,0x93),(0x006D,0x94),(0x006E,0x95),(0x006F,0x96),
    (0x0070,0x97),(0x0071,0x98),(0x0072,0x99),(0x0073,0xA2),(0x0074,0xA3),(0x0075,0xA4),(0x0076,0xA5),(0x0077,0xA6),
    (0x0078,0xA7),(0x0079,0xA8),(0x007A,0xA9),(0x007B,0x43),(0x007C,0xBB),(0x007D,0x47),(0x007E,0xDC),(0x007F,0x07),
    ...
    (0x00B8,0x9D),(0x00B9,0xDA),(0x00BA,0x9B),(0x00BB,0x8B),(0x00BC,0xB7),(0x00BD,0xB8),(0x00BE,0xB9),(0x00BF,0xAB),
    (0x00C0,0x64),(0x00C1,0x65),(0x00C2,0x62),(0x00C3,0x66),(0x00C4,0x7B),(0x00C5,0x5B),(0x00C6,0x9E),(0x00C7,0x68),
    (0x00C8,0x74),(0x00C9,0xE0),(0x00CA,0x72),(0x00CB,0x73),(0x00CC,0x78),(0x00CD,0x75),(0x00CE,0x76),(0x00CF,0x77),
    (0x00D1,0x69),(0x00D2,0xED),(0x00D3,0xEE),(0x00D4,0xEB),(0x00D5,0xEF),(0x00D6,0x7C),(0x00D7,0xBF),(0x00D8,0x80),
    (0x00D9,0xFD),(0x00DA,0xFE),(0x00DB,0xFB),(0x00DC,0xFC),(0x00DD,0xAD),(0x00DF,0x59),(0x00E0,0x44),(0x00E1,0x45),
    (0x00E2,0x42),(0x00E3,0x46),(0x00E4,0xC0),(0x00E5,0xD0),(0x00E6,0x9C),(0x00E7,0x48),(0x00E8,0x54),(0x00E9,0x79),
    (0x00EA,0x52),(0x00EB,0x53),(0x00EC,0x58),(0x00ED,0x55),(0x00EE,0x56),(0x00EF,0x57),(0x00F1,0x49),(0x00F2,0xCD),
    (0x00F3,0xCE),(0x00F4,0xCB),(0x00F5,0xCF),(0x00F6,0x6A),(0x00F7,0xE1),(0x00F8,0x70),(0x00F9,0xDD),(0x00FA,0xDE),
    (0x00FB,0xDB),(0x00FC,0xA1),(0x00FD,0x8D),(0x00FF,0xDF),(0x0160,0xAC),(0x0161,0x8C),(0x017D,0xAE),(0x017E,0x8E),
    (0x203E,0xBC),
];

const CP1123_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    ...
    (0x0090,0x30),(0x0091,0x31),(0x0092,0x1A),(0x0093,0x33),(0x0094,0x34),(0x0095,0x35),(0x0096,0x36),(0x0097,0x08),
    (0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),
    (0x00A0,0x41),(0x00A7,0xE1),(0x00AD,0x73),(0x0401,0x63),(0x0402,0x59),(0x0404,0x64),(0x0405,0x65),(0x0406,0x66),
    (0x0407,0x67),(0x0408,0x68),(0x0409,0x69),(0x040A,0x70),(0x040B,0x71),(0x040C,0x72),(0x040E,0x74),(0x040F,0x75),
    (0x0410,0xB9),(0x0411,0xBA),(0x0412,0xED),(0x0413,0xBF),(0x0414,0xBC),(0x0415,0xBD),(0x0416,0xEC),(0x0417,0xFA),
    (0x0418,0xCB),(0x0419,0xCC),(0x041A,0xCD),(0x041B,0xCE),(0x041C,0xCF),(0x041D,0xDA),(0x041E,0xDB),(0x041F,0xDC),
    (0x0420,0xDE),(0x0421,0xDF),(0x0422,0xEA),(0x0423,0xEB),(0x0424,0xBE),(0x0425,0xCA),(0x0426,0xBB),(0x0427,0xFE),
    (0x0428,0xFB),(0x0429,0xFD),(0x042A,0x57),(0x042B,0xEF),(0x042C,0xEE),(0x042D,0xFC),(0x042E,0xB8),(0x042F,0xDD),
    (0x0430,0x77),(0x0431,0x78),(0x0432,0xAF),(0x0433,0x8D),(0x0434,0x8A),(0x0435,0x8B),(0x0436,0xAE),(0x0437,0xB2),
    (0x0438,0x8F),(0x0439,0x90),(0x043A,0x9A),(0x043B,0x9B),(0x043C,0x9C),(0x043D,0x9D),(0x043E,0x9E),(0x043F,0x9F),
    (0x0440,0xAA),(0x0441,0xAB),(0x0442,0xAC),(0x0443,0xAD),(0x0444,0x8C),(0x0445,0x8E),(0x0446,0x80),(0x0447,0xB6),
    (0x0448,0xB3),(0x0449,0xB5),(0x044A,0xB7),(0x044B,0xB1),(0x044C,0xB0),(0x044D,0xB4),(0x044E,0x76),(0x044F,0xA0),
    (0x0451,0x44),(0x0452,0x42),(0x0454,0x45),(0x0455,0x46),(0x0456,0x47),(0x0457,0x48),(0x0458,0x49),(0x0459,0x51),
    (0x045A,0x52),(0x045B,0x53),(0x045C,0x54),(0x045E,0x55),(0x045F,0x56),(0x0490,0x62),(0x0491,0x43),(0x2116,0x58),
];

const CP1130_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    ...
    (0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),
    (0x00A0,0x41),(0x00A1,0xAA),(0x00A2,0xB0),(0x00A3,0xB1),(0x00A4,0x9F),(0x00A5,0xB2),(0x00A6,0x6A),(0x00A7,0xB5),
    (0x00A9,0xB4),(0x00AA,0x9A),(0x00AB,0x8A),(0x00AC,0xBA),(0x00AD,0xCA),(0x00AE,0xAF),(0x00AF,0xBC),(0x00B0,0x90),
    (0x00B1,0x8F),(0x00B2,0xEA),(0x00B3,0xFA),(0x00B5,0xA0),(0x00B6,0xB6),(0x00B7,0xB3),(0x00B9,0xDA),(0x00BA,0x9B),
    (0x00BB,0x8B),(0x00BC,0xB7),(0x00BD,0xB8),(0x00BE,0xB9),(0x00BF,0xAB),(0x00C0,0x64),(0x00C1,0x65),(0x00C2,0x62),
    (0x00C4,0x63),(0x00C5,0x67),(0x00C6,0x9E),(0x00C7,0x68),(0x00C8,0x74),(0x00C9,0x71),(0x00CA,0x72),(0x00CB,0x73),
    (0x00CD,0x75),(0x00CE,0x76),(0x00CF,0x77),(0x00D1,0x69),(0x00D3,0xEE),(0x00D4,0xEB),(0x00D6,0xEC),(0x00D7,0xBF),
    (0x00D8,0x80),(0x00D9,0xFD),(0x00DA,0xFE),(0x00DB,0xFB),(0x00DC,0xFC),(0x00DF,0x59),(0x00E0,0x44),(0x00E1,0x45),
    (0x00E2,0x42),(0x00E4,0x43),(0x00E5,0x47),(0x00E6,0x9C),(0x00E7,0x48),(0x00E8,0x54),(0x00E9,0x51),(0x00EA,0x52),
    (0x00EB,0x53),(0x00ED,0x55),(0x00EE,0x56),(0x00EF,0x57),(0x00F1,0x49),(0x00F3,0xCE),(0x00F4,0xCB),(0x00F6,0xCC),
    (0x00F7,0xE1),(0x00F8,0x70),(0x00F9,0xDD),(0x00FA,0xDE),(0x00FB,0xDB),(0x00FC,0xDC),(0x00FF,0xDF),(0x0102,0x66),
    (0x0103,0x46),(0x0110,0xAC),(0x0111,0x8C),(0x0152,0x9D),(0x0153,0xBD),(0x0178,0xBE),(0x01A0,0xEF),(0x01A1,0xCF),
    (0x01AF,0xED),(0x01B0,0xCD),(0x0300,0x8E),(0x0301,0xAE),(0x0303,0x58),(0x0309,0x8D),(0x0323,0xAD),(0x20AB,0x78),
];

const CP1132_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    ...
    (0x0048,0xC8),(0x0049,0xC9),(0x004A,0xD1),(0x004B,0xD2),(0x004C,0xD3),(0x004D,0xD4),(0x004E,0xD5),(0x004F,0xD6),
    (0x0050,0xD7),(0x0051,0xD8),(0x0052,0xD9),(0x0053,0xE2),(0x0054,0xE3),(0x0055,0xE4),(0x0056,0xE5),(0x0057,0xE6),
    (0x0058,0xE7),(0x0059,0xE8),(0x005A,0xE9),(0x005B,0x49),(0x005C,0xE0),(0x005D,0x59),(0x005E,0x69),(0x005F,0x6D),
    (0x0060,0x79),(0x0061,0x81),(0x0062,0x82),(0x0063,0x83),(0x0064,0x84),(0x0065,0x85),(0x0066,0x86),(0x0067,0x87),
    (0x0068,0x88),(0x0069,0x89),(0x006A,0x91),(0x006B,0x92),(0x006C,0x93),(0x006D,0x94),(0x006E,0x95),(0x006F,0x96),
    (0x0070,0x97),(0x0071,0x98),(0x0072,0x99),(0x0073,0xA2),(0x0074,0xA3),(0x0075,0xA4),(0x0076,0xA5),(0x0077,0xA6),
    (0x0078,0xA7),(0x0079,0xA8),(0x007A,0xA9),(0x007B,0xC0),(0x007C,0x4F),(0x007D,0xD0),(0x007E,0xA1),(0x007F,0x07),
    ...
    (0x0090,0x30),(0x0091,0x31),(0x0092,0x1A),(0x0093,0x33),(0x0094,0x34),(0x0095,0x35),(0x0096,0x36),(0x0097,0x08),
    (0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),
    (0x00A0,0x41),(0x00A2,0x4A),(0x00A6,0x6A),(0x00AC,0x5F),(0x0E81,0x42),(0x0E82,0x43),(0x0E84,0x44),(0x0E87,0x45),
    (0x0E88,0x46),(0x0E8A,0x48),(0x0E8D,0x52),(0x0E94,0x53),(0x0E95,0x54),(0x0E96,0x55),(0x0E97,0x56),(0x0E99,0x57),
    (0x0E9A,0x58),(0x0E9B,0x62),(0x0E9C,0x63),(0x0E9D,0x64),(0x0E9E,0x65),(0x0E9F,0x66),(0x0EA1,0x67),(0x0EA2,0x68),
    (0x0EA3,0x72),(0x0EA5,0x73),(0x0EA7,0x74),(0x0EAA,0x47),(0x0EAB,0x75),(0x0EAD,0x76),(0x0EAE,0x77),(0x0EAF,0x8C),
    (0x0EB0,0x8D),(0x0EB1,0xAB),(0x0EB2,0x8E),(0x0EB3,0x8F),(0x0EB4,0x9A),(0x0EB5,0x9B),(0x0EB6,0x9C),(0x0EB7,0x9D),
    (0x0EB8,0x9E),(0x0EB9,0x9F),(0x0EBB,0xAC),(0x0EBC,0xAA),(0x0EBD,0xAD),(0x0EC0,0xBB),(0x0EC1,0xBC),(0x0EC2,0xBD),
    (0x0EC3,0xBE),(0x0EC4,0xBF),(0x0EC6,0xDB),(0x0EC8,0xCB),(0x0EC9,0xCC),(0x0ECA,0xCD),(0x0ECB,0xCE),(0x0ECC,0xCF),
    (0x0ECD,0xDA),(0x0ED0,0xB0),(0x0ED1,0xB1),(0x0ED2,0xB2),(0x0ED3,0xB3),(0x0ED4,0xB4),(0x0ED5,0xB5),(0x0ED6,0xB6),
    (0x0ED7,0xB7),(0x0ED8,0xB8),(0x0ED9,0xB9),(0x0EDC,0xDD),(0x0EDD,0xDE),
];

const CP1137_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    ...
    (0x0090,0x30),(0x0091,0x31),(0x0092,0x1A),(0x0093,0x33),(0x0094,0x34),(0x0095,0x35),(0x0096,0x36),(0x0097,0x08),
    (0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),
    (0x00A0,0x41),(0x0901,0x42),(0x0902,0x43),(0x0903,0x44),(0x0905,0x45),(0x0906,0x46),(0x0907,0x47),(0x0908,0x48),
    (0x0909,0x49),(0x090A,0x4A),(0x090B,0x51),(0x090C,0x52),(0x090D,0x53),(0x090E,0x54),(0x090F,0x55),(0x0910,0x56),
    (0x0911,0x57),(0x0912,0x58),(0x0913,0x59),(0x0914,0x62),(0x0915,0x63),(0x0916,0x64),(0x0917,0x65),(0x0918,0x66),
    (0x0919,0x67),(0x091A,0x68),(0x091B,0x69),(0x091C,0x6A),(0x091D,0x70),(0x091E,0x71),(0x091F,0x72),(0x0920,0x73),
    (0x0921,0x74),(0x0922,0x75),(0x0923,0x76),(0x0924,0x77),(0x0925,0x78),(0x0926,0x80),(0x0927,0x8A),(0x0928,0x8B),
    (0x092A,0x8C),(0x092B,0x8D),(0x092C,0x8E),(0x092D,0x8F),(0x092E,0x90),(0x092F,0x9A),(0x0930,0x9B),(0x0932,0x9C),
    (0x0933,0x9D),(0x0935,0x9E),(0x0936,0x9F),(0x0937,0xAA),(0x0938,0xAB),(0x0939,0xAC),(0x093C,0xAE),(0x093D,0xAF),
    (0x093E,0xB0),(0x093F,0xB1),(0x0940,0xB2),(0x0941,0xB3),(0x0942,0xB4),(0x0943,0xB5),(0x0944,0xB6),(0x0945,0xB7),
    (0x0946,0xB8),(0x0947,0xB9),(0x0948,0xBA),(0x0949,0xBB),(0x094A,0xBC),(0x094B,0xBE),(0x094C,0xBF),(0x094D,0xCA),
    (0x0950,0xCB),(0x0951,0xCC),(0x0952,0xCD),(0x0960,0xDA),(0x0961,0xDB),(0x0962,0xDC),(0x0963,0xDD),(0x0964,0xDE),
    (0x0965,0xDF),(0x0966,0xEA),(0x0967,0xEB),(0x0968,0xEC),(0x0969,0xED),(0x096A,0xEE),(0x096B,0xEF),(0x096C,0xFA),
    (0x096D,0xFB),(0x096E,0xFC),(0x096F,0xFD),(0x0970,0xFE),(0x200C,0xA0),(0x200D,0xE1),
];

const CP1141_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    ...
    (0x0090,0x30),(0x0091,0x31),(0x0092,0x1A),(0x0093,0x33),(0x0094,0x34),(0x0095,0x35),(0x0096,0x36),(0x0097,0x08),
    (0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),
    (0x00A0,0x41),(0x00A1,0xAA),(0x00A2,0xB0),(0x00A3,0xB1),(0x00A5,0xB2),(0x00A6,0xCC),(0x00A7,0x7C),(0x00A8,0xBD),
    (0x00A9,0xB4),(0x00AA,0x9A),(0x00AB,0x8A),(0x00AC,0xBA),(0x00AD,0xCA),(0x00AE,0xAF),(0x00AF,0xBC),(0x00B0,0x90),
    (0x00B1,0x8F),(0x00B2,0xEA),(0x00B3,0xFA),(0x00B4,0xBE),(0x00B5,0xA0),(0x00B6,0xB6),(0x00B7,0xB3),(0x00B8,0x9D),
    (0x00B9,0xDA),(0x00BA,0x9B),(0x00BB,0x8B),(0x00BC,0xB7),(0x00BD,0xB8),(0x00BE,0xB9),(0x00BF,0xAB),(0x00C0,0x64),
    (0x00C1,0x65),(0x00C2,0x62),(0x00C3,0x66),(0x00C4,0x4A),(0x00C5,0x67),(0x00C6,0x9E),(0x00C7,0x68),(0x00C8,0x74),
    (0x00C9,0x71),(0x00CA,0x72),(0x00CB,0x73),(0x00CC,0x78),(0x00CD,0x75),(0x00CE,0x76),(0x00CF,0x77),(0x00D0,0xAC),
    (0x00D1,0x69),(0x00D2,0xED),(0x00D3,0xEE),(0x00D4,0xEB),(0x00D5,0xEF),(0x00D6,0xE0),(0x00D7,0xBF),(0x00D8,0x80),
    (0x00D9,0xFD),(0x00DA,0xFE),(0x00DB,0xFB),(0x00DC,0x5A),(0x00DD,0xAD),(0x00DE,0xAE),(0x00DF,0xA1),(0x00E0,0x44),
    (0x00E1,0x45),(0x00E2,0x42),(0x00E3,0x46),(0x00E4,0xC0),(0x00E5,0x47),(0x00E6,0x9C),(0x00E7,0x48),(0x00E8,0x54),
    (0x00E9,0x51),(0x00EA,0x52),(0x00EB,0x53),(0x00EC,0x58),(0x00ED,0x55),(0x00EE,0x56),(0x00EF,0x57),(0x00F0,0x8C),
    (0x00F1,0x49),(0x00F2,0xCD),(0x00F3,0xCE),(0x00F4,0xCB),(0x00F5,0xCF),(0x00F6,0x6A),(0x00F7,0xE1),(0x00F8,0x70),
    (0x00F9,0xDD),(0x00FA,0xDE),(0x00FB,0xDB),(0x00FC,0xD0),(0x00FD,0x8D),(0x00FE,0x8E),(0x00FF,0xDF),(0x203E,0xBC),
    (0x20AC,0x9F),
];

const CP1142_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    ...
    (0x0090,0x30),(0x0091,0x31),(0x0092,0x1A),(0x0093,0x33),(0x0094,0x34),(0x0095,0x35),(0x0096,0x36),(0x0097,0x08),
    (0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),
    (0x00A0,0x41),(0x00A1,0xAA),(0x00A2,0xB0),(0x00A3,0xB1),(0x00A5,0xB2),(0x00A6,0x70),(0x00A7,0xB5),(0x00A8,0xBD),
    (0x00A9,0xB4),(0x00AA,0x9A),(0x00AB,0x8A),(0x00AC,0xBA),(0x00AD,0xCA),(0x00AE,0xAF),(0x00AF,0xBC),(0x00B0,0x90),
    (0x00B1,0x8F),(0x00B2,0xEA),(0x00B3,0xFA),(0x00B4,0xBE),(0x00B5,0xA0),(0x00B6,0xB6),(0x00B7,0xB3),(0x00B8,0x9D),
    (0x00B9,0xDA),(0x00BA,0x9B),(0x00BB,0x8B),(0x00BC,0xB7),(0x00BD,0xB8),(0x00BE,0xB9),(0x00BF,0xAB),(0x00C0,0x64),
    (0x00C1,0x65),(0x00C2,0x62),(0x00C3,0x66),(0x00C4,0x63),(0x00C5,0x5B),(0x00C6,0x7B),(0x00C7,0x68),(0x00C8,0x74),
    (0x00C9,0x71),(0x00CA,0x72),(0x00CB,0x73),(0x00CC,0x78),(0x00CD,0x75),(0x00CE,0x76),(0x00CF,0x77),(0x00D0,0xAC),
    (0x00D1,0x69),(0x00D2,0xED),(0x00D3,0xEE),(0x00D4,0xEB),(0x00D5,0xEF),(0x00D6,0xEC),(0x00D7,0xBF),(0x00D8,0x7C),
    (0x00D9,0xFD),(0x00DA,0xFE),(0x00DB,0xFB),(0x00DC,0xFC),(0x00DD,0xAD),(0x00DE,0xAE),(0x00DF,0x59),(0x00E0,0x44),
    (0x00E1,0x45),(0x00E2,0x42),(0x00E3,0x46),(0x00E4,0x43),(0x00E5,0xD0),(0x00E6,0xC0),(0x00E7,0x48),(0x00E8,0x54),
    (0x00E9,0x51),(0x00EA,0x52),(0x00EB,0x53),(0x00EC,0x58),(0x00ED,0x55),(0x00EE,0x56),(0x00EF,0x57),(0x00F0,0x8C),
    (0x00F1,0x49),(0x00F2,0xCD),(0x00F3,0xCE),(0x00F4,0xCB),(0x00F5,0xCF),(0x00F6,0xCC),(0x00F7,0xE1),(0x00F8,0x6A),
    (0x00F9,0xDD),(0x00FA,0xDE),(0x00FB,0xDB),(0x00FC,0xA1),(0x00FD,0x8D),(0x00FE,0x8E),(0x00FF,0xDF),(0x203E,0xBC),
    (0x20AC,0x5A),
];

const CP1143_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    ...
    (0x0090,0x30),(0x0091,0x31),(0x0092,0x1A),(0x0093,0x33),(0x0094,0x34),(0x0095,0x35),(0x0096,0x36),(0x0097,0x08),
    (0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),
    (0x00A0,0x41),(0x00A1,0xAA),(0x00A2,0xB0),(0x00A3,0xB1),(0x00A5,0xB2),(0x00A6,0xCC),(0x00A7,0x4A),(0x00A8,0xBD),
    (0x00A9,0xB4),(0x00AA,0x9A),(0x00AB,0x8A),(0x00AC,0xBA),(0x00AD,0xCA),(0x00AE,0xAF),(0x00AF,0xBC),(0x00B0,0x90),
    (0x00B1,0x8F),(0x00B2,0xEA),(0x00B3,0xFA),(0x00B4,0xBE),(0x00B5,0xA0),(0x00B6,0xB6),(0x00B7,0xB3),(0x00B8,0x9D),
    (0x00B9,0xDA),(0x00BA,0x9B),(0x00BB,0x8B),(0x00BC,0xB7),(0x00BD,0xB8),(0x00BE,0xB9),(0x00BF,0xAB),(0x00C0,0x64),
    (0x00C1,0x65),(0x00C2,0x62),(0x00C3,0x66),(0x00C4,0x7B),(0x00C5,0x5B),(0x00C6,0x9E),(0x00C7,0x68),(0x00C8,0x74),
    (0x00C9,0xE0),(0x00CA,0x72),(0x00CB,0x73),(0x00CC,0x78),(0x00CD,0x75),(0x00CE,0x76),(0x00CF,0x77),(0x00D0,0xAC),
    (0x00D1,0x69),(0x00D2,0xED),(0x00D3,0xEE),(0x00D4,0xEB),(0x00D5,0xEF),(0x00D6,0x7C),(0x00D7,0xBF),(0x00D8,0x80),
    (0x00D9,0xFD),(0x00DA,0xFE),(0x00DB,0xFB),(0x00DC,0xFC),(0x00DD,0xAD),(0x00DE,0xAE),(0x00DF,0x59),(0x00E0,0x44),
    (0x00E1,0x45),(0x00E2,0x42),(0x00E3,0x46),(0x00E4,0xC0),(0x00E5,0xD0),(0x00E6,0x9C),(0x00E7,0x48),(0x00E8,0x54),
    (0x00E9,0x79),(0x00EA,0x52),(0x00EB,0x53),(0x00EC,0x58),(0x00ED,0x55),(0x00EE,0x56),(0x00EF,0x57),(0x00F0,0x8C),
    (0x00F1,0x49),(0x00F2,0xCD),(0x00F3,0xCE),(0x00F4,0xCB),(0x00F5,0xCF),(0x00F6,0x6A),(0x00F7,0xE1),(0x00F8,0x70),
    (0x00F9,0xDD),(0x00FA,0xDE),(0x00FB,0xDB),(0x00FC,0xA1),(0x00FD,0x8D),(0x00FE,0x8E),(0x00FF,0xDF),(0x203E,0xBC),
    (0x20AC,0x5A),
];

const CP1144_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    ...
    (0x0090,0x30),(0x0091,0x31),(0x0092,0x1A),(0x0093,0x33),(0x0094,0x34),(0x0095,0x35),(0x0096,0x36),(0x0097,0x08),
    (0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),
    (0x00A0,0x41),(0x00A1,0xAA),(0x00A2,0xB0),(0x00A3,0x7B),(0x00A5,0xB2),(0x00A6,0xCD),(0x00A7,0x7C),(0x00A8,0xBD),
    (0x00A9,0xB4),(0x00AA,0x9A),(0x00AB,0x8A),(0x00AC,0xBA),(0x00AD,0xCA),(0x00AE,0xAF),(0x00AF,0xBC),(0x00B0,0x4A),
    (0x00B1,0x8F),(0x00B2,0xEA),(0x00B3,0xFA),(0x00B4,0xBE),(0x00B5,0xA0),(0x00B6,0xB6),(0x00B7,0xB3),(0x00B8,0x9D),
    (0x00B9,0xDA),(0x00BA,0x9B),(0x00BB,0x8B),(0x00BC,0xB7),(0x00BD,0xB8),(0x00BE,0xB9),(0x00BF,0xAB),(0x00C0,0x64),
    (0x00C1,0x65),(0x00C2,0x62),(0x00C3,0x66),(0x00C4,0x63),(0x00C5,0x67),(0x00C6,0x9E),(0x00C7,0x68),(0x00C8,0x74),
    (0x00C9,0x71),(0x00CA,0x72),(0x00CB,0x73),(0x00CC,0x78),(0x00CD,0x75),(0x00CE,0x76),(0x00CF,0x77),(0x00D0,0xAC),
    (0x00D1,0x69),(0x00D2,0xED),(0x00D3,0xEE),(0x00D4,0xEB),(0x00D5,0xEF),(0x00D6,0xEC),(0x00D7,0xBF),(0x00D8,0x80),
    (0x00D9,0xFD),(0x00DA,0xFE),(0x00DB,0xFB),(0x00DC,0xFC),(0x00DD,0xAD),(0x00DE,0xAE),(0x00DF,0x59),(0x00E0,0xC0),
    (0x00E1,0x45),(0x00E2,0x42),(0x00E3,0x46),(0x00E4,0x43),(0x00E5,0x47),(0x00E6,0x9C),(0x00E7,0xE0),(0x00E8,0xD0),
    (0x00E9,0x5A),(0x00EA,0x52),(0x00EB,0x53),(0x00EC,0xA1),(0x00ED,0x55),(0x00EE,0x56),(0x00EF,0x57),(0x00F0,0x8C),
    (0x00F1,0x49),(0x00F2,0x6A),(0x00F3,0xCE),(0x00F4,0xCB),(0x00F5,0xCF),(0x00F6,0xCC),(0x00F7,0xE1),(0x00F8,0x70),
    (0x00F9,0x79),(0x00FA,0xDE),(0x00FB,0xDB),(0x00FC,0xDC),(0x00FD,0x8D),(0x00FE,0x8E),(0x00FF,0xDF),(0x203E,0xBC),
    (0x20AC,0x9F),
];

const CP1145_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    ...
    (0x0090,0x30),(0x0091,0x31),(0x0092,0x1A),(0x0093,0x33),(0x0094,0x34),(0x0095,0x35),(0x0096,0x36),(0x0097,0x08),
    (0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),
    (0x00A0,0x41),(0x00A1,0xAA),(0x00A2,0xB0),(0x00A3,0xB1),(0x00A5,0xB2),(0x00A6,0x49),(0x00A7,0xB5),(0x00A8,0xA1),
    (0x00A9,0xB4),(0x00AA,0x9A),(0x00AB,0x8A),(0x00AC,0x5F),(0x00AD,0xCA),(0x00AE,0xAF),(0x00AF,0xBC),(0x00B0,0x90),
    (0x00B1,0x8F),(0x00B2,0xEA),(0x00B3,0xFA),(0x00B4,0xBE),(0x00B5,0xA0),(0x00B6,0xB6),(0x00B7,0xB3),(0x00B8,0x9D),
    (0x00B9,0xDA),(0x00BA,0x9B),(0x00BB,0x8B),(0x00BC,0xB7),(0x00BD,0xB8),(0x00BE,0xB9),(0x00BF,0xAB),(0x00C0,0x64),
    (0x00C1,0x65),(0x00C2,0x62),(0x00C3,0x66),(0x00C4,0x63),(0x00C5,0x67),(0x00C6,0x9E),(0x00C7,0x68),(0x00C8,0x74),
    (0x00C9,0x71),(0x00CA,0x72),(0x00CB,0x73),(0x00CC,0x78),(0x00CD,0x75),(0x00CE,0x76),(0x00CF,0x77),(0x00D0,0xAC),
    (0x00D1,0x7B),(0x00D2,0xED),(0x00D3,0xEE),(0x00D4,0xEB),(0x00D5,0xEF),(0x00D6,0xEC),(0x00D7,0xBF),(0x00D8,0x80),
    (0x00D9,0xFD),(0x00DA,0xFE),(0x00DB,0xFB),(0x00DC,0xFC),(0x00DD,0xAD),(0x00DE,0xAE),(0x00DF,0x59),(0x00E0,0x44),
    (0x00E1,0x45),(0x00E2,0x42),(0x00E3,0x46),(0x00E4,0x43),(0x00E5,0x47),(0x00E6,0x9C),(0x00E7,0x48),(0x00E8,0x54),
    (0x00E9,0x51),(0x00EA,0x52),(0x00EB,0x53),(0x00EC,0x58),(0x00ED,0x55),(0x00EE,0x56),(0x00EF,0x57),(0x00F0,0x8C),
    (0x00F1,0x6A),(0x00F2,0xCD),(0x00F3,0xCE),(0x00F4,0xCB),(0x00F5,0xCF),(0x00F6,0xCC),(0x00F7,0xE1),(0x00F8,0x70),
    (0x00F9,0xDD),(0x00FA,0xDE),(0x00FB,0xDB),(0x00FC,0xDC),(0x00FD,0x8D),(0x00FE,0x8E),(0x00FF,0xDF),(0x203E,0xBC),
    (0x20AC,0x9F),
];

const CP1146_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    ...
    (0x0090,0x30),(0x0091,0x31),(0x0092,0x1A),(0x0093,0x33),(0x0094,0x34),(0x0095,0x35),(0x0096,0x36),(0x0097,0x08),
    (0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),
    (0x00A0,0x41),(0x00A1,0xAA),(0x00A2,0xB0),(0x00A3,0x5B),(0x00A5,0xB2),(0x00A6,0x6A),(0x00A7,0xB5),(0x00A8,0xBD),
    (0x00A9,0xB4),(0x00AA,0x9A),(0x00AB,0x8A),(0x00AC,0x5F),(0x00AD,0xCA),(0x00AE,0xAF),(0x00AF,0xA1),(0x00B0,0x90),
    (0x00B1,0x8F),(0x00B2,0xEA),(0x00B3,0xFA),(0x00B4,0xBE),(0x00B5,0xA0),(0x00B6,0xB6),(0x00B7,0xB3),(0x00B8,0x9D),
    (0x00B9,0xDA),(0x00BA,0x9B),(0x00BB,0x8B),(0x00BC,0xB7),(0x00BD,0xB8),(0x00BE,0xB9),(0x00BF,0xAB),(0x00C0,0x64),
    (0x00C1,0x65),(0x00C2,0x62),(0x00C3,0x66),(0x00C4,0x63),(0x00C5,0x67),(0x00C6,0x9E),(0x00C7,0x68),(0x00C8,0x74),
    (0x00C9,0x71),(0x00CA,0x72),(0x00CB,0x73),(0x00CC,0x78),(0x00CD,0x75),(0x00CE,0x76),(0x00CF,0x77),(0x00D0,0xAC),
...
const CP1147_ENC: &[(u16, u8)] = &[
    ...
    (0x0090,0x30),(0x0091,0x31),(0x0092,0x1A),(0x0093,0x33),(0x0094,0x34),(0x0095,0x35),(0x0096,0x36),(0x0097,0x08),
    (0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),
    (0x00A0,0x41),(0x00A1,0xAA),(0x00A2,0xB0),(0x00A3,0x7B),(0x00A5,0xB2),(0x00A6,0xDD),(0x00A7,0x5A),(0x00A8,0xA1),
    (0x00A9,0xB4),(0x00AA,0x9A),(0x00AB,0x8A),(0x00AC,0xBA),(0x00AD,0xCA),(0x00AE,0xAF),(0x00AF,0xBC),(0x00B0,0x4A),
    (0x00B1,0x8F),(0x00B2,0xEA),(0x00B3,0xFA),(0x00B4,0xBE),(0x00B5,0x79),(0x00B6,0xB6),(0x00B7,0xB3),(0x00B8,0x9D),
    (0x00B9,0xDA),(0x00BA,0x9B),(0x00BB,0x8B),(0x00BC,0xB7),(0x00BD,0xB8),(0x00BE,0xB9),(0x00BF,0xAB),(0x00C0,0x64),
    (0x00C1,0x65),(0x00C2,0x62),(0x00C3,0x66),(0x00C4,0x63),(0x00C5,0x67),(0x00C6,0x9E),(0x00C7,0x68),(0x00C8,0x74),
    (0x00C9,0x71),(0x00CA,0x72),(0x00CB,0x73),(0x00CC,0x78),(0x00CD,0x75),(0x00CE,0x76),(0x00CF,0x77),(0x00D0,0xAC),
    (0x00D1,0x69),(0x00D2,0xED),(0x00D3,0xEE),(0x00D4,0xEB),(0x00D5,0xEF),(0x00D6,0xEC),(0x00D7,0xBF),(0x00D8,0x80),
    (0x00D9,0xFD),(0x00DA,0xFE),(0x00DB,0xFB),(0x00DC,0xFC),(0x00DD,0xAD),(0x00DE,0xAE),(0x00DF,0x59),(0x00E0,0x7C),
    (0x00E1,0x45),(0x00E2,0x42),(0x00E3,0x46),(0x00E4,0x43),(0x00E5,0x47),(0x00E6,0x9C),(0x00E7,0xE0),(0x00E8,0xD0),
    (0x00E9,0xC0),(0x00EA,0x52),(0x00EB,0x53),(0x00EC,0x58),(0x00ED,0x55),(0x00EE,0x56),(0x00EF,0x57),(0x00F0,0x8C),
    (0x00F1,0x49),(0x00F2,0xCD),(0x00F3,0xCE),(0x00F4,0xCB),(0x00F5,0xCF),(0x00F6,0xCC),(0x00F7,0xE1),(0x00F8,0x70),
    (0x00F9,0x6A),(0x00FA,0xDE),(0x00FB,0xDB),(0x00FC,0xDC),(0x00FD,0x8D),(0x00FE,0x8E),(0x00FF,0xDF),(0x203E,0xBC),
    (0x20AC,0x9F),
];

const CP1148_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    ...
    (0x0090,0x30),(0x0091,0x31),(0x0092,0x1A),(0x0093,0x33),(0x0094,0x34),(0x0095,0x35),(0x0096,0x36),(0x0097,0x08),
    (0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),
    (0x00A0,0x41),(0x00A1,0xAA),(0x00A2,0xB0),(0x00A3,0xB1),(0x00A5,0xB2),(0x00A6,0x6A),(0x00A7,0xB5),(0x00A8,0xBD),
    (0x00A9,0xB4),(0x00AA,0x9A),(0x00AB,0x8A),(0x00AC,0xBA),(0x00AD,0xCA),(0x00AE,0xAF),(0x00AF,0xBC),(0x00B0,0x90),
    (0x00B1,0x8F),(0x00B2,0xEA),(0x00B3,0xFA),(0x00B4,0xBE),(0x00B5,0xA0),(0x00B6,0xB6),(0x00B7,0xB3),(0x00B8,0x9D),
    (0x00B9,0xDA),(0x00BA,0x9B),(0x00BB,0x8B),(0x00BC,0xB7),(0x00BD,0xB8),(0x00BE,0xB9),(0x00BF,0xAB),(0x00C0,0x64),
    (0x00C1,0x65),(0x00C2,0x62),(0x00C3,0x66),(0x00C4,0x63),(0x00C5,0x67),(0x00C6,0x9E),(0x00C7,0x68),(0x00C8,0x74),
...
const CP1149_ENC: &[(u16, u8)] = &[
    ...
    (0x00A0,0x41),(0x00A1,0xAA),(0x00A2,0xB0),(0x00A3,0xB1),(0x00A5,0xB2),(0x00A6,0x6A),(0x00A7,0xB5),(0x00A8,0xBD),
    (0x00A9,0xB4),(0x00AA,0x9A),(0x00AB,0x8A),(0x00AC,0xBA),(0x00AD,0xCA),(0x00AE,0xAF),(0x00AF,0xBC),(0x00B0,0x90),
    (0x00B1,0x8F),(0x00B2,0xEA),(0x00B3,0xFA),(0x00B4,0xE0),(0x00B5,0xA0),(0x00B6,0xB6),(0x00B7,0xB3),(0x00B8,0x9D),
    (0x00B9,0xDA),(0x00BA,0x9B),(0x00BB,0x8B),(0x00BC,0xB7),(0x00BD,0xB8),(0x00BE,0xB9),(0x00BF,0xAB),(0x00C0,0x64),
    (0x00C1,0x65),(0x00C2,0x62),(0x00C3,0x66),(0x00C4,0x63),(0x00C5,0x67),(0x00C6,0x5A),(0x00C7,0x68),(0x00C8,0x74),
    (0x00C9,0x71),(0x00CA,0x72),(0x00CB,0x73),(0x00CC,0x78),(0x00CD,0x75),(0x00CE,0x76),(0x00CF,0x77),(0x00D0,0x7C),
    (0x00D1,0x69),(0x00D2,0xED),(0x00D3,0xEE),(0x00D4,0xEB),(0x00D5,0xEF),(0x00D6,0x5F),(0x00D7,0xBF),(0x00D8,0x80),
    (0x00D9,0xFD),(0x00DA,0xFE),(0x00DB,0xFB),(0x00DC,0xFC),(0x00DD,0xAD),(0x00DE,0x4A),(0x00DF,0x59),(0x00E0,0x44),
    (0x00E1,0x45),(0x00E2,0x42),(0x00E3,0x46),(0x00E4,0x43),(0x00E5,0x47),(0x00E6,0xD0),(0x00E7,0x48),(0x00E8,0x54),
    (0x00E9,0x51),(0x00EA,0x52),(0x00EB,0x53),(0x00EC,0x58),(0x00ED,0x55),(0x00EE,0x56),(0x00EF,0x57),(0x00F0,0x79),
    (0x00F1,0x49),(0x00F2,0xCD),(0x00F3,0xCE),(0x00F4,0xCB),(0x00F5,0xCF),(0x00F6,0xA1),(0x00F7,0xE1),(0x00F8,0x70),
    (0x00F9,0xDD),(0x00FA,0xDE),(0x00FB,0xDB),(0x00FC,0xDC),(0x00FD,0x8D),(0x00FE,0xC0),(0x00FF,0xDF),(0x203E,0xBC),
    (0x20AC,0x9F),
];

const CP12712_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    ...
    (0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),
    (0x00A0,0x74),(0x00A2,0x4A),(0x00A3,0xB1),(0x00A4,0x9F),(0x00A5,0xB2),(0x00A6,0x6A),(0x00A7,0xB5),(0x00A8,0xBD),
    (0x00A9,0xB4),(0x00AB,0x8A),(0x00AC,0x5F),(0x00AD,0xCA),(0x00AE,0xAF),(0x00B0,0x90),(0x00B1,0x8F),(0x00B2,0xEA),
    (0x00B3,0xFA),(0x00B4,0xBE),(0x00B5,0xA0),(0x00B6,0xB6),(0x00B8,0x9D),(0x00B9,0xDA),(0x00BB,0x8B),(0x00BC,0xB7),
    (0x00BD,0xB8),(0x00BE,0xB9),(0x00D7,0xBF),(0x00F7,0xE1),(0x05D0,0x41),(0x05D1,0x42),(0x05D2,0x43),(0x05D3,0x44),
    (0x05D4,0x45),(0x05D5,0x46),(0x05D6,0x47),(0x05D7,0x48),(0x05D8,0x49),(0x05D9,0x51),(0x05DA,0x52),(0x05DB,0x53),
    (0x05DC,0x54),(0x05DD,0x55),(0x05DE,0x56),(0x05DF,0x57),(0x05E0,0x58),(0x05E1,0x59),(0x05E2,0x62),(0x05E3,0x63),
    (0x05E4,0x64),(0x05E5,0x65),(0x05E6,0x66),(0x05E7,0x67),(0x05E8,0x68),(0x05E9,0x69),(0x05EA,0x71),(0x200E,0xFD),
    (0x200F,0xFE),(0x2017,0x78),(0x2022,0xB3),(0x202A,0xFB),(0x202B,0xFC),(0x202C,0xDD),(0x202D,0xDB),(0x202E,0xDC),
    (0x203E,0xBC),(0x20AA,0x9E),(0x20AC,0x9C),
];

const CP16804_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    ...
    (0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),
    (0x00A0,0x41),(0x00A2,0x4A),(0x00A6,0x6A),(0x00AC,0x5F),(0x00AD,0xCA),(0x00D7,0xE0),(0x00F7,0xA1),(0x060C,0x79),
    (0x061B,0xC0),(0x061F,0xD0),(0x0621,0x46),(0x0622,0x47),(0x0623,0x49),(0x0624,0x52),(0x0625,0x56),(0x0626,0x55),
    (0x0627,0x56),(0x0628,0x58),(0x0629,0x62),(0x062A,0x63),(0x062B,0x65),(0x062C,0x67),(0x062D,0x69),(0x062E,0x71),
    (0x062F,0x73),(0x0630,0x74),(0x0631,0x75),(0x0632,0x76),(0x0633,0x77),(0x0634,0x80),(0x0635,0x8B),(0x0636,0x8D),
    (0x0637,0x8F),(0x0638,0x90),(0x0639,0x9A),(0x063A,0x9E),(0x0640,0x44),(0x0641,0xAB),(0x0642,0xAD),(0x0643,0xAF),
    (0x0644,0xB1),(0x0645,0xBB),(0x0646,0xBD),(0x0647,0xBF),(0x0648,0xCF),(0x0649,0xDA),(0x064A,0xDC),(0x0651,0x42),
    (0x0660,0xDF),(0x0661,0xEA),(0x0662,0xEB),(0x0663,0xED),(0x0664,0xEE),(0x0665,0xEF),(0x0666,0xFB),(0x0667,0xFC),
    (0x0668,0xFD),(0x0669,0xFE),(0x066A,0x6C),(0x066B,0x6B),(0x066C,0x4B),(0x066D,0x5C),(0x2007,0xE1),(0x200B,0x45),
    (0x20AC,0xFA),(0xFE7C,0x42),(0xFE7D,0x43),(0xFE80,0x46),(0xFE81,0x47),(0xFE82,0x48),(0xFE83,0x49),(0xFE84,0x51),
    (0xFE85,0x52),(0xFE86,0x52),(0xFE87,0x56),(0xFE88,0x57),(0xFE8B,0x55),(0xFE8C,0x55),(0xFE8D,0x56),(0xFE8E,0x57),
    (0xFE8F,0x58),(0xFE90,0x58),(0xFE91,0x59),(0xFE92,0x59),(0xFE93,0x62),(0xFE94,0x62),(0xFE95,0x63),(0xFE96,0x63),
    (0xFE97,0x64),(0xFE98,0x64),(0xFE99,0x65),(0xFE9A,0x65),(0xFE9B,0x66),(0xFE9C,0x66),(0xFE9D,0x67),(0xFE9E,0x67),
    (0xFE9F,0x68),(0xFEA0,0x68),(0xFEA1,0x69),(0xFEA2,0x69),(0xFEA3,0x70),(0xFEA4,0x70),(0xFEA5,0x71),(0xFEA6,0x71),
    (0xFEA7,0x72),(0xFEA8,0x72),(0xFEA9,0x73),(0xFEAA,0x73),(0xFEAB,0x74),(0xFEAC,0x74),(0xFEAD,0x75),(0xFEAE,0x75),
    (0xFEAF,0x76),(0xFEB0,0x76),(0xFEB1,0x77),(0xFEB2,0x77),(0xFEB3,0x78),(0xFEB4,0x78),(0xFEB5,0x80),(0xFEB6,0x80),
    (0xFEB7,0x8A),(0xFEB8,0x8A),(0xFEB9,0x8B),(0xFEBA,0x8B),(0xFEBB,0x8C),(0xFEBC,0x8C),(0xFEBD,0x8D),(0xFEBE,0x8D),
    (0xFEBF,0x8E),(0xFEC0,0x8E),(0xFEC1,0x8F),(0xFEC2,0x8F),(0xFEC3,0x8F),(0xFEC4,0x8F),(0xFEC5,0x90),(0xFEC6,0x90),
    (0xFEC7,0x90),(0xFEC8,0x90),(0xFEC9,0x9A),(0xFECA,0x9B),(0xFECB,0x9C),(0xFECC,0x9D),(0xFECD,0x9E),(0xFECE,0x9F),
    (0xFECF,0xA0),(0xFED0,0xAA),(0xFED1,0xAB),(0xFED2,0xAB),(0xFED3,0xAC),(0xFED4,0xAC),(0xFED5,0xAD),(0xFED6,0xAD),
    (0xFED7,0xAE),(0xFED8,0xAE),(0xFED9,0xAF),(0xFEDA,0xAF),(0xFEDB,0xB0),(0xFEDC,0xB0),(0xFEDD,0xB1),(0xFEDE,0xB1),
    (0xFEDF,0xBA),(0xFEE0,0xBA),(0xFEE1,0xBB),(0xFEE2,0xBB),(0xFEE3,0xBC),(0xFEE4,0xBC),(0xFEE5,0xBD),(0xFEE6,0xBD),
    (0xFEE7,0xBE),(0xFEE8,0xBE),(0xFEE9,0xBF),(0xFEEA,0xBF),(0xFEEB,0xCB),(0xFEEC,0xCD),(0xFEED,0xCF),(0xFEEE,0xCF),
    (0xFEEF,0xDA),(0xFEF0,0xDB),(0xFEF1,0xDC),(0xFEF2,0xDD),(0xFEF3,0xDE),(0xFEF4,0xDE),(0xFEF5,0xB2),(0xFEF6,0xB3),
    (0xFEF7,0xB4),(0xFEF8,0xB5),(0xFEF9,0xB8),(0xFEFA,0xB9),(0xFEFB,0xB8),(0xFEFC,0xB9),
];

const CP4517_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    (0x0020,0x40),(0x0021,0x4F),(0x0022,0x7F),(0x0024,0x5B),(0x0025,0x6C),(0x0026,0x50),(0x0027,0x7D),(0x0028,0x4D),
    (0x0029,0x5D),(0x002A,0x5C),(0x002B,0x4E),(0x002C,0x6B),(0x002D,0x60),(0x002E,0x4B),(0x002F,0x61),(0x0030,0xF0),
    (0x0031,0xF1),(0x0032,0xF2),(0x0033,0xF3),(0x0034,0xF4),(0x0035,0xF5),(0x0036,0xF6),(0x0037,0xF7),(0x0038,0xF8),
    (0x0039,0xF9),(0x003A,0x7A),(0x003B,0x5E),(0x003C,0x4C),(0x003D,0x7E),(0x003E,0x6E),(0x003F,0x6F),(0x0041,0xC1),
    (0x0042,0xC2),(0x0043,0xC3),(0x0044,0xC4),(0x0045,0xC5),(0x0046,0xC6),(0x0047,0xC7),(0x0048,0xC8),(0x0049,0xC9),
    (0x004A,0xD1),(0x004B,0xD2),(0x004C,0xD3),(0x004D,0xD4),(0x004E,0xD5),(0x004F,0xD6),(0x0050,0xD7),(0x0051,0xD8),
    (0x0052,0xD9),(0x0053,0xE2),(0x0054,0xE3),(0x0055,0xE4),(0x0056,0xE5),(0x0057,0xE6),(0x0058,0xE7),(0x0059,0xE8),
    (0x005A,0xE9),(0x005E,0x5F),(0x005F,0x6D),(0x0061,0x81),(0x0062,0x82),(0x0063,0x83),(0x0064,0x84),(0x0065,0x85),
    (0x0066,0x86),(0x0067,0x87),(0x0068,0x88),(0x0069,0x89),(0x006A,0x91),(0x006B,0x92),(0x006C,0x93),(0x006D,0x94),
    (0x006E,0x95),(0x006F,0x96),(0x0070,0x97),(0x0071,0x98),(0x0072,0x99),(0x0073,0xA2),(0x0074,0xA3),(0x0075,0xA4),
    (0x0076,0xA5),(0x0077,0xA6),(0x0078,0xA7),(0x0079,0xA8),(0x007A,0xA9),(0x007F,0x07),(0x0080,0x20),(0x0081,0x21),
    (0x0082,0x22),(0x0083,0x23),(0x0084,0x24),(0x0085,0x15),(0x0086,0x06),(0x0087,0x17),(0x0088,0x28),(0x0089,0x29),
    (0x008A,0x2A),(0x008B,0x2B),(0x008C,0x2C),(0x008D,0x09),(0x008E,0x0A),(0x008F,0x1B),(0x0090,0x30),(0x0091,0x31),
    (0x0092,0x1A),(0x0093,0x33),(0x0094,0x34),(0x0095,0x35),(0x0096,0x36),(0x0097,0x08),(0x0098,0x38),(0x0099,0x39),
    (0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),(0x00A0,0x41),(0x00A3,0x79),
    (0x00A7,0x5A),(0x00A8,0xA1),(0x00AD,0xCA),(0x00B0,0x4A),(0x00B5,0x7B),(0x00D7,0xED),(0x00E1,0x7C),(0x00E7,0xE0),
    (0x00E8,0xD0),(0x00E9,0xC0),(0x00F7,0xEA),(0x00FA,0x6A),(0x060C,0xEB),(0x061B,0xEF),(0x061F,0xEE),(0x0621,0x46),
    (0x0622,0x47),(0x0623,0x49),(0x0624,0x52),(0x0625,0x56),(0x0626,0x55),(0x0627,0x56),(0x0628,0x58),(0x0629,0x62),
    (0x062A,0x63),(0x062B,0x65),(0x062C,0x67),(0x062D,0x69),(0x062E,0x71),(0x062F,0x73),(0x0630,0x74),(0x0631,0x75),
    (0x0632,0x76),(0x0633,0x77),(0x0634,0x80),(0x0635,0x8B),(0x0636,0x8D),(0x0637,0x8F),(0x0638,0x90),(0x0639,0x9A),
    (0x063A,0x9E),(0x0640,0x44),(0x0641,0xAB),(0x0642,0xAD),(0x0643,0xAF),(0x0644,0xB1),(0x0645,0xBB),(0x0646,0xBD),
    (0x0647,0xBF),(0x0648,0xCF),(0x0649,0xDA),(0x064A,0xDC),(0x0651,0x42),(0x0660,0xF0),(0x0661,0xF1),(0x0662,0xF2),
    (0x0663,0xF3),(0x0664,0xF4),(0x0665,0xF5),(0x0666,0xF6),(0x0667,0xF7),(0x0668,0xF8),(0x0669,0xF9),(0x066A,0x6C),
    (0x066B,0x6B),(0x066C,0x4B),(0x066D,0x5C),(0x2007,0xE1),(0x200B,0x45),(0xF8F4,0x8B),(0xF8F5,0x80),(0xF8F6,0x77),
    (0xF8F7,0x8D),(0xFE70,0x40),(0xFE71,0x44),(0xFE72,0x40),(0xFE73,0x45),(0xFE74,0x40),(0xFE76,0x40),(0xFE77,0x44),
    (0xFE78,0x40),(0xFE79,0x44),(0xFE7A,0x40),(0xFE7B,0x44),(0xFE7C,0x42),(0xFE7D,0x43),(0xFE7E,0x40),(0xFE7F,0x44),
    (0xFE80,0x46),(0xFE81,0x47),(0xFE82,0x48),(0xFE83,0x49),(0xFE84,0x51),(0xFE85,0x52),(0xFE86,0x52),(0xFE87,0x56),
    (0xFE88,0x57),(0xFE89,0x55),(0xFE8A,0x55),(0xFE8B,0x55),(0xFE8C,0x55),(0xFE8D,0x56),(0xFE8E,0x57),(0xFE8F,0x58),
    (0xFE90,0x58),(0xFE91,0x59),(0xFE92,0x59),(0xFE93,0x62),(0xFE94,0x62),(0xFE95,0x63),(0xFE96,0x63),(0xFE97,0x64),
    (0xFE98,0x64),(0xFE99,0x65),(0xFE9A,0x65),(0xFE9B,0x66),(0xFE9C,0x66),(0xFE9D,0x67),(0xFE9E,0x67),(0xFE9F,0x68),
    (0xFEA0,0x68),(0xFEA1,0x69),(0xFEA2,0x69),(0xFEA3,0x70),(0xFEA4,0x70),(0xFEA5,0x71),(0xFEA6,0x71),(0xFEA7,0x72),
    (0xFEA8,0x72),(0xFEA9,0x73),(0xFEAA,0x73),(0xFEAB,0x74),(0xFEAC,0x74),(0xFEAD,0x75),(0xFEAE,0x75),(0xFEAF,0x76),
    (0xFEB0,0x76),(0xFEB1,0x77),(0xFEB2,0x77),(0xFEB3,0x78),(0xFEB4,0x78),(0xFEB5,0x80),(0xFEB6,0x80),(0xFEB7,0x8A),
    (0xFEB8,0x8A),(0xFEB9,0x8B),(0xFEBA,0x8B),(0xFEBB,0x8C),(0xFEBC,0x8C),(0xFEBD,0x8D),(0xFEBE,0x8D),(0xFEBF,0x8E),
    (0xFEC0,0x8E),(0xFEC1,0x8F),(0xFEC2,0x8F),(0xFEC3,0x8F),(0xFEC4,0x8F),(0xFEC5,0x90),(0xFEC6,0x90),(0xFEC7,0x90),
    (0xFEC8,0x90),(0xFEC9,0x9A),(0xFECA,0x9B),(0xFECB,0x9C),(0xFECC,0x9D),(0xFECD,0x9E),(0xFECE,0x9F),(0xFECF,0xA0),
    (0xFED0,0xAA),(0xFED1,0xAB),(0xFED2,0xAB),(0xFED3,0xAC),(0xFED4,0xAC),(0xFED5,0xAD),(0xFED6,0xAD),(0xFED7,0xAE),
    (0xFED8,0xAE),(0xFED9,0xAF),(0xFEDA,0xAF),(0xFEDB,0xB0),(0xFEDC,0xB0),(0xFEDD,0xB1),(0xFEDE,0xB1),(0xFEDF,0xBA),
    (0xFEE0,0xBA),(0xFEE1,0xBB),(0xFEE2,0xBB),(0xFEE3,0xBC),(0xFEE4,0xBC),(0xFEE5,0xBD),(0xFEE6,0xBD),(0xFEE7,0xBE),
    (0xFEE8,0xBE),(0xFEE9,0xBF),(0xFEEA,0xBF),(0xFEEB,0xCB),(0xFEEC,0xCD),(0xFEED,0xCF),(0xFEEE,0xCF),(0xFEEF,0xDA),
    (0xFEF0,0xDB),(0xFEF1,0xDC),(0xFEF2,0xDD),(0xFEF3,0xDE),(0xFEF4,0xDE),(0xFEF5,0xB2),(0xFEF6,0xB3),(0xFEF7,0xB4),
    (0xFEF8,0xB5),(0xFEF9,0xB8),(0xFEFA,0xB9),(0xFEFB,0xB8),(0xFEFC,0xB9),
];

const CP4971_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    ...
    (0x0090,0x30),(0x0091,0x31),(0x0092,0x1A),(0x0093,0x33),(0x0094,0x34),(0x0095,0x35),(0x0096,0x36),(0x0097,0x08),
    (0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),
    (0x00A0,0x74),(0x00A3,0xB0),(0x00A6,0xDF),(0x00A7,0xEB),(0x00A8,0x70),(0x00A9,0xFB),(0x00AB,0xEE),(0x00AC,0xEF),
    (0x00AD,0xCA),(0x00B0,0x90),(0x00B1,0xDA),(0x00B2,0xEA),(0x00B3,0xFA),(0x00B4,0xA0),(0x00B7,0xDD),(0x00BB,0xFE),
    (0x00BD,0xDB),(0x0385,0x80),(0x0386,0x71),(0x0387,0xDD),(0x0388,0x72),(0x0389,0x73),(0x038A,0x75),(0x038C,0x76),
    (0x038E,0x77),(0x038F,0x78),(0x0390,0xCC),(0x0391,0x41),(0x0392,0x42),(0x0393,0x43),(0x0394,0x44),(0x0395,0x45),
    (0x0396,0x46),(0x0397,0x47),(0x0398,0x48),(0x0399,0x49),(0x039A,0x51),(0x039B,0x52),(0x039C,0x53),(0x039D,0x54),
    (0x039E,0x55),(0x039F,0x56),(0x03A0,0x57),(0x03A1,0x58),(0x03A3,0x59),(0x03A4,0x62),(0x03A5,0x63),(0x03A6,0x64),
    (0x03A7,0x65),(0x03A8,0x66),(0x03A9,0x67),(0x03AA,0x68),(0x03AB,0x69),(0x03AC,0xB1),(0x03AD,0xB2),(0x03AE,0xB3),
    (0x03AF,0xB5),(0x03B0,0xCD),(0x03B1,0x8A),(0x03B2,0x8B),(0x03B3,0x8C),(0x03B4,0x8D),(0x03B5,0x8E),(0x03B6,0x8F),
    (0x03B7,0x9A),(0x03B8,0x9B),(0x03B9,0x9C),(0x03BA,0x9D),(0x03BB,0x9E),(0x03BC,0x9F),(0x03BD,0xAA),(0x03BE,0xAB),
    (0x03BF,0xAC),(0x03C0,0xAD),(0x03C1,0xAE),(0x03C2,0xBA),(0x03C3,0xAF),(0x03C4,0xBB),(0x03C5,0xBC),(0x03C6,0xBD),
    (0x03C7,0xBE),(0x03C8,0xBF),(0x03C9,0xCB),(0x03CA,0xB4),(0x03CB,0xB8),(0x03CC,0xB6),(0x03CD,0xB7),(0x03CE,0xB9),
    (0x03D5,0xBD),(0x2015,0xCF),(0x2018,0xCE),(0x2019,0xDE),(0x20AC,0xFC),
];
...
const CSN369103_FULL_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x04),(0x0005,0x05),(0x0006,0x06),(0x0007,0x07),
    (0x0008,0x08),(0x0009,0x09),(0x000A,0x0A),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x14),(0x0015,0x15),(0x0016,0x16),(0x0017,0x17),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x1A),(0x001B,0x1B),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    (0x0020,0x20),(0x0021,0x21),(0x0022,0x22),(0x0023,0x23),(0x0024,0xA4),(0x0025,0x25),(0x0026,0x26),(0x0027,0x27),
    (0x0028,0x28),(0x0029,0x29),(0x002A,0x2A),(0x002B,0x2B),(0x002C,0x2C),(0x002D,0x2D),(0x002E,0x2E),(0x002F,0x2F),
    (0x0030,0x30),(0x0031,0x31),(0x0032,0x32),(0x0033,0x33),(0x0034,0x34),(0x0035,0x35),(0x0036,0x36),(0x0037,0x37),
    (0x0038,0x38),(0x0039,0x39),(0x003A,0x3A),(0x003B,0x3B),(0x003C,0x3C),(0x003D,0x3D),(0x003E,0x3E),(0x003F,0x3F),
    (0x0040,0x40),(0x0041,0x41),(0x0042,0x42),(0x0043,0x43),(0x0044,0x44),(0x0045,0x45),(0x0046,0x46),(0x0047,0x47),
    ...
    (0x00A0,0xA0),(0x00A4,0x24),(0x00A7,0xA7),(0x00A8,0xA8),(0x00AD,0xAD),(0x00B0,0xB0),(0x00B4,0xB4),(0x00B8,0xB8),
...
fn decode_csn369103(input: &[u8]) -> Result<(char, usize), DecodeError> {
    decode_sbcs_full(input, &CSN369103_FULL)
}

fn encode_csn369103(ch: char, out: &mut [u8]) -> Result<usize, EncodeError> {
    encode_sbcs_full(ch, out, CSN369103_FULL_ENC)
}
...
const CP856_FULL: [u16; 256] = [
    ...
    0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0x00B5, 0xFFFF, // E0-E7
    0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0x203E, 0x00B4, // E8-EF
    0x00AD, 0x00B1, 0x2017, 0x00BE, 0x00B6, 0x00A7, 0x00F7, 0x00B8, // F0-F7
    0x00B0, 0x00A8, 0x2022, 0x00B9, 0x00B3, 0x00B2, 0x25A0, 0x00A0, // F8-FF
];

const CP856_FULL_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x04),(0x0005,0x05),(0x0006,0x06),(0x0007,0x07),
    (0x0008,0x08),(0x0009,0x09),(0x000A,0x0A),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x14),(0x0015,0x15),(0x0016,0x16),(0x0017,0x17),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x7F),(0x001B,0x1B),(0x001C,0x1A),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    ...
    (0x0070,0x70),(0x0071,0x71),(0x0072,0x72),(0x0073,0x73),(0x0074,0x74),(0x0075,0x75),(0x0076,0x76),(0x0077,0x77),
    (0x0078,0x78),(0x0079,0x79),(0x007A,0x7A),(0x007B,0x7B),(0x007C,0x7C),(0x007D,0x7D),(0x007E,0x7E),(0x007F,0x1C),
    (0x00A0,0xFF),(0x00A2,0xBD),(0x00A3,0x9C),(0x00A4,0xCF),(0x00A5,0xBE),(0x00A6,0xDD),(0x00A7,0xF5),(0x00A8,0xF9),
    (0x00A9,0xB8),(0x00AB,0xAE),(0x00AC,0xAA),(0x00AD,0xF0),(0x00AE,0xA9),(0x00B0,0xF8),(0x00B1,0xF1),(0x00B2,0xFD),
    (0x00B3,0xFC),(0x00B4,0xEF),(0x00B5,0xE6),(0x00B6,0xF4),(0x00B8,0xF7),(0x00B9,0xFB),(0x00BB,0xAF),(0x00BC,0xAC),
    (0x00BD,0xAB),(0x00BE,0xF3),(0x00D7,0x9E),(0x00F7,0xF6),(0x05D0,0x80),(0x05D1,0x81),(0x05D2,0x82),(0x05D3,0x83),
    (0x05D4,0x84),(0x05D5,0x85),(0x05D6,0x86),(0x05D7,0x87),(0x05D8,0x88),(0x05D9,0x89),(0x05DA,0x8A),(0x05DB,0x8B),
    (0x05DC,0x8C),(0x05DD,0x8D),(0x05DE,0x8E),(0x05DF,0x8F),(0x05E0,0x90),(0x05E1,0x91),(0x05E2,0x92),(0x05E3,0x93),
    (0x05E4,0x94),(0x05E5,0x95),(0x05E6,0x96),(0x05E7,0x97),(0x05E8,0x98),(0x05E9,0x99),(0x05EA,0x9A),(0x2017,0xF2),
    (0x2022,0xFA),(0x203C,0x13),(0x203E,0xEE),(0x2190,0x1B),(0x2191,0x18),(0x2192,0x1A),(0x2193,0x19),(0x2194,0x1D),
    (0x2195,0x12),(0x21A8,0x17),(0x221F,0x1C),(0x2302,0x7F),(0x2500,0xC4),(0x2502,0xB3),(0x250C,0xDA),(0x2510,0xBF),
    (0x2514,0xC0),(0x2518,0xD9),(0x251C,0xC3),(0x2524,0xB4),(0x252C,0xC2),(0x2534,0xC1),(0x253C,0xC5),(0x2550,0xCD),
    (0x2551,0xBA),(0x2554,0xC9),(0x2557,0xBB),(0x255A,0xC8),(0x255D,0xBC),(0x2560,0xCC),(0x2563,0xB9),(0x2566,0xCB),
    (0x2569,0xCA),(0x256C,0xCE),(0x2580,0xDF),(0x2584,0xDC),(0x2588,0xDB),(0x2591,0xB0),(0x2592,0xB1),(0x2593,0xB2),
    (0x25A0,0xFE),(0x25AC,0x16),(0x25B2,0x1E),(0x25BA,0x10),(0x25BC,0x1F),(0x25C4,0x11),(0x25CB,0x09),(0x25D8,0x08),
    (0x25D9,0x0A),(0x263A,0x01),(0x263B,0x02),(0x263C,0x0F),(0x2640,0x0C),(0x2642,0x0B),(0x2660,0x06),(0x2663,0x05),
    (0x2665,0x03),(0x2666,0x04),(0x266A,0x0D),(0x266B,0x0E),(0xFFE8,0xB3),(0xFFE9,0x1B),(0xFFEA,0x18),(0xFFEB,0x1A),
    (0xFFEC,0x19),(0xFFED,0xFE),(0xFFEE,0x09),
];

fn decode_cp856(input: &[u8]) -> Result<(char, usize), DecodeError> {
    decode_sbcs_full(input, &CP856_FULL)
}

fn encode_cp856(ch: char, out: &mut [u8]) -> Result<usize, EncodeError> {
    encode_sbcs_full(ch, out, CP856_FULL_ENC)
}
...
fn decode_char(enc: Encoding, input: &[u8]) -> Result<(char, usize), DecodeError> {
    match enc {
        ...
        Encoding::Cp1025 => decode_sbcs_full(input, &CP1025_TO_UNICODE),
        Encoding::Cp1026 => decode_sbcs_full(input, &CP1026_TO_UNICODE),
        Encoding::Cp420 => decode_sbcs_full(input, &CP420_TO_UNICODE),
        Encoding::Cp424 => decode_sbcs_full(input, &CP424_TO_UNICODE),
        Encoding::Cp880 => decode_sbcs_full(input, &CP880_TO_UNICODE),
        Encoding::Cp1112 => decode_sbcs_full(input, &CP1112_TO_UNICODE),
        Encoding::Cp1122 => decode_sbcs_full(input, &CP1122_TO_UNICODE),
        Encoding::Cp1123 => decode_sbcs_full(input, &CP1123_TO_UNICODE),
        Encoding::Cp1130 => decode_sbcs_full(input, &CP1130_TO_UNICODE),
        Encoding::Cp1132 => decode_sbcs_full(input, &CP1132_TO_UNICODE),
        Encoding::Cp1137 => decode_sbcs_full(input, &CP1137_TO_UNICODE),
        Encoding::Cp1141 => decode_sbcs_full(input, &CP1141_TO_UNICODE),
        Encoding::Cp1142 => decode_sbcs_full(input, &CP1142_TO_UNICODE),
        Encoding::Cp1143 => decode_sbcs_full(input, &CP1143_TO_UNICODE),
        Encoding::Cp1144 => decode_sbcs_full(input, &CP1144_TO_UNICODE),
        Encoding::Cp1145 => decode_sbcs_full(input, &CP1145_TO_UNICODE),
        Encoding::Cp1146 => decode_sbcs_full(input, &CP1146_TO_UNICODE),
        Encoding::Cp1147 => decode_sbcs_full(input, &CP1147_TO_UNICODE),
        Encoding::Cp1148 => decode_sbcs_full(input, &CP1148_TO_UNICODE),
        Encoding::Cp1149 => decode_sbcs_full(input, &CP1149_TO_UNICODE),
        Encoding::Cp12712 => decode_sbcs_full(input, &CP12712_TO_UNICODE),
        Encoding::Cp16804 => decode_sbcs_full(input, &CP16804_TO_UNICODE),
        Encoding::Cp4517 => decode_sbcs_full(input, &CP4517_TO_UNICODE),
        Encoding::Cp4971 => decode_sbcs_full(input, &CP4971_TO_UNICODE),
...
fn encode_char(enc: Encoding, ch: char, out: &mut [u8]) -> Result<usize, EncodeError> {
    match enc {
        ...
        Encoding::Cp1025 => encode_sbcs_full(ch, out, CP1025_ENC),
        Encoding::Cp1026 => encode_sbcs_full(ch, out, CP1026_ENC),
        Encoding::Cp420 => encode_sbcs_full(ch, out, CP420_ENC),
        Encoding::Cp424 => encode_sbcs_full(ch, out, CP424_ENC),
        Encoding::Cp880 => encode_sbcs_full(ch, out, CP880_ENC),
        Encoding::Cp1112 => encode_sbcs_full(ch, out, CP1112_ENC),
        Encoding::Cp1122 => encode_sbcs_full(ch, out, CP1122_ENC),
        Encoding::Cp1123 => encode_sbcs_full(ch, out, CP1123_ENC),
        Encoding::Cp1130 => encode_sbcs_full(ch, out, CP1130_ENC),
        Encoding::Cp1132 => encode_sbcs_full(ch, out, CP1132_ENC),
        Encoding::Cp1137 => encode_sbcs_full(ch, out, CP1137_ENC),
        Encoding::Cp1141 => encode_sbcs_full(ch, out, CP1141_ENC),
        Encoding::Cp1142 => encode_sbcs_full(ch, out, CP1142_ENC),
        Encoding::Cp1143 => encode_sbcs_full(ch, out, CP1143_ENC),
        Encoding::Cp1144 => encode_sbcs_full(ch, out, CP1144_ENC),
        Encoding::Cp1145 => encode_sbcs_full(ch, out, CP1145_ENC),
        Encoding::Cp1146 => encode_sbcs_full(ch, out, CP1146_ENC),
        Encoding::Cp1147 => encode_sbcs_full(ch, out, CP1147_ENC),
        Encoding::Cp1148 => encode_sbcs_full(ch, out, CP1148_ENC),
        Encoding::Cp1149 => encode_sbcs_full(ch, out, CP1149_ENC),
        Encoding::Cp12712 => encode_sbcs_full(ch, out, CP12712_ENC),
        Encoding::Cp16804 => encode_sbcs_full(ch, out, CP16804_ENC),
        Encoding::Cp4517 => encode_sbcs_full(ch, out, CP4517_ENC),
        Encoding::Cp4971 => encode_sbcs_full(ch, out, CP4971_ENC),
