...
enum Encoding {
    ...
    Koi8T,
    EcmaCyrillic,
    /// GOST 19768-74 (ISO-IR-153 / ST SEV 358-88): 8-bit Cyrillic SBCS.
    Gost1976874,
    /// ISO_10367-BOX (ISO-IR-155): box-drawing SBCS.
    Iso10367Box,
    /// IEC_P27-1 (ISO-IR-143): math/Greek symbol SBCS.
    IecP271,
    /// WIN-SAMI-2 (WS2): Windows Sami SBCS.
    WinSami2,
    /// ISO-IR-209: Sami Latin SBCS.
    IsoIr209,
    /// MAC-IS: Macintosh Icelandic SBCS.
    MacIs,
    /// MAC-UK (= MACUKRAINIAN): Macintosh Ukrainian SBCS.
    MacUk,
    /// MS-MAC-CYRILLIC: Microsoft Mac Cyrillic SBCS (≠ MAC-UK at 0xA2).
    MsMacCyrillic,
    /// CP904 (IBM-904): ASCII-based PC codepage, sparse high half.
    Cp904,
    /// CP922 (IBM-922): Estonian ISO-8859-1 + S/Z-caron.
    Cp922,
    /// CP4909 (IBM-4909): Greek ISO-8859-7 variant with euro.
    Cp4909,
    /// CP5347 (IBM-5347): Cyrillic Windows-1251 variant.
    Cp5347,
    /// CP037 (IBM-037): EBCDIC US/Canada — full 256-entry NON-ASCII-low codec.
    Cp037,
    /// CP500 (IBM-500): EBCDIC International.
    Cp500,
    /// CP1047 (IBM-1047): EBCDIC Latin-1 / Open Systems.
    Cp1047,
    /// CP1140 (IBM-1140): EBCDIC US/Canada with euro.
    Cp1140,
    ...
    Cp871,
    /// CP870: EBCDIC Latin-2 (ROECE/Yugoslavia).
    Cp870,
    /// CP875: EBCDIC Greek.
    Cp875,
    /// EBCDIC-CP-DK: EBCDIC Denmark/Norway.
    EbcdicCpDk,
...
const PHASE1_CODEC_TABLE: [CodecSpec; 170] = [
    CodecSpec {
    ...
    CodecSpec {
        encoding: Encoding::Gost1976874,
        canonical: "GOST_19768-74",
        normalized: "GOST1976874",
        aliases: &["GOST19768", "ISOIR153", "STSEV35888", "CSISO153GOST1976874"],
    },
    CodecSpec {
        encoding: Encoding::Iso10367Box,
        canonical: "ISO_10367-BOX",
        normalized: "ISO10367BOX",
        aliases: &["CSISO10367BOX", "ISOIR155"],
    },
    CodecSpec {
        encoding: Encoding::IecP271,
        canonical: "IEC_P27-1",
        normalized: "IECP271",
        aliases: &["CSISO143IECP271", "ISOIR143"],
    },
    CodecSpec {
        encoding: Encoding::WinSami2,
        canonical: "WIN-SAMI-2",
        normalized: "WINSAMI2",
        aliases: &["WS2"],
    },
    CodecSpec {
        encoding: Encoding::IsoIr209,
        canonical: "ISO-IR-209",
        normalized: "ISOIR209",
        aliases: &[],
    },
    CodecSpec {
        encoding: Encoding::MacIs,
        canonical: "MAC-IS",
        normalized: "MACIS",
        aliases: &[],
    },
    CodecSpec {
        encoding: Encoding::MacUk,
        canonical: "MAC-UK",
        normalized: "MACUK",
        aliases: &["MACUKRAINIAN"],
    },
    CodecSpec {
        encoding: Encoding::MsMacCyrillic,
        canonical: "MS-MAC-CYRILLIC",
        normalized: "MSMACCYRILLIC",
        aliases: &[],
    },
    CodecSpec {
        encoding: Encoding::Cp904,
        canonical: "CP904",
        normalized: "CP904",
        aliases: &["904", "IBM904", "CSIBM904"],
    },
    CodecSpec {
        encoding: Encoding::Cp922,
        canonical: "CP922",
        normalized: "CP922",
        aliases: &["IBM922", "CSIBM922"],
    },
    CodecSpec {
        encoding: Encoding::Cp4909,
        canonical: "CP4909",
        normalized: "CP4909",
        aliases: &["IBM4909", "CSIBM4909"],
    },
    CodecSpec {
        encoding: Encoding::Cp5347,
        canonical: "CP5347",
        normalized: "CP5347",
        aliases: &["IBM5347", "CSIBM5347"],
    },
    CodecSpec {
        encoding: Encoding::Cp037,
        canonical: "CP037",
        normalized: "CP037",
        // EBCDIC-CP-IS is NOT here: it is a distinct codepage (Icelandic, CP871).
        aliases: &[
            "IBM037",
            "CSIBM037",
            "EBCDICCPUS",
    ...
    CodecSpec {
        encoding: Encoding::Cp500,
        canonical: "CP500",
        normalized: "CP500",
        aliases: &["IBM500", "CSIBM500", "EBCDICCPBE", "EBCDICCPCH"],
    },
    CodecSpec {
        encoding: Encoding::Cp1047,
        canonical: "CP1047",
        normalized: "CP1047",
        aliases: &["IBM1047"],
    },
    CodecSpec {
        encoding: Encoding::Cp1140,
        canonical: "CP1140",
        normalized: "CP1140",
        aliases: &["IBM1140", "CSIBM1140"],
    },
    CodecSpec {
        encoding: Encoding::Cp273,
        canonical: "CP273",
        normalized: "CP273",
        aliases: &["CSIBM273", "IBM273"],
    },
    CodecSpec {
        encoding: Encoding::Cp278,
        canonical: "CP278",
        normalized: "CP278",
        aliases: &["CSIBM278", "EBCDICCPFI", "EBCDICCPSE", "IBM278"],
    },
    CodecSpec {
        encoding: Encoding::Cp280,
        canonical: "CP280",
        normalized: "CP280",
        aliases: &["CSIBM280", "EBCDICCPIT", "IBM280"],
    },
    CodecSpec {
        encoding: Encoding::Cp284,
        canonical: "CP284",
        normalized: "CP284",
        aliases: &["CSIBM284", "EBCDICCPES", "IBM284"],
    },
    CodecSpec {
        encoding: Encoding::Cp285,
        canonical: "CP285",
        normalized: "CP285",
        aliases: &["CSIBM285", "EBCDICCPGB", "IBM285"],
    },
    CodecSpec {
        encoding: Encoding::Cp297,
        canonical: "CP297",
        normalized: "CP297",
        aliases: &["CSIBM297", "EBCDICCPFR", "IBM297"],
    },
    CodecSpec {
        encoding: Encoding::Cp871,
        canonical: "CP871",
        normalized: "CP871",
        aliases: &["CSIBM871", "EBCDICCPIS", "IBM871"],
    },
    CodecSpec {
        encoding: Encoding::Cp870,
        canonical: "CP870",
        normalized: "CP870",
        aliases: &["CSIBM870", "EBCDICCPROECE", "EBCDICCPYU", "IBM870"],
    },
    CodecSpec {
        encoding: Encoding::Cp875,
        canonical: "CP875",
        normalized: "CP875",
        aliases: &["IBM875"],
    },
    CodecSpec {
        encoding: Encoding::EbcdicCpDk,
        canonical: "EBCDIC-CP-DK",
        normalized: "EBCDICCPDK",
        aliases: &["CSIBM277", "EBCDICCPNO", "IBM277"],
    },
...
/// Generic single-byte codec decoder for the common shape shared by most legacy
/// SBCS pages: `0x00..=0x7F` are ASCII identity and `0x80..=0xFF` index a
/// 128-entry `table` of code points (`0xFFFF` marks an undefined byte -> EILSEQ).
/// Identical in behaviour to the per-codec `decode_*` functions (e.g.
/// [`decode_cp437`]); used by codecs added via this shared path so each one is a
/// single dispatch arm + its table.
fn decode_sbcs128(input: &[u8], table: &[u16; 128]) -> Result<(char, usize), DecodeError> {
    ...
    if b < 0x80 {
        ...
        map_single_byte(table[(b - 0x80) as usize])
    }
}

/// Generic single-byte codec encoder, the inverse of [`decode_sbcs128`]:
/// `0x00..=0x7F` are ASCII identity, otherwise a linear reverse lookup over the
/// 128-entry `table` (skipping `0xFFFF` undefined slots so e.g. U+FFFF itself
/// stays unrepresentable, matching glibc).
fn encode_sbcs128(ch: char, out: &mut [u8], table: &[u16; 128]) -> Result<usize, EncodeError> {
    if out.is_empty() {
    ...
    for (idx, &unicode) in table.iter().enumerate() {
...
/// Generic single-byte codec decoder for pages whose LOW half (`0x00..=0x7F`) is
/// NOT plain ASCII — EBCDIC and the ISO-646 7-bit national variants. The full
/// 256-entry `table` maps every byte (`0xFFFF` = undefined -> EILSEQ); there is
/// no ASCII passthrough. Such codecs MUST also disable the `to_reverse` encode
/// fast path (see [`build_to_reverse`]), which assumes an ASCII low half — they
/// route through [`encode_sbcs_full`] via `encode_char` instead.
fn decode_sbcs_full(input: &[u8], table: &[u16; 256]) -> Result<(char, usize), DecodeError> {
    let Some(&b) = input.first() else {
        return Err(DecodeError::Incomplete);
    };
    map_single_byte(table[b as usize])
}

/// Encoder for full-256 NON-ASCII-low codecs, driven by a glibc-swept
/// `(code point -> byte)` table sorted by code point. Unlike a pure inverse of
/// the decode table, this captures glibc's non-roundtrip encode fallbacks (e.g.
/// CP1140 maps U+203E -> 0xBC even though 0xBC decodes to U+00AF). All keys are
/// BMP (`u16`); a code point above the BMP, or absent, is `Unrepresentable`.
fn encode_sbcs_full(ch: char, out: &mut [u8], enc: &[(u16, u8)]) -> Result<usize, EncodeError> {
    if out.is_empty() {
        return Err(EncodeError::NoSpace);
    }
    let cp = ch as u32;
    ...
    match enc.binary_search_by_key(&(cp as u16), |&(c, _)| c) {
        Ok(i) => {
            out[0] = enc[i].1;
            Ok(1)
        }
...
/// True if `enc`'s bytes `0x00..=0x7F` all decode to the identical ASCII scalar
/// (the assumption baked into the [`SingleByteReverse`] encode fast path). EBCDIC
/// and ISO-646 national variants remap part of the low range, so they return
/// false and must not use the reverse-map fast path.
fn sbcs_low_is_ascii(enc: Encoding) -> bool {
    for b in 0u8..0x80 {
        match decode_char(enc, &[b]) {
...
/// GOST 19768-74 (ISO-IR-153, ST SEV 358-88) to Unicode for bytes 0x80-0xFF,
/// generated byte-exact from host glibc. An 8-bit Cyrillic SBCS: 0x80-0x9F are
/// C1-control identity, 0xB0-0xEF are the Cyrillic block, with a few sparse
/// punctuation/Ё cells; `0xFFFF` marks an undefined byte (decode EILSEQ).
const GOST_19768_74_TO_UNICODE: [u16; 128] = [
    0x0080, 0x0081, 0x0082, 0x0083, 0x0084, 0x0085, 0x0086, 0x0087, // 80-87
    0x0088, 0x0089, 0x008A, 0x008B, 0x008C, 0x008D, 0x008E, 0x008F, // 88-8F
    0x0090, 0x0091, 0x0092, 0x0093, 0x0094, 0x0095, 0x0096, 0x0097, // 90-97
    0x0098, 0x0099, 0x009A, 0x009B, 0x009C, 0x009D, 0x009E, 0x009F, // 98-9F
    0x00A0, 0x0401, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, // A0-A7
    0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0x00AD, 0xFFFF, 0xFFFF, // A8-AF
    0x0410, 0x0411, 0x0412, 0x0413, 0x0414, 0x0415, 0x0416, 0x0417, // B0-B7
    0x0418, 0x0419, 0x041A, 0x041B, 0x041C, 0x041D, 0x041E, 0x041F, // B8-BF
    0x0420, 0x0421, 0x0422, 0x0423, 0x0424, 0x0425, 0x0426, 0x0427, // C0-C7
    0x0428, 0x0429, 0x042A, 0x042B, 0x042C, 0x042D, 0x042E, 0x042F, // C8-CF
    ...
    0x0440, 0x0441, 0x0442, 0x0443, 0x0444, 0x0445, 0x0446, 0x0447, // E0-E7
    0x0448, 0x0449, 0x044A, 0x044B, 0x044C, 0x044D, 0x044E, 0x044F, // E8-EF
    0xFFFF, 0x0451, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, // F0-F7
    0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, // F8-FF
];

fn decode_gost_19768_74(input: &[u8]) -> Result<(char, usize), DecodeError> {
    if input.is_empty() {
        return Err(DecodeError::Incomplete);
    }
    let b = input[0];
    if b < 0x80 {
        ...
        let cp = GOST_19768_74_TO_UNICODE[(b - 0x80) as usize];
        map_single_byte(cp)
    }
}

fn encode_gost_19768_74(ch: char, out: &mut [u8]) -> Result<usize, EncodeError> {
    if out.is_empty() {
        return Err(EncodeError::NoSpace);
    }
    let cp = ch as u32;
    ...
    for (idx, &unicode) in GOST_19768_74_TO_UNICODE.iter().enumerate() {
        if unicode != 0xFFFF && u32::from(unicode) == cp {
            out[0] = (idx as u8) + 0x80;
            return Ok(1);
        }
...
// === Batch of ASCII-compatible SBCS pages glibc supports (bd-4tgqly), each
// generated byte-exact from the host glibc iconv and decoded/encoded via the
// shared decode_sbcs128/encode_sbcs128 helpers. 0xFFFF = undefined byte. ===

/// ISO_10367-BOX (= ISO-IR-155 box-drawing set) bytes 0x80-0xFF.
const ISO_10367_BOX_TO_UNICODE: [u16; 128] = [
    0x0080, 0x0081, 0x0082, 0x0083, 0x0084, 0x0085, 0x0086, 0x0087, // 80-87
    0x0088, 0x0089, 0x008A, 0x008B, 0x008C, 0x008D, 0x008E, 0x008F, // 88-8F
    0x0090, 0x0091, 0x0092, 0x0093, 0x0094, 0x0095, 0x0096, 0x0097, // 90-97
    0x0098, 0x0099, 0x009A, 0x009B, 0x009C, 0x009D, 0x009E, 0x009F, // 98-9F
    ...
    0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, // B0-B7
    0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, // B8-BF
    0x2551, 0x2550, 0x2554, 0x2557, 0x255A, 0x255D, 0x2560, 0x2563, // C0-C7
    0x2566, 0x2569, 0x256C, 0xE019, 0x2584, 0x2588, 0x25AA, 0xFFFF, // C8-CF
    0x2502, 0x2500, 0x250C, 0x2510, 0x2514, 0x2518, 0x251C, 0x2524, // D0-D7
    0x252C, 0x2534, 0x253C, 0x2591, 0x2592, 0x2593, 0xFFFF, 0xFFFF, // D8-DF
    0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, // E0-E7
    0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, // E8-EF
    0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, // F0-F7
    0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, // F8-FF
...
/// IEC_P27-1 (= ISO-IR-143 math/Greek symbols) bytes 0x80-0xFF.
const IEC_P27_1_TO_UNICODE: [u16; 128] = [
    0x0080, 0x0081, 0x0082, 0x0083, 0x0084, 0x0085, 0x0086, 0x0087, // 80-87
    0x0088, 0x0089, 0x008A, 0x008B, 0x008C, 0x008D, 0x008E, 0x008F, // 88-8F
    0x0090, 0x0091, 0x0092, 0x0093, 0x0094, 0x0095, 0x0096, 0x0097, // 90-97
    0x0098, 0x0099, 0x009A, 0x009B, 0x009C, 0x009D, 0x009E, 0x009F, // 98-9F
    0x02C7, 0x2261, 0x2227, 0x2228, 0x2229, 0x222A, 0x2282, 0x2283, // A0-A7
    0x21D0, 0x21D2, 0x2234, 0x2235, 0x2208, 0x220B, 0x2286, 0x2287, // A8-AF
    0x222B, 0x222E, 0x221E, 0x2207, 0x2202, 0x223C, 0x2248, 0x2243, // B0-B7
    0x2245, 0x2264, 0x2260, 0x2265, 0x2194, 0x00AC, 0x2200, 0x2203, // B8-BF
    0x05D0, 0x25A1, 0x2225, 0x0393, 0x0394, 0x22A5, 0x2220, 0x221F, // C0-C7
    0x0398, 0x2329, 0x232A, 0x039B, 0x2032, 0x2033, 0x039E, 0x2213, // C8-CF
    0x03A0, 0x00B2, 0x03A3, 0x00D7, 0x00B3, 0x03A5, 0x03A6, 0x00B7, // D0-D7
    0x03A8, 0x03A9, 0x2205, 0x21C0, 0x221A, 0x0192, 0x221D, 0x00B1, // D8-DF
    0x00B0, 0x03B1, 0x03B2, 0x03B3, 0x03B4, 0x03B5, 0x03B6, 0x03B7, // E0-E7
    0x03B8, 0x03B9, 0x03BA, 0x03BB, 0x03BC, 0x03BD, 0x03BE, 0x2030, // E8-EF
    0x03C0, 0x03C1, 0x03C3, 0x00F7, 0x03C4, 0x03C5, 0x03C6, 0x03C7, // F0-F7
    0x03C8, 0x03C9, 0x2020, 0x2190, 0x2191, 0x2192, 0x2193, 0x203E, // F8-FF
];

/// WIN-SAMI-2 (WS2) bytes 0x80-0xFF.
const WIN_SAMI_2_TO_UNICODE: [u16; 128] = [
    0x20AC, 0xFFFF, 0x010C, 0x0192, 0x010D, 0x01B7, 0x0292, 0x01EE, // 80-87
    0x01EF, 0x0110, 0x0160, 0x2039, 0x0152, 0xFFFF, 0xFFFF, 0xFFFF, // 88-8F
    0xFFFF, 0x2018, 0x2019, 0x201C, 0x201D, 0x2022, 0x2013, 0x2014, // 90-97
    0x0111, 0x01E6, 0x0161, 0x203A, 0x0153, 0xFFFF, 0xFFFF, 0x0178, // 98-9F
    0x00A0, 0x01E7, 0x01E4, 0x00A3, 0x00A4, 0x01E5, 0x00A6, 0x00A7, // A0-A7
    0x00A8, 0x00A9, 0x021E, 0x00AB, 0x00AC, 0x00AD, 0x00AE, 0x021F, // A8-AF
    0x00B0, 0x00B1, 0x01E8, 0x01E9, 0x00B4, 0x00B5, 0x00B6, 0x00B7, // B0-B7
    0x014A, 0x014B, 0x0166, 0x00BB, 0x0167, 0x00BD, 0x017D, 0x017E, // B8-BF
    0x00C0, 0x00C1, 0x00C2, 0x00C3, 0x00C4, 0x00C5, 0x00C6, 0x00C7, // C0-C7
    0x00C8, 0x00C9, 0x00CA, 0x00CB, 0x00CC, 0x00CD, 0x00CE, 0x00CF, // C8-CF
    0x00D0, 0x00D1, 0x00D2, 0x00D3, 0x00D4, 0x00D5, 0x00D6, 0x00D7, // D0-D7
    0x00D8, 0x00D9, 0x00DA, 0x00DB, 0x00DC, 0x00DD, 0x00DE, 0x00DF, // D8-DF
...
/// ISO-IR-209 (Sami Latin) bytes 0x80-0xFF.
const ISO_IR_209_TO_UNICODE: [u16; 128] = [
    0xFFFF, 0xFFFF, 0x201A, 0x0192, 0x201E, 0x2026, 0x00AC, 0x2260, // 80-87
    0x00A3, 0x2030, 0x00BF, 0x2264, 0x0152, 0xFFFF, 0xFFFF, 0xFFFF, // 88-8F
    0xFFFF, 0x2018, 0x2019, 0x201C, 0x201D, 0x2022, 0x2013, 0x2014, // 90-97
    0x00AE, 0x2122, 0x00A1, 0x2265, 0x0153, 0xFFFF, 0xFFFF, 0x0178, // 98-9F
    0x00A0, 0x010C, 0x010D, 0x0110, 0x0111, 0x01E4, 0x01E5, 0x00A7, // A0-A7
    0x01E6, 0x00A9, 0x01E7, 0x021E, 0x01E8, 0x00AD, 0x01E9, 0x014A, // A8-AF
    0x00B0, 0x014B, 0x0160, 0x0161, 0x00B4, 0x0166, 0x00B6, 0x00B7, // B0-B7
    0x0167, 0x017D, 0x017E, 0x021F, 0x01B7, 0x0292, 0x01EE, 0x01EF, // B8-BF
    0x00C0, 0x00C1, 0x00C2, 0x00C3, 0x00C4, 0x00C5, 0x00C6, 0x00C7, // C0-C7
    0x00C8, 0x00C9, 0x00CA, 0x00CB, 0x00CC, 0x00CD, 0x00CE, 0x00CF, // C8-CF
    0x00D0, 0x00D1, 0x00D2, 0x00D3, 0x00D4, 0x00D5, 0x00D6, 0x00D7, // D0-D7
    0x00D8, 0x00D9, 0x00DA, 0x00DB, 0x00DC, 0x00DD, 0x00DE, 0x00DF, // D8-DF
...
/// MAC-IS (Macintosh Icelandic) bytes 0x80-0xFF.
const MAC_IS_TO_UNICODE: [u16; 128] = [
    0x00C4, 0x00C5, 0x00C7, 0x00C9, 0x00D1, 0x00D6, 0x00DC, 0x00E1, // 80-87
    0x00E0, 0x00E2, 0x00E4, 0x00E3, 0x00E5, 0x00E7, 0x00E9, 0x00E8, // 88-8F
    0x00EA, 0x00EB, 0x00ED, 0x00EC, 0x00EE, 0x00EF, 0x00F1, 0x00F3, // 90-97
    0x00F2, 0x00F4, 0x00F6, 0x00F5, 0x00FA, 0x00F9, 0x00FB, 0x00FC, // 98-9F
    ...
    0x221E, 0x00B1, 0x2264, 0x2265, 0x00A5, 0x00B5, 0x2202, 0x2211, // B0-B7
    0x220F, 0x03C0, 0x222B, 0x00AA, 0x00BA, 0x03A9, 0x00E6, 0x00F8, // B8-BF
    0x00BF, 0x00A1, 0x00AC, 0x221A, 0x0192, 0x2248, 0x0394, 0x00AB, // C0-C7
    0x00BB, 0x2026, 0x00A0, 0x00C0, 0x00C3, 0x00D5, 0x0152, 0x0153, // C8-CF
    0x2014, 0x2013, 0x201C, 0x201D, 0x2018, 0x2019, 0x00F7, 0x25C6, // D0-D7
    0x00FF, 0x0178, 0x2044, 0x00A4, 0x0110, 0x0111, 0x00DE, 0x00FE, // D8-DF
    0x2021, 0x00B7, 0x201A, 0x201E, 0x2030, 0x00C2, 0x00CA, 0x00C1, // E0-E7
    0x00CB, 0x00C8, 0x00CD, 0x00CE, 0x00CF, 0x00CC, 0x00D3, 0x00D4, // E8-EF
    0xE01E, 0x00D2, 0x00DA, 0x00DB, 0x00D9, 0x0131, 0xFFFF, 0xFFFF, // F0-F7
    0x00AF, 0x02D8, 0x02D9, 0x02DA, 0x00B8, 0x02DD, 0x02DB, 0x02C7, // F8-FF
];

/// MAC-UK (Macintosh Ukrainian, = MACUKRAINIAN) bytes 0x80-0xFF.
const MAC_UK_TO_UNICODE: [u16; 128] = [
    0x0410, 0x0411, 0x0412, 0x0413, 0x0414, 0x0415, 0x0416, 0x0417, // 80-87
    0x0418, 0x0419, 0x041A, 0x041B, 0x041C, 0x041D, 0x041E, 0x041F, // 88-8F
    0x0420, 0x0421, 0x0422, 0x0423, 0x0424, 0x0425, 0x0426, 0x0427, // 90-97
    0x0428, 0x0429, 0x042A, 0x042B, 0x042C, 0x042D, 0x042E, 0x042F, // 98-9F
    ...
    0x0438, 0x0439, 0x043A, 0x043B, 0x043C, 0x043D, 0x043E, 0x043F, // E8-EF
    0x0440, 0x0441, 0x0442, 0x0443, 0x0444, 0x0445, 0x0446, 0x0447, // F0-F7
    0x0448, 0x0449, 0x044A, 0x044B, 0x044C, 0x044D, 0x044E, 0x00A4, // F8-FF
];

/// MS-MAC-CYRILLIC (Microsoft Mac Cyrillic) bytes 0x80-0xFF. Differs from MAC-UK
/// only at 0xA2 (U+00A2 cent vs U+0490 ghe-upturn).
const MS_MAC_CYRILLIC_TO_UNICODE: [u16; 128] = [
    0x0410, 0x0411, 0x0412, 0x0413, 0x0414, 0x0415, 0x0416, 0x0417, // 80-87
    0x0418, 0x0419, 0x041A, 0x041B, 0x041C, 0x041D, 0x041E, 0x041F, // 88-8F
    0x0420, 0x0421, 0x0422, 0x0423, 0x0424, 0x0425, 0x0426, 0x0427, // 90-97
    0x0428, 0x0429, 0x042A, 0x042B, 0x042C, 0x042D, 0x042E, 0x042F, // 98-9F
    0x2020, 0x00B0, 0x00A2, 0x00A3, 0x00A7, 0x2022, 0x00B6, 0x0406, // A0-A7
    0x00AE, 0x00A9, 0x2122, 0x0402, 0x0452, 0x2260, 0x0403, 0x0453, // A8-AF
    0x221E, 0x00B1, 0x2264, 0x2265, 0x0456, 0x00B5, 0x0491, 0x0408, // B0-B7
    0x0404, 0x0454, 0x0407, 0x0457, 0x0409, 0x0459, 0x040A, 0x045A, // B8-BF
    0x0458, 0x0405, 0x00AC, 0x221A, 0x0192, 0x2248, 0x2206, 0x00AB, // C0-C7
...
/// CP904 (IBM-904, ASCII-based, mostly undefined high half) bytes 0x80-0xFF.
const CP904_TO_UNICODE: [u16; 128] = [
    0x00A2, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, // 80-87
    0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, // 88-8F
    0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, // 90-97
    0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, // 98-9F
    0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, // A0-A7
    ...
    0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, // E8-EF
    0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, // F0-F7
    0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0x00AC, 0x00A6, 0xFFFF, // F8-FF
];

/// CP922 (IBM-922, Estonian, ISO-8859-1 + S-caron/Z-caron) bytes 0x80-0xFF.
const CP922_TO_UNICODE: [u16; 128] = [
    0x0080, 0x0081, 0x0082, 0x0083, 0x0084, 0x0085, 0x0086, 0x0087, // 80-87
    0x0088, 0x0089, 0x008A, 0x008B, 0x008C, 0x008D, 0x008E, 0x008F, // 88-8F
    0x0090, 0x0091, 0x0092, 0x0093, 0x0094, 0x0095, 0x0096, 0x0097, // 90-97
    0x0098, 0x0099, 0x009A, 0x009B, 0x009C, 0x009D, 0x009E, 0x009F, // 98-9F
...
/// CP4909 (IBM-4909, Greek, ISO-8859-7 variant with euro) bytes 0x80-0xFF.
const CP4909_TO_UNICODE: [u16; 128] = [
    0x0080, 0x0081, 0x0082, 0x0083, 0x0084, 0x0085, 0x0086, 0x0087, // 80-87
    0x0088, 0x0089, 0x008A, 0x008B, 0x008C, 0x008D, 0x008E, 0x008F, // 88-8F
    0x0090, 0x0091, 0x0092, 0x0093, 0x0094, 0x0095, 0x0096, 0x0097, // 90-97
    0x0098, 0x0099, 0x009A, 0x009B, 0x009C, 0x009D, 0x009E, 0x009F, // 98-9F
    0x00A0, 0x2018, 0x2019, 0x00A3, 0x20AC, 0xFFFF, 0x00A6, 0x00A7, // A0-A7
    0x00A8, 0x00A9, 0xFFFF, 0x00AB, 0x00AC, 0x00AD, 0xFFFF, 0x2015, // A8-AF
    0x00B0, 0x00B1, 0x00B2, 0x00B3, 0x00B4, 0x0385, 0x0386, 0x0387, // B0-B7
    0x0388, 0x0389, 0x038A, 0x00BB, 0x038C, 0x00BD, 0x038E, 0x038F, // B8-BF
    0x0390, 0x0391, 0x0392, 0x0393, 0x0394, 0x0395, 0x0396, 0x0397, // C0-C7
    0x0398, 0x0399, 0x039A, 0x039B, 0x039C, 0x039D, 0x039E, 0x039F, // C8-CF
    0x03A0, 0x03A1, 0xFFFF, 0x03A3, 0x03A4, 0x03A5, 0x03A6, 0x03A7, // D0-D7
...
/// CP5347 (IBM-5347, Cyrillic, Windows-1251 variant) bytes 0x80-0xFF.
const CP5347_TO_UNICODE: [u16; 128] = [
    0x0402, 0x0403, 0x201A, 0x0453, 0x201E, 0x2026, 0x2020, 0x2021, // 80-87
    0x20AC, 0x2030, 0x0409, 0x2039, 0x040A, 0x040C, 0x040B, 0x040F, // 88-8F
    0x0452, 0x2018, 0x2019, 0x201C, 0x201D, 0x2022, 0x2013, 0x2014, // 90-97
...
/// CP037 (IBM-037, EBCDIC US/Canada) — a full 256-entry NON-ASCII-low table
/// (EBCDIC remaps the entire byte range incl. the letter/digit positions), so it
/// decodes via [`decode_sbcs_full`] / encodes via [`encode_sbcs_full`] and its
/// `to_reverse` fast path is disabled. Generated byte-exact from host glibc.
const CP037_TO_UNICODE: [u16; 256] = [
...
/// CP500 (IBM-500, EBCDIC International) — full 256-entry NON-ASCII-low EBCDIC table (host-generated).
const CP500_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
...
/// CP1047 (IBM-1047, EBCDIC Latin-1 / Open Systems) — full 256-entry NON-ASCII-low EBCDIC table (host-generated).
const CP1047_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
...
/// CP1140 (IBM-1140, EBCDIC US/Canada with euro) — full 256-entry NON-ASCII-low EBCDIC table (host-generated).
const CP1140_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
...
/// CP037 encode map (code point -> byte), swept byte-exact from host
/// glibc (captures non-roundtrip fallbacks, e.g. CP1140 U+203E -> 0xBC).
const CP037_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    (0x0020,0x40),(0x0021,0x5A),(0x0022,0x7F),(0x0023,0x7B),(0x0024,0x5B),(0x0025,0x6C),(0x0026,0x50),(0x0027,0x7D),
    (0x0028,0x4D),(0x0029,0x5D),(0x002A,0x5C),(0x002B,0x4E),(0x002C,0x6B),(0x002D,0x60),(0x002E,0x4B),(0x002F,0x61),
    (0x0030,0xF0),(0x0031,0xF1),(0x0032,0xF2),(0x0033,0xF3),(0x0034,0xF4),(0x0035,0xF5),(0x0036,0xF6),(0x0037,0xF7),
    (0x0038,0xF8),(0x0039,0xF9),(0x003A,0x7A),(0x003B,0x5E),(0x003C,0x4C),(0x003D,0x7E),(0x003E,0x6E),(0x003F,0x6F),
    (0x0040,0x7C),(0x0041,0xC1),(0x0042,0xC2),(0x0043,0xC3),(0x0044,0xC4),(0x0045,0xC5),(0x0046,0xC6),(0x0047,0xC7),
    (0x0048,0xC8),(0x0049,0xC9),(0x004A,0xD1),(0x004B,0xD2),(0x004C,0xD3),(0x004D,0xD4),(0x004E,0xD5),(0x004F,0xD6),
    (0x0050,0xD7),(0x0051,0xD8),(0x0052,0xD9),(0x0053,0xE2),(0x0054,0xE3),(0x0055,0xE4),(0x0056,0xE5),(0x0057,0xE6),
    (0x0058,0xE7),(0x0059,0xE8),(0x005A,0xE9),(0x005B,0xBA),(0x005C,0xE0),(0x005D,0xBB),(0x005E,0xB0),(0x005F,0x6D),
    (0x0060,0x79),(0x0061,0x81),(0x0062,0x82),(0x0063,0x83),(0x0064,0x84),(0x0065,0x85),(0x0066,0x86),(0x0067,0x87),
    (0x0068,0x88),(0x0069,0x89),(0x006A,0x91),(0x006B,0x92),(0x006C,0x93),(0x006D,0x94),(0x006E,0x95),(0x006F,0x96),
    (0x0070,0x97),(0x0071,0x98),(0x0072,0x99),(0x0073,0xA2),(0x0074,0xA3),(0x0075,0xA4),(0x0076,0xA5),(0x0077,0xA6),
    (0x0078,0xA7),(0x0079,0xA8),(0x007A,0xA9),(0x007B,0xC0),(0x007C,0x4F),(0x007D,0xD0),(0x007E,0xA1),(0x007F,0x07),
    (0x0080,0x20),(0x0081,0x21),(0x0082,0x22),(0x0083,0x23),(0x0084,0x24),(0x0085,0x15),(0x0086,0x06),(0x0087,0x17),
    (0x0088,0x28),(0x0089,0x29),(0x008A,0x2A),(0x008B,0x2B),(0x008C,0x2C),(0x008D,0x09),(0x008E,0x0A),(0x008F,0x1B),
    (0x0090,0x30),(0x0091,0x31),(0x0092,0x1A),(0x0093,0x33),(0x0094,0x34),(0x0095,0x35),(0x0096,0x36),(0x0097,0x08),
    (0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),
    (0x00A0,0x41),(0x00A1,0xAA),(0x00A2,0x4A),(0x00A3,0xB1),(0x00A4,0x9F),(0x00A5,0xB2),(0x00A6,0x6A),(0x00A7,0xB5),
    (0x00A8,0xBD),(0x00A9,0xB4),(0x00AA,0x9A),(0x00AB,0x8A),(0x00AC,0x5F),(0x00AD,0xCA),(0x00AE,0xAF),(0x00AF,0xBC),
    (0x00B0,0x90),(0x00B1,0x8F),(0x00B2,0xEA),(0x00B3,0xFA),(0x00B4,0xBE),(0x00B5,0xA0),(0x00B6,0xB6),(0x00B7,0xB3),
    (0x00B8,0x9D),(0x00B9,0xDA),(0x00BA,0x9B),(0x00BB,0x8B),(0x00BC,0xB7),(0x00BD,0xB8),(0x00BE,0xB9),(0x00BF,0xAB),
    (0x00C0,0x64),(0x00C1,0x65),(0x00C2,0x62),(0x00C3,0x66),(0x00C4,0x63),(0x00C5,0x67),(0x00C6,0x9E),(0x00C7,0x68),
    (0x00C8,0x74),(0x00C9,0x71),(0x00CA,0x72),(0x00CB,0x73),(0x00CC,0x78),(0x00CD,0x75),(0x00CE,0x76),(0x00CF,0x77),
    (0x00D0,0xAC),(0x00D1,0x69),(0x00D2,0xED),(0x00D3,0xEE),(0x00D4,0xEB),(0x00D5,0xEF),(0x00D6,0xEC),(0x00D7,0xBF),
    (0x00D8,0x80),(0x00D9,0xFD),(0x00DA,0xFE),(0x00DB,0xFB),(0x00DC,0xFC),(0x00DD,0xAD),(0x00DE,0xAE),(0x00DF,0x59),
    (0x00E0,0x44),(0x00E1,0x45),(0x00E2,0x42),(0x00E3,0x46),(0x00E4,0x43),(0x00E5,0x47),(0x00E6,0x9C),(0x00E7,0x48),
    (0x00E8,0x54),(0x00E9,0x51),(0x00EA,0x52),(0x00EB,0x53),(0x00EC,0x58),(0x00ED,0x55),(0x00EE,0x56),(0x00EF,0x57),
    (0x00F0,0x8C),(0x00F1,0x49),(0x00F2,0xCD),(0x00F3,0xCE),(0x00F4,0xCB),(0x00F5,0xCF),(0x00F6,0xCC),(0x00F7,0xE1),
    (0x00F8,0x70),(0x00F9,0xDD),(0x00FA,0xDE),(0x00FB,0xDB),(0x00FC,0xDC),(0x00FD,0x8D),(0x00FE,0x8E),(0x00FF,0xDF),
];

/// CP500 encode map (code point -> byte), swept byte-exact from host
/// glibc (captures non-roundtrip fallbacks, e.g. CP1140 U+203E -> 0xBC).
const CP500_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    (0x0020,0x40),(0x0021,0x4F),(0x0022,0x7F),(0x0023,0x7B),(0x0024,0x5B),(0x0025,0x6C),(0x0026,0x50),(0x0027,0x7D),
    (0x0028,0x4D),(0x0029,0x5D),(0x002A,0x5C),(0x002B,0x4E),(0x002C,0x6B),(0x002D,0x60),(0x002E,0x4B),(0x002F,0x61),
    (0x0030,0xF0),(0x0031,0xF1),(0x0032,0xF2),(0x0033,0xF3),(0x0034,0xF4),(0x0035,0xF5),(0x0036,0xF6),(0x0037,0xF7),
    (0x0038,0xF8),(0x0039,0xF9),(0x003A,0x7A),(0x003B,0x5E),(0x003C,0x4C),(0x003D,0x7E),(0x003E,0x6E),(0x003F,0x6F),
    (0x0040,0x7C),(0x0041,0xC1),(0x0042,0xC2),(0x0043,0xC3),(0x0044,0xC4),(0x0045,0xC5),(0x0046,0xC6),(0x0047,0xC7),
    (0x0048,0xC8),(0x0049,0xC9),(0x004A,0xD1),(0x004B,0xD2),(0x004C,0xD3),(0x004D,0xD4),(0x004E,0xD5),(0x004F,0xD6),
    (0x0050,0xD7),(0x0051,0xD8),(0x0052,0xD9),(0x0053,0xE2),(0x0054,0xE3),(0x0055,0xE4),(0x0056,0xE5),(0x0057,0xE6),
    (0x0058,0xE7),(0x0059,0xE8),(0x005A,0xE9),(0x005B,0x4A),(0x005C,0xE0),(0x005D,0x5A),(0x005E,0x5F),(0x005F,0x6D),
    (0x0060,0x79),(0x0061,0x81),(0x0062,0x82),(0x0063,0x83),(0x0064,0x84),(0x0065,0x85),(0x0066,0x86),(0x0067,0x87),
    (0x0068,0x88),(0x0069,0x89),(0x006A,0x91),(0x006B,0x92),(0x006C,0x93),(0x006D,0x94),(0x006E,0x95),(0x006F,0x96),
    (0x0070,0x97),(0x0071,0x98),(0x0072,0x99),(0x0073,0xA2),(0x0074,0xA3),(0x0075,0xA4),(0x0076,0xA5),(0x0077,0xA6),
    (0x0078,0xA7),(0x0079,0xA8),(0x007A,0xA9),(0x007B,0xC0),(0x007C,0xBB),(0x007D,0xD0),(0x007E,0xA1),(0x007F,0x07),
    (0x0080,0x20),(0x0081,0x21),(0x0082,0x22),(0x0083,0x23),(0x0084,0x24),(0x0085,0x15),(0x0086,0x06),(0x0087,0x17),
    (0x0088,0x28),(0x0089,0x29),(0x008A,0x2A),(0x008B,0x2B),(0x008C,0x2C),(0x008D,0x09),(0x008E,0x0A),(0x008F,0x1B),
    (0x0090,0x30),(0x0091,0x31),(0x0092,0x1A),(0x0093,0x33),(0x0094,0x34),(0x0095,0x35),(0x0096,0x36),(0x0097,0x08),
    (0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),
    (0x00A0,0x41),(0x00A1,0xAA),(0x00A2,0xB0),(0x00A3,0xB1),(0x00A4,0x9F),(0x00A5,0xB2),(0x00A6,0x6A),(0x00A7,0xB5),
    (0x00A8,0xBD),(0x00A9,0xB4),(0x00AA,0x9A),(0x00AB,0x8A),(0x00AC,0xBA),(0x00AD,0xCA),(0x00AE,0xAF),(0x00AF,0xBC),
    (0x00B0,0x90),(0x00B1,0x8F),(0x00B2,0xEA),(0x00B3,0xFA),(0x00B4,0xBE),(0x00B5,0xA0),(0x00B6,0xB6),(0x00B7,0xB3),
    (0x00B8,0x9D),(0x00B9,0xDA),(0x00BA,0x9B),(0x00BB,0x8B),(0x00BC,0xB7),(0x00BD,0xB8),(0x00BE,0xB9),(0x00BF,0xAB),
    (0x00C0,0x64),(0x00C1,0x65),(0x00C2,0x62),(0x00C3,0x66),(0x00C4,0x63),(0x00C5,0x67),(0x00C6,0x9E),(0x00C7,0x68),
    (0x00C8,0x74),(0x00C9,0x71),(0x00CA,0x72),(0x00CB,0x73),(0x00CC,0x78),(0x00CD,0x75),(0x00CE,0x76),(0x00CF,0x77),
...
/// CP1047 encode map (code point -> byte), swept byte-exact from host
/// glibc (captures non-roundtrip fallbacks, e.g. CP1140 U+203E -> 0xBC).
const CP1047_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    ...
    (0x0048,0xC8),(0x0049,0xC9),(0x004A,0xD1),(0x004B,0xD2),(0x004C,0xD3),(0x004D,0xD4),(0x004E,0xD5),(0x004F,0xD6),
    (0x0050,0xD7),(0x0051,0xD8),(0x0052,0xD9),(0x0053,0xE2),(0x0054,0xE3),(0x0055,0xE4),(0x0056,0xE5),(0x0057,0xE6),
    (0x0058,0xE7),(0x0059,0xE8),(0x005A,0xE9),(0x005B,0xAD),(0x005C,0xE0),(0x005D,0xBD),(0x005E,0x5F),(0x005F,0x6D),
    (0x0060,0x79),(0x0061,0x81),(0x0062,0x82),(0x0063,0x83),(0x0064,0x84),(0x0065,0x85),(0x0066,0x86),(0x0067,0x87),
    (0x0068,0x88),(0x0069,0x89),(0x006A,0x91),(0x006B,0x92),(0x006C,0x93),(0x006D,0x94),(0x006E,0x95),(0x006F,0x96),
    (0x0070,0x97),(0x0071,0x98),(0x0072,0x99),(0x0073,0xA2),(0x0074,0xA3),(0x0075,0xA4),(0x0076,0xA5),(0x0077,0xA6),
    (0x0078,0xA7),(0x0079,0xA8),(0x007A,0xA9),(0x007B,0xC0),(0x007C,0x4F),(0x007D,0xD0),(0x007E,0xA1),(0x007F,0x07),
    ...
    (0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),
    (0x00A0,0x41),(0x00A1,0xAA),(0x00A2,0x4A),(0x00A3,0xB1),(0x00A4,0x9F),(0x00A5,0xB2),(0x00A6,0x6A),(0x00A7,0xB5),
    (0x00A8,0xBB),(0x00A9,0xB4),(0x00AA,0x9A),(0x00AB,0x8A),(0x00AC,0xB0),(0x00AD,0xCA),(0x00AE,0xAF),(0x00AF,0xBC),
    (0x00B0,0x90),(0x00B1,0x8F),(0x00B2,0xEA),(0x00B3,0xFA),(0x00B4,0xBE),(0x00B5,0xA0),(0x00B6,0xB6),(0x00B7,0xB3),
    (0x00B8,0x9D),(0x00B9,0xDA),(0x00BA,0x9B),(0x00BB,0x8B),(0x00BC,0xB7),(0x00BD,0xB8),(0x00BE,0xB9),(0x00BF,0xAB),
    (0x00C0,0x64),(0x00C1,0x65),(0x00C2,0x62),(0x00C3,0x66),(0x00C4,0x63),(0x00C5,0x67),(0x00C6,0x9E),(0x00C7,0x68),
    (0x00C8,0x74),(0x00C9,0x71),(0x00CA,0x72),(0x00CB,0x73),(0x00CC,0x78),(0x00CD,0x75),(0x00CE,0x76),(0x00CF,0x77),
    (0x00D0,0xAC),(0x00D1,0x69),(0x00D2,0xED),(0x00D3,0xEE),(0x00D4,0xEB),(0x00D5,0xEF),(0x00D6,0xEC),(0x00D7,0xBF),
    (0x00D8,0x80),(0x00D9,0xFD),(0x00DA,0xFE),(0x00DB,0xFB),(0x00DC,0xFC),(0x00DD,0xBA),(0x00DE,0xAE),(0x00DF,0x59),
    (0x00E0,0x44),(0x00E1,0x45),(0x00E2,0x42),(0x00E3,0x46),(0x00E4,0x43),(0x00E5,0x47),(0x00E6,0x9C),(0x00E7,0x48),
    (0x00E8,0x54),(0x00E9,0x51),(0x00EA,0x52),(0x00EB,0x53),(0x00EC,0x58),(0x00ED,0x55),(0x00EE,0x56),(0x00EF,0x57),
    (0x00F0,0x8C),(0x00F1,0x49),(0x00F2,0xCD),(0x00F3,0xCE),(0x00F4,0xCB),(0x00F5,0xCF),(0x00F6,0xCC),(0x00F7,0xE1),
    (0x00F8,0x70),(0x00F9,0xDD),(0x00FA,0xDE),(0x00FB,0xDB),(0x00FC,0xDC),(0x00FD,0x8D),(0x00FE,0x8E),(0x00FF,0xDF),
...
/// CP1140 encode map (code point -> byte), swept byte-exact from host
/// glibc (captures non-roundtrip fallbacks, e.g. CP1140 U+203E -> 0xBC).
const CP1140_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    ...
    (0x0090,0x30),(0x0091,0x31),(0x0092,0x1A),(0x0093,0x33),(0x0094,0x34),(0x0095,0x35),(0x0096,0x36),(0x0097,0x08),
    (0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),
    (0x00A0,0x41),(0x00A1,0xAA),(0x00A2,0x4A),(0x00A3,0xB1),(0x00A5,0xB2),(0x00A6,0x6A),(0x00A7,0xB5),(0x00A8,0xBD),
    (0x00A9,0xB4),(0x00AA,0x9A),(0x00AB,0x8A),(0x00AC,0x5F),(0x00AD,0xCA),(0x00AE,0xAF),(0x00AF,0xBC),(0x00B0,0x90),
    (0x00B1,0x8F),(0x00B2,0xEA),(0x00B3,0xFA),(0x00B4,0xBE),(0x00B5,0xA0),(0x00B6,0xB6),(0x00B7,0xB3),(0x00B8,0x9D),
    (0x00B9,0xDA),(0x00BA,0x9B),(0x00BB,0x8B),(0x00BC,0xB7),(0x00BD,0xB8),(0x00BE,0xB9),(0x00BF,0xAB),(0x00C0,0x64),
    (0x00C1,0x65),(0x00C2,0x62),(0x00C3,0x66),(0x00C4,0x63),(0x00C5,0x67),(0x00C6,0x9E),(0x00C7,0x68),(0x00C8,0x74),
    (0x00C9,0x71),(0x00CA,0x72),(0x00CB,0x73),(0x00CC,0x78),(0x00CD,0x75),(0x00CE,0x76),(0x00CF,0x77),(0x00D0,0xAC),
    (0x00D1,0x69),(0x00D2,0xED),(0x00D3,0xEE),(0x00D4,0xEB),(0x00D5,0xEF),(0x00D6,0xEC),(0x00D7,0xBF),(0x00D8,0x80),
    (0x00D9,0xFD),(0x00DA,0xFE),(0x00DB,0xFB),(0x00DC,0xFC),(0x00DD,0xAD),(0x00DE,0xAE),(0x00DF,0x59),(0x00E0,0x44),
    (0x00E1,0x45),(0x00E2,0x42),(0x00E3,0x46),(0x00E4,0x43),(0x00E5,0x47),(0x00E6,0x9C),(0x00E7,0x48),(0x00E8,0x54),
    (0x00E9,0x51),(0x00EA,0x52),(0x00EB,0x53),(0x00EC,0x58),(0x00ED,0x55),(0x00EE,0x56),(0x00EF,0x57),(0x00F0,0x8C),
    (0x00F1,0x49),(0x00F2,0xCD),(0x00F3,0xCE),(0x00F4,0xCB),(0x00F5,0xCF),(0x00F6,0xCC),(0x00F7,0xE1),(0x00F8,0x70),
    (0x00F9,0xDD),(0x00FA,0xDE),(0x00FB,0xDB),(0x00FC,0xDC),(0x00FD,0x8D),(0x00FE,0x8E),(0x00FF,0xDF),(0x203E,0xBC),
    (0x20AC,0x9F),
];

/// CP273 (EBCDIC Germany/Austria) — full 256-entry EBCDIC table (host-generated).
const CP273_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
...
/// CP278 (EBCDIC Finland/Sweden) — full 256-entry EBCDIC table (host-generated).
const CP278_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
    ...
    0x0090,0x0091,0x0016,0x0093,0x0094,0x0095,0x0096,0x0004, // 30-37
    0x0098,0x0099,0x009A,0x009B,0x0014,0x0015,0x009E,0x001A, // 38-3F
    0x0020,0x00A0,0x00E2,0x007B,0x00E0,0x00E1,0x00E3,0x007D, // 40-47
    0x00E7,0x00F1,0x00A7,0x002E,0x003C,0x0028,0x002B,0x0021, // 48-4F
    0x0026,0x0060,0x00EA,0x00EB,0x00E8,0x00ED,0x00EE,0x00EF, // 50-57
    0x00EC,0x00DF,0x00A4,0x00C5,0x002A,0x0029,0x003B,0x005E, // 58-5F
    0x002D,0x002F,0x00C2,0x0023,0x00C0,0x00C1,0x00C3,0x0024, // 60-67
    0x00C7,0x00D1,0x00F6,0x002C,0x0025,0x005F,0x003E,0x003F, // 68-6F
    0x00F8,0x00C9,0x00CA,0x00CB,0x00C8,0x00CD,0x00CE,0x00CF, // 70-77
    0x00CC,0x00E9,0x003A,0x00C4,0x00D6,0x0027,0x003D,0x0022, // 78-7F
    0x00D8,0x0061,0x0062,0x0063,0x0064,0x0065,0x0066,0x0067, // 80-87
    0x0068,0x0069,0x00AB,0x00BB,0x00F0,0x00FD,0x00FE,0x00B1, // 88-8F
    0x00B0,0x006A,0x006B,0x006C,0x006D,0x006E,0x006F,0x0070, // 90-97
    0x0071,0x0072,0x00AA,0x00BA,0x00E6,0x00B8,0x00C6,0x005D, // 98-9F
    0x00B5,0x00FC,0x0073,0x0074,0x0075,0x0076,0x0077,0x0078, // A0-A7
    0x0079,0x007A,0x00A1,0x00BF,0x00D0,0x00DD,0x00DE,0x00AE, // A8-AF
    0x00A2,0x00A3,0x00A5,0x00B7,0x00A9,0x005B,0x00B6,0x00BC, // B0-B7
    0x00BD,0x00BE,0x00AC,0x007C,0x00AF,0x00A8,0x00B4,0x00D7, // B8-BF
    0x00E4,0x0041,0x0042,0x0043,0x0044,0x0045,0x0046,0x0047, // C0-C7
    0x0048,0x0049,0x00AD,0x00F4,0x00A6,0x00F2,0x00F3,0x00F5, // C8-CF
    0x00E5,0x004A,0x004B,0x004C,0x004D,0x004E,0x004F,0x0050, // D0-D7
    0x0051,0x0052,0x00B9,0x00FB,0x007E,0x00F9,0x00FA,0x00FF, // D8-DF
    0x005C,0x00F7,0x0053,0x0054,0x0055,0x0056,0x0057,0x0058, // E0-E7
    0x0059,0x005A,0x00B2,0x00D4,0x0040,0x00D2,0x00D3,0x00D5, // E8-EF
    0x0030,0x0031,0x0032,0x0033,0x0034,0x0035,0x0036,0x0037, // F0-F7
    0x0038,0x0039,0x00B3,0x00DB,0x00DC,0x00D9,0x00DA,0x009F, // F8-FF
];

/// CP280 (EBCDIC Italy) — full 256-entry EBCDIC table (host-generated).
const CP280_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
    ...
    0x0090,0x0091,0x0016,0x0093,0x0094,0x0095,0x0096,0x0004, // 30-37
    0x0098,0x0099,0x009A,0x009B,0x0014,0x0015,0x009E,0x001A, // 38-3F
    0x0020,0x00A0,0x00E2,0x00E4,0x007B,0x00E1,0x00E3,0x00E5, // 40-47
    0x005C,0x00F1,0x00B0,0x002E,0x003C,0x0028,0x002B,0x0021, // 48-4F
    0x0026,0x005D,0x00EA,0x00EB,0x007D,0x00ED,0x00EE,0x00EF, // 50-57
    0x007E,0x00DF,0x00E9,0x0024,0x002A,0x0029,0x003B,0x005E, // 58-5F
    0x002D,0x002F,0x00C2,0x00C4,0x00C0,0x00C1,0x00C3,0x00C5, // 60-67
    0x00C7,0x00D1,0x00F2,0x002C,0x0025,0x005F,0x003E,0x003F, // 68-6F
    0x00F8,0x00C9,0x00CA,0x00CB,0x00C8,0x00CD,0x00CE,0x00CF, // 70-77
    0x00CC,0x00F9,0x003A,0x00A3,0x00A7,0x0027,0x003D,0x0022, // 78-7F
    0x00D8,0x0061,0x0062,0x0063,0x0064,0x0065,0x0066,0x0067, // 80-87
    0x0068,0x0069,0x00AB,0x00BB,0x00F0,0x00FD,0x00FE,0x00B1, // 88-8F
    0x005B,0x006A,0x006B,0x006C,0x006D,0x006E,0x006F,0x0070, // 90-97
    0x0071,0x0072,0x00AA,0x00BA,0x00E6,0x00B8,0x00C6,0x00A4, // 98-9F
    0x00B5,0x00EC,0x0073,0x0074,0x0075,0x0076,0x0077,0x0078, // A0-A7
    0x0079,0x007A,0x00A1,0x00BF,0x00D0,0x00DD,0x00DE,0x00AE, // A8-AF
    0x00A2,0x0023,0x00A5,0x00B7,0x00A9,0x0040,0x00B6,0x00BC, // B0-B7
    0x00BD,0x00BE,0x00AC,0x007C,0x00AF,0x00A8,0x00B4,0x00D7, // B8-BF
    0x00E0,0x0041,0x0042,0x0043,0x0044,0x0045,0x0046,0x0047, // C0-C7
    0x0048,0x0049,0x00AD,0x00F4,0x00F6,0x00A6,0x00F3,0x00F5, // C8-CF
    0x00E8,0x004A,0x004B,0x004C,0x004D,0x004E,0x004F,0x0050, // D0-D7
    0x0051,0x0052,0x00B9,0x00FB,0x00FC,0x0060,0x00FA,0x00FF, // D8-DF
    0x00E7,0x00F7,0x0053,0x0054,0x0055,0x0056,0x0057,0x0058, // E0-E7
    0x0059,0x005A,0x00B2,0x00D4,0x00D6,0x00D2,0x00D3,0x00D5, // E8-EF
    0x0030,0x0031,0x0032,0x0033,0x0034,0x0035,0x0036,0x0037, // F0-F7
    0x0038,0x0039,0x00B3,0x00DB,0x00DC,0x00D9,0x00DA,0x009F, // F8-FF
];

/// CP284 (EBCDIC Spain/Latin America) — full 256-entry EBCDIC table (host-generated).
const CP284_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
    ...
    0x0098,0x0099,0x009A,0x009B,0x0014,0x0015,0x009E,0x001A, // 38-3F
    0x0020,0x00A0,0x00E2,0x00E4,0x00E0,0x00E1,0x00E3,0x00E5, // 40-47
    0x00E7,0x00A6,0x005B,0x002E,0x003C,0x0028,0x002B,0x007C, // 48-4F
    0x0026,0x00E9,0x00EA,0x00EB,0x00E8,0x00ED,0x00EE,0x00EF, // 50-57
    0x00EC,0x00DF,0x005D,0x0024,0x002A,0x0029,0x003B,0x00AC, // 58-5F
    0x002D,0x002F,0x00C2,0x00C4,0x00C0,0x00C1,0x00C3,0x00C5, // 60-67
    0x00C7,0x0023,0x00F1,0x002C,0x0025,0x005F,0x003E,0x003F, // 68-6F
    0x00F8,0x00C9,0x00CA,0x00CB,0x00C8,0x00CD,0x00CE,0x00CF, // 70-77
    0x00CC,0x0060,0x003A,0x00D1,0x0040,0x0027,0x003D,0x0022, // 78-7F
    0x00D8,0x0061,0x0062,0x0063,0x0064,0x0065,0x0066,0x0067, // 80-87
    0x0068,0x0069,0x00AB,0x00BB,0x00F0,0x00FD,0x00FE,0x00B1, // 88-8F
    0x00B0,0x006A,0x006B,0x006C,0x006D,0x006E,0x006F,0x0070, // 90-97
    0x0071,0x0072,0x00AA,0x00BA,0x00E6,0x00B8,0x00C6,0x00A4, // 98-9F
    0x00B5,0x00A8,0x0073,0x0074,0x0075,0x0076,0x0077,0x0078, // A0-A7
    0x0079,0x007A,0x00A1,0x00BF,0x00D0,0x00DD,0x00DE,0x00AE, // A8-AF
    0x00A2,0x00A3,0x00A5,0x00B7,0x00A9,0x00A7,0x00B6,0x00BC, // B0-B7
    0x00BD,0x00BE,0x005E,0x0021,0x00AF,0x007E,0x00B4,0x00D7, // B8-BF
    0x007B,0x0041,0x0042,0x0043,0x0044,0x0045,0x0046,0x0047, // C0-C7
    0x0048,0x0049,0x00AD,0x00F4,0x00F6,0x00F2,0x00F3,0x00F5, // C8-CF
    0x007D,0x004A,0x004B,0x004C,0x004D,0x004E,0x004F,0x0050, // D0-D7
    0x0051,0x0052,0x00B9,0x00FB,0x00FC,0x00F9,0x00FA,0x00FF, // D8-DF
...
/// CP285 (EBCDIC United Kingdom) — full 256-entry EBCDIC table (host-generated).
const CP285_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
    ...
    0x0098,0x0099,0x009A,0x009B,0x0014,0x0015,0x009E,0x001A, // 38-3F
    0x0020,0x00A0,0x00E2,0x00E4,0x00E0,0x00E1,0x00E3,0x00E5, // 40-47
    0x00E7,0x00F1,0x0024,0x002E,0x003C,0x0028,0x002B,0x007C, // 48-4F
    0x0026,0x00E9,0x00EA,0x00EB,0x00E8,0x00ED,0x00EE,0x00EF, // 50-57
    0x00EC,0x00DF,0x0021,0x00A3,0x002A,0x0029,0x003B,0x00AC, // 58-5F
    0x002D,0x002F,0x00C2,0x00C4,0x00C0,0x00C1,0x00C3,0x00C5, // 60-67
    0x00C7,0x00D1,0x00A6,0x002C,0x0025,0x005F,0x003E,0x003F, // 68-6F
    0x00F8,0x00C9,0x00CA,0x00CB,0x00C8,0x00CD,0x00CE,0x00CF, // 70-77
    0x00CC,0x0060,0x003A,0x0023,0x0040,0x0027,0x003D,0x0022, // 78-7F
    ...
    0x00B0,0x006A,0x006B,0x006C,0x006D,0x006E,0x006F,0x0070, // 90-97
    0x0071,0x0072,0x00AA,0x00BA,0x00E6,0x00B8,0x00C6,0x00A4, // 98-9F
    0x00B5,0x203E,0x0073,0x0074,0x0075,0x0076,0x0077,0x0078, // A0-A7
    0x0079,0x007A,0x00A1,0x00BF,0x00D0,0x00DD,0x00DE,0x00AE, // A8-AF
    0x00A2,0x005B,0x00A5,0x00B7,0x00A9,0x00A7,0x00B6,0x00BC, // B0-B7
    0x00BD,0x00BE,0x005E,0x005D,0x007E,0x00A8,0x00B4,0x00D7, // B8-BF
    0x007B,0x0041,0x0042,0x0043,0x0044,0x0045,0x0046,0x0047, // C0-C7
    0x0048,0x0049,0x00AD,0x00F4,0x00F6,0x00F2,0x00F3,0x00F5, // C8-CF
    0x007D,0x004A,0x004B,0x004C,0x004D,0x004E,0x004F,0x0050, // D0-D7
    0x0051,0x0052,0x00B9,0x00FB,0x00FC,0x00F9,0x00FA,0x00FF, // D8-DF
...
/// CP297 (EBCDIC France) — full 256-entry EBCDIC table (host-generated).
const CP297_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
    ...
    0x0090,0x0091,0x0016,0x0093,0x0094,0x0095,0x0096,0x0004, // 30-37
    0x0098,0x0099,0x009A,0x009B,0x0014,0x0015,0x009E,0x001A, // 38-3F
    0x0020,0x00A0,0x00E2,0x00E4,0x0040,0x00E1,0x00E3,0x00E5, // 40-47
    0x005C,0x00F1,0x00B0,0x002E,0x003C,0x0028,0x002B,0x0021, // 48-4F
    0x0026,0x007B,0x00EA,0x00EB,0x007D,0x00ED,0x00EE,0x00EF, // 50-57
    0x00EC,0x00DF,0x00A7,0x0024,0x002A,0x0029,0x003B,0x005E, // 58-5F
    0x002D,0x002F,0x00C2,0x00C4,0x00C0,0x00C1,0x00C3,0x00C5, // 60-67
    0x00C7,0x00D1,0x00F9,0x002C,0x0025,0x005F,0x003E,0x003F, // 68-6F
    0x00F8,0x00C9,0x00CA,0x00CB,0x00C8,0x00CD,0x00CE,0x00CF, // 70-77
    0x00CC,0x00B5,0x003A,0x00A3,0x00E0,0x0027,0x003D,0x0022, // 78-7F
    0x00D8,0x0061,0x0062,0x0063,0x0064,0x0065,0x0066,0x0067, // 80-87
    0x0068,0x0069,0x00AB,0x00BB,0x00F0,0x00FD,0x00FE,0x00B1, // 88-8F
    0x005B,0x006A,0x006B,0x006C,0x006D,0x006E,0x006F,0x0070, // 90-97
    0x0071,0x0072,0x00AA,0x00BA,0x00E6,0x00B8,0x00C6,0x00A4, // 98-9F
    0x0060,0x00A8,0x0073,0x0074,0x0075,0x0076,0x0077,0x0078, // A0-A7
    0x0079,0x007A,0x00A1,0x00BF,0x00D0,0x00DD,0x00DE,0x00AE, // A8-AF
    0x00A2,0x0023,0x00A5,0x00B7,0x00A9,0x005D,0x00B6,0x00BC, // B0-B7
    0x00BD,0x00BE,0x00AC,0x007C,0x00AF,0x007E,0x00B4,0x00D7, // B8-BF
    0x00E9,0x0041,0x0042,0x0043,0x0044,0x0045,0x0046,0x0047, // C0-C7
    0x0048,0x0049,0x00AD,0x00F4,0x00F6,0x00F2,0x00F3,0x00F5, // C8-CF
    0x00E8,0x004A,0x004B,0x004C,0x004D,0x004E,0x004F,0x0050, // D0-D7
    0x0051,0x0052,0x00B9,0x00FB,0x00FC,0x00A6,0x00FA,0x00FF, // D8-DF
    0x00E7,0x00F7,0x0053,0x0054,0x0055,0x0056,0x0057,0x0058, // E0-E7
    0x0059,0x005A,0x00B2,0x00D4,0x00D6,0x00D2,0x00D3,0x00D5, // E8-EF
    0x0030,0x0031,0x0032,0x0033,0x0034,0x0035,0x0036,0x0037, // F0-F7
    0x0038,0x0039,0x00B3,0x00DB,0x00DC,0x00D9,0x00DA,0x009F, // F8-FF
...
/// CP871 (EBCDIC Iceland) — full 256-entry EBCDIC table (host-generated).
const CP871_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
    ...
    0x0098,0x0099,0x009A,0x009B,0x0014,0x0015,0x009E,0x001A, // 38-3F
    0x0020,0x00A0,0x00E2,0x00E4,0x00E0,0x00E1,0x00E3,0x00E5, // 40-47
    0x00E7,0x00F1,0x00FE,0x002E,0x003C,0x0028,0x002B,0x0021, // 48-4F
    0x0026,0x00E9,0x00EA,0x00EB,0x00E8,0x00ED,0x00EE,0x00EF, // 50-57
    0x00EC,0x00DF,0x00C6,0x0024,0x002A,0x0029,0x003B,0x00D6, // 58-5F
    0x002D,0x002F,0x00C2,0x00C4,0x00C0,0x00C1,0x00C3,0x00C5, // 60-67
    0x00C7,0x00D1,0x00A6,0x002C,0x0025,0x005F,0x003E,0x003F, // 68-6F
    0x00F8,0x00C9,0x00CA,0x00CB,0x00C8,0x00CD,0x00CE,0x00CF, // 70-77
    0x00CC,0x00F0,0x003A,0x0023,0x00D0,0x0027,0x003D,0x0022, // 78-7F
    0x00D8,0x0061,0x0062,0x0063,0x0064,0x0065,0x0066,0x0067, // 80-87
    0x0068,0x0069,0x00AB,0x00BB,0x0060,0x00FD,0x007B,0x00B1, // 88-8F
    0x00B0,0x006A,0x006B,0x006C,0x006D,0x006E,0x006F,0x0070, // 90-97
    0x0071,0x0072,0x00AA,0x00BA,0x007D,0x00B8,0x005D,0x00A4, // 98-9F
    0x00B5,0x00F6,0x0073,0x0074,0x0075,0x0076,0x0077,0x0078, // A0-A7
    0x0079,0x007A,0x00A1,0x00BF,0x0040,0x00DD,0x005B,0x00AE, // A8-AF
    0x00A2,0x00A3,0x00A5,0x00B7,0x00A9,0x00A7,0x00B6,0x00BC, // B0-B7
    0x00BD,0x00BE,0x00AC,0x007C,0x00AF,0x00A8,0x005C,0x00D7, // B8-BF
    0x00DE,0x0041,0x0042,0x0043,0x0044,0x0045,0x0046,0x0047, // C0-C7
    0x0048,0x0049,0x00AD,0x00F4,0x007E,0x00F2,0x00F3,0x00F5, // C8-CF
    0x00E6,0x004A,0x004B,0x004C,0x004D,0x004E,0x004F,0x0050, // D0-D7
    0x0051,0x0052,0x00B9,0x00FB,0x00FC,0x00F9,0x00FA,0x00FF, // D8-DF
    0x00B4,0x00F7,0x0053,0x0054,0x0055,0x0056,0x0057,0x0058, // E0-E7
    0x0059,0x005A,0x00B2,0x00D4,0x005E,0x00D2,0x00D3,0x00D5, // E8-EF
    0x0030,0x0031,0x0032,0x0033,0x0034,0x0035,0x0036,0x0037, // F0-F7
    0x0038,0x0039,0x00B3,0x00DB,0x00DC,0x00D9,0x00DA,0x009F, // F8-FF
];

/// CP870 (EBCDIC Latin-2 (ROECE/Yugoslavia)) — full 256-entry EBCDIC table (host-generated).
const CP870_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
    ...
    0x0090,0x0091,0x0016,0x0093,0x0094,0x0095,0x0096,0x0004, // 30-37
    0x0098,0x0099,0x009A,0x009B,0x0014,0x0015,0x009E,0x001A, // 38-3F
    0x0020,0x00A0,0x00E2,0x00E4,0x0163,0x00E1,0x0103,0x010D, // 40-47
    0x00E7,0x0107,0x005B,0x002E,0x003C,0x0028,0x002B,0x0021, // 48-4F
    0x0026,0x00E9,0x0119,0x00EB,0x016F,0x00ED,0x00EE,0x013E, // 50-57
    0x013A,0x00DF,0x005D,0x0024,0x002A,0x0029,0x003B,0x005E, // 58-5F
    0x002D,0x002F,0x00C2,0x00C4,0x02DD,0x00C1,0x0102,0x010C, // 60-67
    0x00C7,0x0106,0x007C,0x002C,0x0025,0x005F,0x003E,0x003F, // 68-6F
    0x02C7,0x00C9,0x0118,0x00CB,0x016E,0x00CD,0x00CE,0x013D, // 70-77
    0x0139,0x0060,0x003A,0x0023,0x0040,0x0027,0x003D,0x0022, // 78-7F
    0x02D8,0x0061,0x0062,0x0063,0x0064,0x0065,0x0066,0x0067, // 80-87
    0x0068,0x0069,0x015B,0x0148,0x0111,0x00FD,0x0159,0x015F, // 88-8F
    0x00B0,0x006A,0x006B,0x006C,0x006D,0x006E,0x006F,0x0070, // 90-97
    0x0071,0x0072,0x0142,0x0144,0x0161,0x00B8,0x02DB,0x00A4, // 98-9F
    0x0105,0x007E,0x0073,0x0074,0x0075,0x0076,0x0077,0x0078, // A0-A7
    0x0079,0x007A,0x015A,0x0147,0x0110,0x00DD,0x0158,0x015E, // A8-AF
    0x00B7,0x0104,0x017C,0x0162,0x017B,0x00A7,0x017E,0x017A, // B0-B7
    0x017D,0x0179,0x0141,0x0143,0x0160,0x00A8,0x00B4,0x00D7, // B8-BF
    0x007B,0x0041,0x0042,0x0043,0x0044,0x0045,0x0046,0x0047, // C0-C7
    0x0048,0x0049,0x00AD,0x00F4,0x00F6,0x0155,0x00F3,0x0151, // C8-CF
    0x007D,0x004A,0x004B,0x004C,0x004D,0x004E,0x004F,0x0050, // D0-D7
    0x0051,0x0052,0x011A,0x0171,0x00FC,0x0165,0x00FA,0x011B, // D8-DF
    0x005C,0x00F7,0x0053,0x0054,0x0055,0x0056,0x0057,0x0058, // E0-E7
    0x0059,0x005A,0x010F,0x00D4,0x00D6,0x0154,0x00D3,0x0150, // E8-EF
    0x0030,0x0031,0x0032,0x0033,0x0034,0x0035,0x0036,0x0037, // F0-F7
    0x0038,0x0039,0x010E,0x0170,0x00DC,0x0164,0x00DA,0x009F, // F8-FF
];

/// CP875 (EBCDIC Greek) — full 256-entry EBCDIC table (host-generated).
const CP875_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
    ...
    0x0090,0x0091,0x0016,0x0093,0x0094,0x0095,0x0096,0x0004, // 30-37
    0x0098,0x0099,0x009A,0x009B,0x0014,0x0015,0x009E,0x001A, // 38-3F
    0x0020,0x0391,0x0392,0x0393,0x0394,0x0395,0x0396,0x0397, // 40-47
    0x0398,0x0399,0x005B,0x002E,0x003C,0x0028,0x002B,0x0021, // 48-4F
    0x0026,0x039A,0x039B,0x039C,0x039D,0x039E,0x039F,0x03A0, // 50-57
    0x03A1,0x03A3,0x005D,0x0024,0x002A,0x0029,0x003B,0x005E, // 58-5F
    0x002D,0x002F,0x03A4,0x03A5,0x03A6,0x03A7,0x03A8,0x03A9, // 60-67
    0x03AA,0x03AB,0xFFFF,0x002C,0x0025,0x005F,0x003E,0x003F, // 68-6F
    0x00A8,0x0386,0x0388,0x0389,0x2207,0x038A,0x038C,0x038E, // 70-77
    0x038F,0x0060,0x003A,0x0023,0x0040,0x0027,0x003D,0x0022, // 78-7F
    0x0385,0x0061,0x0062,0x0063,0x0064,0x0065,0x0066,0x0067, // 80-87
    0x0068,0x0069,0x03B1,0x03B2,0x03B3,0x03B4,0x03B5,0x03B6, // 88-8F
    0x00B0,0x006A,0x006B,0x006C,0x006D,0x006E,0x006F,0x0070, // 90-97
    0x0071,0x0072,0x03B7,0x03B8,0x03B9,0x03BA,0x03BB,0x03BC, // 98-9F
    0x00B4,0x007E,0x0073,0x0074,0x0075,0x0076,0x0077,0x0078, // A0-A7
    0x0079,0x007A,0x03BD,0x03BE,0x03BF,0x03C0,0x03C1,0x03C3, // A8-AF
    0x00A3,0x03AC,0x03AD,0x03AE,0x03CA,0x03AF,0x03CC,0x03CD, // B0-B7
    0x03CB,0x03CE,0x03C2,0x03C4,0x03C5,0x03C6,0x03C7,0x03C8, // B8-BF
    0x007B,0x0041,0x0042,0x0043,0x0044,0x0045,0x0046,0x0047, // C0-C7
    0x0048,0x0049,0x00AD,0x03C9,0x0390,0x03B0,0x2018,0x2015, // C8-CF
    0x007D,0x004A,0x004B,0x004C,0x004D,0x004E,0x004F,0x0050, // D0-D7
    0x0051,0x0052,0x00B1,0x00BD,0xFFFF,0x00B7,0x2019,0x00A6, // D8-DF
    0x005C,0xFFFF,0x0053,0x0054,0x0055,0x0056,0x0057,0x0058, // E0-E7
    0x0059,0x005A,0x00B2,0x00A7,0xFFFF,0xFFFF,0x00AB,0x00AC, // E8-EF
    0x0030,0x0031,0x0032,0x0033,0x0034,0x0035,0x0036,0x0037, // F0-F7
    0x0038,0x0039,0x00B3,0x00A9,0xFFFF,0xFFFF,0x00BB,0x009F, // F8-FF
];

/// EBCDIC-CP-DK (EBCDIC Denmark/Norway) — full 256-entry EBCDIC table (host-generated).
const EBCDIC_CP_DK_TO_UNICODE: [u16; 256] = [
    0x0000,0x0001,0x0002,0x0003,0x009C,0x0009,0x0086,0x007F, // 00-07
    0x0097,0x008D,0x008E,0x000B,0x000C,0x000D,0x000E,0x000F, // 08-0F
    0x0010,0x0011,0x0012,0x0013,0x009D,0x0085,0x0008,0x0087, // 10-17
    0x0018,0x0019,0x0092,0x008F,0x001C,0x001D,0x001E,0x001F, // 18-1F
    ...
    0x0090,0x0091,0x0016,0x0093,0x0094,0x0095,0x0096,0x0004, // 30-37
    0x0098,0x0099,0x009A,0x009B,0x0014,0x0015,0x009E,0x001A, // 38-3F
    0x0020,0x00A0,0x00E2,0x00E4,0x00E0,0x00E1,0x00E3,0x007D, // 40-47
    0x00E7,0x00F1,0x0023,0x002E,0x003C,0x0028,0x002B,0x0021, // 48-4F
    0x0026,0x00E9,0x00EA,0x00EB,0x00E8,0x00ED,0x00EE,0x00EF, // 50-57
    0x00EC,0x00DF,0x00A4,0x00C5,0x002A,0x0029,0x003B,0x005E, // 58-5F
    0x002D,0x002F,0x00C2,0x00C4,0x00C0,0x00C1,0x00C3,0x0024, // 60-67
    0x00C7,0x00D1,0x00F8,0x002C,0x0025,0x005F,0x003E,0x003F, // 68-6F
    0x00A6,0x00C9,0x00CA,0x00CB,0x00C8,0x00CD,0x00CE,0x00CF, // 70-77
    0x00CC,0x0060,0x003A,0x00C6,0x00D8,0x0027,0x003D,0x0022, // 78-7F
    0x0040,0x0061,0x0062,0x0063,0x0064,0x0065,0x0066,0x0067, // 80-87
    0x0068,0x0069,0x00AB,0x00BB,0x00F0,0x00FD,0x00FE,0x00B1, // 88-8F
    0x00B0,0x006A,0x006B,0x006C,0x006D,0x006E,0x006F,0x0070, // 90-97
    0x0071,0x0072,0x00AA,0x00BA,0x007B,0x00B8,0x005B,0x005D, // 98-9F
    0x00B5,0x00FC,0x0073,0x0074,0x0075,0x0076,0x0077,0x0078, // A0-A7
    0x0079,0x007A,0x00A1,0x00BF,0x00D0,0x00DD,0x00DE,0x00AE, // A8-AF
    0x00A2,0x00A3,0x00A5,0x00B7,0x00A9,0x00A7,0x00B6,0x00BC, // B0-B7
    0x00BD,0x00BE,0x00AC,0x007C,0x00AF,0x00A8,0x00B4,0x00D7, // B8-BF
    0x00E6,0x0041,0x0042,0x0043,0x0044,0x0045,0x0046,0x0047, // C0-C7
    0x0048,0x0049,0x00AD,0x00F4,0x00F6,0x00F2,0x00F3,0x00F5, // C8-CF
    0x00E5,0x004A,0x004B,0x004C,0x004D,0x004E,0x004F,0x0050, // D0-D7
    0x0051,0x0052,0x00B9,0x00FB,0x007E,0x00F9,0x00FA,0x00FF, // D8-DF
    0x005C,0x00F7,0x0053,0x0054,0x0055,0x0056,0x0057,0x0058, // E0-E7
...
const CP273_ENC: &[(u16, u8)] = &[
    ...
    (0x0030,0xF0),(0x0031,0xF1),(0x0032,0xF2),(0x0033,0xF3),(0x0034,0xF4),(0x0035,0xF5),(0x0036,0xF6),(0x0037,0xF7),
    (0x0038,0xF8),(0x0039,0xF9),(0x003A,0x7A),(0x003B,0x5E),(0x003C,0x4C),(0x003D,0x7E),(0x003E,0x6E),(0x003F,0x6F),
    (0x0040,0xB5),(0x0041,0xC1),(0x0042,0xC2),(0x0043,0xC3),(0x0044,0xC4),(0x0045,0xC5),(0x0046,0xC6),(0x0047,0xC7),
    (0x0048,0xC8),(0x0049,0xC9),(0x004A,0xD1),(0x004B,0xD2),(0x004C,0xD3),(0x004D,0xD4),(0x004E,0xD5),(0x004F,0xD6),
    (0x0050,0xD7),(0x0051,0xD8),(0x0052,0xD9),(0x0053,0xE2),(0x0054,0xE3),(0x0055,0xE4),(0x0056,0xE5),(0x0057,0xE6),
    (0x0058,0xE7),(0x0059,0xE8),(0x005A,0xE9),(0x005B,0x63),(0x005C,0xEC),(0x005D,0xFC),(0x005E,0x5F),(0x005F,0x6D),
    (0x0060,0x79),(0x0061,0x81),(0x0062,0x82),(0x0063,0x83),(0x0064,0x84),(0x0065,0x85),(0x0066,0x86),(0x0067,0x87),
    (0x0068,0x88),(0x0069,0x89),(0x006A,0x91),(0x006B,0x92),(0x006C,0x93),(0x006D,0x94),(0x006E,0x95),(0x006F,0x96),
    (0x0070,0x97),(0x0071,0x98),(0x0072,0x99),(0x0073,0xA2),(0x0074,0xA3),(0x0075,0xA4),(0x0076,0xA5),(0x0077,0xA6),
    (0x0078,0xA7),(0x0079,0xA8),(0x007A,0xA9),(0x007B,0x43),(0x007C,0xBB),(0x007D,0xDC),(0x007E,0x59),(0x007F,0x07),
    (0x0080,0x20),(0x0081,0x21),(0x0082,0x22),(0x0083,0x23),(0x0084,0x24),(0x0085,0x15),(0x0086,0x06),(0x0087,0x17),
    (0x0088,0x28),(0x0089,0x29),(0x008A,0x2A),(0x008B,0x2B),(0x008C,0x2C),(0x008D,0x09),(0x008E,0x0A),(0x008F,0x1B),
    (0x0090,0x30),(0x0091,0x31),(0x0092,0x1A),(0x0093,0x33),(0x0094,0x34),(0x0095,0x35),(0x0096,0x36),(0x0097,0x08),
    (0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),
    (0x00A0,0x41),(0x00A1,0xAA),(0x00A2,0xB0),(0x00A3,0xB1),(0x00A4,0x9F),(0x00A5,0xB2),(0x00A6,0xCC),(0x00A7,0x7C),
    (0x00A8,0xBD),(0x00A9,0xB4),(0x00AA,0x9A),(0x00AB,0x8A),(0x00AC,0xBA),(0x00AD,0xCA),(0x00AE,0xAF),(0x00AF,0xBC),
    (0x00B0,0x90),(0x00B1,0x8F),(0x00B2,0xEA),(0x00B3,0xFA),(0x00B4,0xBE),(0x00B5,0xA0),(0x00B6,0xB6),(0x00B7,0xB3),
    (0x00B8,0x9D),(0x00B9,0xDA),(0x00BA,0x9B),(0x00BB,0x8B),(0x00BC,0xB7),(0x00BD,0xB8),(0x00BE,0xB9),(0x00BF,0xAB),
    (0x00C0,0x64),(0x00C1,0x65),(0x00C2,0x62),(0x00C3,0x66),(0x00C4,0x4A),(0x00C5,0x67),(0x00C6,0x9E),(0x00C7,0x68),
    (0x00C8,0x74),(0x00C9,0x71),(0x00CA,0x72),(0x00CB,0x73),(0x00CC,0x78),(0x00CD,0x75),(0x00CE,0x76),(0x00CF,0x77),
    (0x00D0,0xAC),(0x00D1,0x69),(0x00D2,0xED),(0x00D3,0xEE),(0x00D4,0xEB),(0x00D5,0xEF),(0x00D6,0xE0),(0x00D7,0xBF),
    (0x00D8,0x80),(0x00D9,0xFD),(0x00DA,0xFE),(0x00DB,0xFB),(0x00DC,0x5A),(0x00DD,0xAD),(0x00DE,0xAE),(0x00DF,0xA1),
    (0x00E0,0x44),(0x00E1,0x45),(0x00E2,0x42),(0x00E3,0x46),(0x00E4,0xC0),(0x00E5,0x47),(0x00E6,0x9C),(0x00E7,0x48),
    (0x00E8,0x54),(0x00E9,0x51),(0x00EA,0x52),(0x00EB,0x53),(0x00EC,0x58),(0x00ED,0x55),(0x00EE,0x56),(0x00EF,0x57),
    (0x00F0,0x8C),(0x00F1,0x49),(0x00F2,0xCD),(0x00F3,0xCE),(0x00F4,0xCB),(0x00F5,0xCF),(0x00F6,0x6A),(0x00F7,0xE1),
    (0x00F8,0x70),(0x00F9,0xDD),(0x00FA,0xDE),(0x00FB,0xDB),(0x00FC,0xD0),(0x00FD,0x8D),(0x00FE,0x8E),(0x00FF,0xDF),
];

const CP278_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    (0x0020,0x40),(0x0021,0x4F),(0x0022,0x7F),(0x0023,0x63),(0x0024,0x67),(0x0025,0x6C),(0x0026,0x50),(0x0027,0x7D),
    (0x0028,0x4D),(0x0029,0x5D),(0x002A,0x5C),(0x002B,0x4E),(0x002C,0x6B),(0x002D,0x60),(0x002E,0x4B),(0x002F,0x61),
    (0x0030,0xF0),(0x0031,0xF1),(0x0032,0xF2),(0x0033,0xF3),(0x0034,0xF4),(0x0035,0xF5),(0x0036,0xF6),(0x0037,0xF7),
    (0x0038,0xF8),(0x0039,0xF9),(0x003A,0x7A),(0x003B,0x5E),(0x003C,0x4C),(0x003D,0x7E),(0x003E,0x6E),(0x003F,0x6F),
    (0x0040,0xEC),(0x0041,0xC1),(0x0042,0xC2),(0x0043,0xC3),(0x0044,0xC4),(0x0045,0xC5),(0x0046,0xC6),(0x0047,0xC7),
    (0x0048,0xC8),(0x0049,0xC9),(0x004A,0xD1),(0x004B,0xD2),(0x004C,0xD3),(0x004D,0xD4),(0x004E,0xD5),(0x004F,0xD6),
    (0x0050,0xD7),(0x0051,0xD8),(0x0052,0xD9),(0x0053,0xE2),(0x0054,0xE3),(0x0055,0xE4),(0x0056,0xE5),(0x0057,0xE6),
    (0x0058,0xE7),(0x0059,0xE8),(0x005A,0xE9),(0x005B,0xB5),(0x005C,0xE0),(0x005D,0x9F),(0x005E,0x5F),(0x005F,0x6D),
    (0x0060,0x51),(0x0061,0x81),(0x0062,0x82),(0x0063,0x83),(0x0064,0x84),(0x0065,0x85),(0x0066,0x86),(0x0067,0x87),
    (0x0068,0x88),(0x0069,0x89),(0x006A,0x91),(0x006B,0x92),(0x006C,0x93),(0x006D,0x94),(0x006E,0x95),(0x006F,0x96),
    (0x0070,0x97),(0x0071,0x98),(0x0072,0x99),(0x0073,0xA2),(0x0074,0xA3),(0x0075,0xA4),(0x0076,0xA5),(0x0077,0xA6),
    (0x0078,0xA7),(0x0079,0xA8),(0x007A,0xA9),(0x007B,0x43),(0x007C,0xBB),(0x007D,0x47),(0x007E,0xDC),(0x007F,0x07),
    (0x0080,0x20),(0x0081,0x21),(0x0082,0x22),(0x0083,0x23),(0x0084,0x24),(0x0085,0x15),(0x0086,0x06),(0x0087,0x17),
    (0x0088,0x28),(0x0089,0x29),(0x008A,0x2A),(0x008B,0x2B),(0x008C,0x2C),(0x008D,0x09),(0x008E,0x0A),(0x008F,0x1B),
    (0x0090,0x30),(0x0091,0x31),(0x0092,0x1A),(0x0093,0x33),(0x0094,0x34),(0x0095,0x35),(0x0096,0x36),(0x0097,0x08),
    (0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),
    (0x00A0,0x41),(0x00A1,0xAA),(0x00A2,0xB0),(0x00A3,0xB1),(0x00A4,0x5A),(0x00A5,0xB2),(0x00A6,0xCC),(0x00A7,0x4A),
    (0x00A8,0xBD),(0x00A9,0xB4),(0x00AA,0x9A),(0x00AB,0x8A),(0x00AC,0xBA),(0x00AD,0xCA),(0x00AE,0xAF),(0x00AF,0xBC),
    (0x00B0,0x90),(0x00B1,0x8F),(0x00B2,0xEA),(0x00B3,0xFA),(0x00B4,0xBE),(0x00B5,0xA0),(0x00B6,0xB6),(0x00B7,0xB3),
    (0x00B8,0x9D),(0x00B9,0xDA),(0x00BA,0x9B),(0x00BB,0x8B),(0x00BC,0xB7),(0x00BD,0xB8),(0x00BE,0xB9),(0x00BF,0xAB),
    (0x00C0,0x64),(0x00C1,0x65),(0x00C2,0x62),(0x00C3,0x66),(0x00C4,0x7B),(0x00C5,0x5B),(0x00C6,0x9E),(0x00C7,0x68),
    (0x00C8,0x74),(0x00C9,0x71),(0x00CA,0x72),(0x00CB,0x73),(0x00CC,0x78),(0x00CD,0x75),(0x00CE,0x76),(0x00CF,0x77),
    (0x00D0,0xAC),(0x00D1,0x69),(0x00D2,0xED),(0x00D3,0xEE),(0x00D4,0xEB),(0x00D5,0xEF),(0x00D6,0x7C),(0x00D7,0xBF),
    (0x00D8,0x80),(0x00D9,0xFD),(0x00DA,0xFE),(0x00DB,0xFB),(0x00DC,0xFC),(0x00DD,0xAD),(0x00DE,0xAE),(0x00DF,0x59),
    (0x00E0,0x44),(0x00E1,0x45),(0x00E2,0x42),(0x00E3,0x46),(0x00E4,0xC0),(0x00E5,0xD0),(0x00E6,0x9C),(0x00E7,0x48),
    (0x00E8,0x54),(0x00E9,0x79),(0x00EA,0x52),(0x00EB,0x53),(0x00EC,0x58),(0x00ED,0x55),(0x00EE,0x56),(0x00EF,0x57),
    (0x00F0,0x8C),(0x00F1,0x49),(0x00F2,0xCD),(0x00F3,0xCE),(0x00F4,0xCB),(0x00F5,0xCF),(0x00F6,0x6A),(0x00F7,0xE1),
    (0x00F8,0x70),(0x00F9,0xDD),(0x00FA,0xDE),(0x00FB,0xDB),(0x00FC,0xA1),(0x00FD,0x8D),(0x00FE,0x8E),(0x00FF,0xDF),
];

const CP280_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    (0x0020,0x40),(0x0021,0x4F),(0x0022,0x7F),(0x0023,0xB1),(0x0024,0x5B),(0x0025,0x6C),(0x0026,0x50),(0x0027,0x7D),
    (0x0028,0x4D),(0x0029,0x5D),(0x002A,0x5C),(0x002B,0x4E),(0x002C,0x6B),(0x002D,0x60),(0x002E,0x4B),(0x002F,0x61),
    (0x0030,0xF0),(0x0031,0xF1),(0x0032,0xF2),(0x0033,0xF3),(0x0034,0xF4),(0x0035,0xF5),(0x0036,0xF6),(0x0037,0xF7),
    (0x0038,0xF8),(0x0039,0xF9),(0x003A,0x7A),(0x003B,0x5E),(0x003C,0x4C),(0x003D,0x7E),(0x003E,0x6E),(0x003F,0x6F),
    (0x0040,0xB5),(0x0041,0xC1),(0x0042,0xC2),(0x0043,0xC3),(0x0044,0xC4),(0x0045,0xC5),(0x0046,0xC6),(0x0047,0xC7),
    (0x0048,0xC8),(0x0049,0xC9),(0x004A,0xD1),(0x004B,0xD2),(0x004C,0xD3),(0x004D,0xD4),(0x004E,0xD5),(0x004F,0xD6),
    (0x0050,0xD7),(0x0051,0xD8),(0x0052,0xD9),(0x0053,0xE2),(0x0054,0xE3),(0x0055,0xE4),(0x0056,0xE5),(0x0057,0xE6),
    (0x0058,0xE7),(0x0059,0xE8),(0x005A,0xE9),(0x005B,0x90),(0x005C,0x48),(0x005D,0x51),(0x005E,0x5F),(0x005F,0x6D),
    (0x0060,0xDD),(0x0061,0x81),(0x0062,0x82),(0x0063,0x83),(0x0064,0x84),(0x0065,0x85),(0x0066,0x86),(0x0067,0x87),
    (0x0068,0x88),(0x0069,0x89),(0x006A,0x91),(0x006B,0x92),(0x006C,0x93),(0x006D,0x94),(0x006E,0x95),(0x006F,0x96),
    (0x0070,0x97),(0x0071,0x98),(0x0072,0x99),(0x0073,0xA2),(0x0074,0xA3),(0x0075,0xA4),(0x0076,0xA5),(0x0077,0xA6),
    (0x0078,0xA7),(0x0079,0xA8),(0x007A,0xA9),(0x007B,0x44),(0x007C,0xBB),(0x007D,0x54),(0x007E,0x58),(0x007F,0x07),
    (0x0080,0x20),(0x0081,0x21),(0x0082,0x22),(0x0083,0x23),(0x0084,0x24),(0x0085,0x15),(0x0086,0x06),(0x0087,0x17),
    (0x0088,0x28),(0x0089,0x29),(0x008A,0x2A),(0x008B,0x2B),(0x008C,0x2C),(0x008D,0x09),(0x008E,0x0A),(0x008F,0x1B),
    (0x0090,0x30),(0x0091,0x31),(0x0092,0x1A),(0x0093,0x33),(0x0094,0x34),(0x0095,0x35),(0x0096,0x36),(0x0097,0x08),
    (0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),
    (0x00A0,0x41),(0x00A1,0xAA),(0x00A2,0xB0),(0x00A3,0x7B),(0x00A4,0x9F),(0x00A5,0xB2),(0x00A6,0xCD),(0x00A7,0x7C),
    (0x00A8,0xBD),(0x00A9,0xB4),(0x00AA,0x9A),(0x00AB,0x8A),(0x00AC,0xBA),(0x00AD,0xCA),(0x00AE,0xAF),(0x00AF,0xBC),
    (0x00B0,0x4A),(0x00B1,0x8F),(0x00B2,0xEA),(0x00B3,0xFA),(0x00B4,0xBE),(0x00B5,0xA0),(0x00B6,0xB6),(0x00B7,0xB3),
    (0x00B8,0x9D),(0x00B9,0xDA),(0x00BA,0x9B),(0x00BB,0x8B),(0x00BC,0xB7),(0x00BD,0xB8),(0x00BE,0xB9),(0x00BF,0xAB),
    (0x00C0,0x64),(0x00C1,0x65),(0x00C2,0x62),(0x00C3,0x66),(0x00C4,0x63),(0x00C5,0x67),(0x00C6,0x9E),(0x00C7,0x68),
    (0x00C8,0x74),(0x00C9,0x71),(0x00CA,0x72),(0x00CB,0x73),(0x00CC,0x78),(0x00CD,0x75),(0x00CE,0x76),(0x00CF,0x77),
    (0x00D0,0xAC),(0x00D1,0x69),(0x00D2,0xED),(0x00D3,0xEE),(0x00D4,0xEB),(0x00D5,0xEF),(0x00D6,0xEC),(0x00D7,0xBF),
    (0x00D8,0x80),(0x00D9,0xFD),(0x00DA,0xFE),(0x00DB,0xFB),(0x00DC,0xFC),(0x00DD,0xAD),(0x00DE,0xAE),(0x00DF,0x59),
    (0x00E0,0xC0),(0x00E1,0x45),(0x00E2,0x42),(0x00E3,0x46),(0x00E4,0x43),(0x00E5,0x47),(0x00E6,0x9C),(0x00E7,0xE0),
    (0x00E8,0xD0),(0x00E9,0x5A),(0x00EA,0x52),(0x00EB,0x53),(0x00EC,0xA1),(0x00ED,0x55),(0x00EE,0x56),(0x00EF,0x57),
    (0x00F0,0x8C),(0x00F1,0x49),(0x00F2,0x6A),(0x00F3,0xCE),(0x00F4,0xCB),(0x00F5,0xCF),(0x00F6,0xCC),(0x00F7,0xE1),
    (0x00F8,0x70),(0x00F9,0x79),(0x00FA,0xDE),(0x00FB,0xDB),(0x00FC,0xDC),(0x00FD,0x8D),(0x00FE,0x8E),(0x00FF,0xDF),
];

const CP284_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    (0x0020,0x40),(0x0021,0xBB),(0x0022,0x7F),(0x0023,0x69),(0x0024,0x5B),(0x0025,0x6C),(0x0026,0x50),(0x0027,0x7D),
    (0x0028,0x4D),(0x0029,0x5D),(0x002A,0x5C),(0x002B,0x4E),(0x002C,0x6B),(0x002D,0x60),(0x002E,0x4B),(0x002F,0x61),
    (0x0030,0xF0),(0x0031,0xF1),(0x0032,0xF2),(0x0033,0xF3),(0x0034,0xF4),(0x0035,0xF5),(0x0036,0xF6),(0x0037,0xF7),
    (0x0038,0xF8),(0x0039,0xF9),(0x003A,0x7A),(0x003B,0x5E),(0x003C,0x4C),(0x003D,0x7E),(0x003E,0x6E),(0x003F,0x6F),
    (0x0040,0x7C),(0x0041,0xC1),(0x0042,0xC2),(0x0043,0xC3),(0x0044,0xC4),(0x0045,0xC5),(0x0046,0xC6),(0x0047,0xC7),
    (0x0048,0xC8),(0x0049,0xC9),(0x004A,0xD1),(0x004B,0xD2),(0x004C,0xD3),(0x004D,0xD4),(0x004E,0xD5),(0x004F,0xD6),
    (0x0050,0xD7),(0x0051,0xD8),(0x0052,0xD9),(0x0053,0xE2),(0x0054,0xE3),(0x0055,0xE4),(0x0056,0xE5),(0x0057,0xE6),
    (0x0058,0xE7),(0x0059,0xE8),(0x005A,0xE9),(0x005B,0x4A),(0x005C,0xE0),(0x005D,0x5A),(0x005E,0xBA),(0x005F,0x6D),
    (0x0060,0x79),(0x0061,0x81),(0x0062,0x82),(0x0063,0x83),(0x0064,0x84),(0x0065,0x85),(0x0066,0x86),(0x0067,0x87),
    (0x0068,0x88),(0x0069,0x89),(0x006A,0x91),(0x006B,0x92),(0x006C,0x93),(0x006D,0x94),(0x006E,0x95),(0x006F,0x96),
    (0x0070,0x97),(0x0071,0x98),(0x0072,0x99),(0x0073,0xA2),(0x0074,0xA3),(0x0075,0xA4),(0x0076,0xA5),(0x0077,0xA6),
    (0x0078,0xA7),(0x0079,0xA8),(0x007A,0xA9),(0x007B,0xC0),(0x007C,0x4F),(0x007D,0xD0),(0x007E,0xBD),(0x007F,0x07),
    (0x0080,0x20),(0x0081,0x21),(0x0082,0x22),(0x0083,0x23),(0x0084,0x24),(0x0085,0x15),(0x0086,0x06),(0x0087,0x17),
    (0x0088,0x28),(0x0089,0x29),(0x008A,0x2A),(0x008B,0x2B),(0x008C,0x2C),(0x008D,0x09),(0x008E,0x0A),(0x008F,0x1B),
    (0x0090,0x30),(0x0091,0x31),(0x0092,0x1A),(0x0093,0x33),(0x0094,0x34),(0x0095,0x35),(0x0096,0x36),(0x0097,0x08),
    (0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),
    (0x00A0,0x41),(0x00A1,0xAA),(0x00A2,0xB0),(0x00A3,0xB1),(0x00A4,0x9F),(0x00A5,0xB2),(0x00A6,0x49),(0x00A7,0xB5),
    (0x00A8,0xA1),(0x00A9,0xB4),(0x00AA,0x9A),(0x00AB,0x8A),(0x00AC,0x5F),(0x00AD,0xCA),(0x00AE,0xAF),(0x00AF,0xBC),
    (0x00B0,0x90),(0x00B1,0x8F),(0x00B2,0xEA),(0x00B3,0xFA),(0x00B4,0xBE),(0x00B5,0xA0),(0x00B6,0xB6),(0x00B7,0xB3),
    (0x00B8,0x9D),(0x00B9,0xDA),(0x00BA,0x9B),(0x00BB,0x8B),(0x00BC,0xB7),(0x00BD,0xB8),(0x00BE,0xB9),(0x00BF,0xAB),
    (0x00C0,0x64),(0x00C1,0x65),(0x00C2,0x62),(0x00C3,0x66),(0x00C4,0x63),(0x00C5,0x67),(0x00C6,0x9E),(0x00C7,0x68),
    (0x00C8,0x74),(0x00C9,0x71),(0x00CA,0x72),(0x00CB,0x73),(0x00CC,0x78),(0x00CD,0x75),(0x00CE,0x76),(0x00CF,0x77),
    (0x00D0,0xAC),(0x00D1,0x7B),(0x00D2,0xED),(0x00D3,0xEE),(0x00D4,0xEB),(0x00D5,0xEF),(0x00D6,0xEC),(0x00D7,0xBF),
    (0x00D8,0x80),(0x00D9,0xFD),(0x00DA,0xFE),(0x00DB,0xFB),(0x00DC,0xFC),(0x00DD,0xAD),(0x00DE,0xAE),(0x00DF,0x59),
    (0x00E0,0x44),(0x00E1,0x45),(0x00E2,0x42),(0x00E3,0x46),(0x00E4,0x43),(0x00E5,0x47),(0x00E6,0x9C),(0x00E7,0x48),
    (0x00E8,0x54),(0x00E9,0x51),(0x00EA,0x52),(0x00EB,0x53),(0x00EC,0x58),(0x00ED,0x55),(0x00EE,0x56),(0x00EF,0x57),
    (0x00F0,0x8C),(0x00F1,0x6A),(0x00F2,0xCD),(0x00F3,0xCE),(0x00F4,0xCB),(0x00F5,0xCF),(0x00F6,0xCC),(0x00F7,0xE1),
    (0x00F8,0x70),(0x00F9,0xDD),(0x00FA,0xDE),(0x00FB,0xDB),(0x00FC,0xDC),(0x00FD,0x8D),(0x00FE,0x8E),(0x00FF,0xDF),
];

const CP285_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    (0x0020,0x40),(0x0021,0x5A),(0x0022,0x7F),(0x0023,0x7B),(0x0024,0x4A),(0x0025,0x6C),(0x0026,0x50),(0x0027,0x7D),
    (0x0028,0x4D),(0x0029,0x5D),(0x002A,0x5C),(0x002B,0x4E),(0x002C,0x6B),(0x002D,0x60),(0x002E,0x4B),(0x002F,0x61),
    (0x0030,0xF0),(0x0031,0xF1),(0x0032,0xF2),(0x0033,0xF3),(0x0034,0xF4),(0x0035,0xF5),(0x0036,0xF6),(0x0037,0xF7),
    (0x0038,0xF8),(0x0039,0xF9),(0x003A,0x7A),(0x003B,0x5E),(0x003C,0x4C),(0x003D,0x7E),(0x003E,0x6E),(0x003F,0x6F),
    (0x0040,0x7C),(0x0041,0xC1),(0x0042,0xC2),(0x0043,0xC3),(0x0044,0xC4),(0x0045,0xC5),(0x0046,0xC6),(0x0047,0xC7),
    (0x0048,0xC8),(0x0049,0xC9),(0x004A,0xD1),(0x004B,0xD2),(0x004C,0xD3),(0x004D,0xD4),(0x004E,0xD5),(0x004F,0xD6),
    (0x0050,0xD7),(0x0051,0xD8),(0x0052,0xD9),(0x0053,0xE2),(0x0054,0xE3),(0x0055,0xE4),(0x0056,0xE5),(0x0057,0xE6),
    (0x0058,0xE7),(0x0059,0xE8),(0x005A,0xE9),(0x005B,0xB1),(0x005C,0xE0),(0x005D,0xBB),(0x005E,0xBA),(0x005F,0x6D),
    (0x0060,0x79),(0x0061,0x81),(0x0062,0x82),(0x0063,0x83),(0x0064,0x84),(0x0065,0x85),(0x0066,0x86),(0x0067,0x87),
    (0x0068,0x88),(0x0069,0x89),(0x006A,0x91),(0x006B,0x92),(0x006C,0x93),(0x006D,0x94),(0x006E,0x95),(0x006F,0x96),
    (0x0070,0x97),(0x0071,0x98),(0x0072,0x99),(0x0073,0xA2),(0x0074,0xA3),(0x0075,0xA4),(0x0076,0xA5),(0x0077,0xA6),
    (0x0078,0xA7),(0x0079,0xA8),(0x007A,0xA9),(0x007B,0xC0),(0x007C,0x4F),(0x007D,0xD0),(0x007E,0xBC),(0x007F,0x07),
    (0x0080,0x20),(0x0081,0x21),(0x0082,0x22),(0x0083,0x23),(0x0084,0x24),(0x0085,0x15),(0x0086,0x06),(0x0087,0x17),
    (0x0088,0x28),(0x0089,0x29),(0x008A,0x2A),(0x008B,0x2B),(0x008C,0x2C),(0x008D,0x09),(0x008E,0x0A),(0x008F,0x1B),
    (0x0090,0x30),(0x0091,0x31),(0x0092,0x1A),(0x0093,0x33),(0x0094,0x34),(0x0095,0x35),(0x0096,0x36),(0x0097,0x08),
    (0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),
    (0x00A0,0x41),(0x00A1,0xAA),(0x00A2,0xB0),(0x00A3,0x5B),(0x00A4,0x9F),(0x00A5,0xB2),(0x00A6,0x6A),(0x00A7,0xB5),
    (0x00A8,0xBD),(0x00A9,0xB4),(0x00AA,0x9A),(0x00AB,0x8A),(0x00AC,0x5F),(0x00AD,0xCA),(0x00AE,0xAF),(0x00B0,0x90),
    (0x00B1,0x8F),(0x00B2,0xEA),(0x00B3,0xFA),(0x00B4,0xBE),(0x00B5,0xA0),(0x00B6,0xB6),(0x00B7,0xB3),(0x00B8,0x9D),
    (0x00B9,0xDA),(0x00BA,0x9B),(0x00BB,0x8B),(0x00BC,0xB7),(0x00BD,0xB8),(0x00BE,0xB9),(0x00BF,0xAB),(0x00C0,0x64),
    (0x00C1,0x65),(0x00C2,0x62),(0x00C3,0x66),(0x00C4,0x63),(0x00C5,0x67),(0x00C6,0x9E),(0x00C7,0x68),(0x00C8,0x74),
    (0x00C9,0x71),(0x00CA,0x72),(0x00CB,0x73),(0x00CC,0x78),(0x00CD,0x75),(0x00CE,0x76),(0x00CF,0x77),(0x00D0,0xAC),
    ...
    (0x00E9,0x51),(0x00EA,0x52),(0x00EB,0x53),(0x00EC,0x58),(0x00ED,0x55),(0x00EE,0x56),(0x00EF,0x57),(0x00F0,0x8C),
    (0x00F1,0x49),(0x00F2,0xCD),(0x00F3,0xCE),(0x00F4,0xCB),(0x00F5,0xCF),(0x00F6,0xCC),(0x00F7,0xE1),(0x00F8,0x70),
    (0x00F9,0xDD),(0x00FA,0xDE),(0x00FB,0xDB),(0x00FC,0xDC),(0x00FD,0x8D),(0x00FE,0x8E),(0x00FF,0xDF),(0x203E,0xA1),
];

const CP297_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    ...
    (0x0030,0xF0),(0x0031,0xF1),(0x0032,0xF2),(0x0033,0xF3),(0x0034,0xF4),(0x0035,0xF5),(0x0036,0xF6),(0x0037,0xF7),
    (0x0038,0xF8),(0x0039,0xF9),(0x003A,0x7A),(0x003B,0x5E),(0x003C,0x4C),(0x003D,0x7E),(0x003E,0x6E),(0x003F,0x6F),
    (0x0040,0x44),(0x0041,0xC1),(0x0042,0xC2),(0x0043,0xC3),(0x0044,0xC4),(0x0045,0xC5),(0x0046,0xC6),(0x0047,0xC7),
    (0x0048,0xC8),(0x0049,0xC9),(0x004A,0xD1),(0x004B,0xD2),(0x004C,0xD3),(0x004D,0xD4),(0x004E,0xD5),(0x004F,0xD6),
    (0x0050,0xD7),(0x0051,0xD8),(0x0052,0xD9),(0x0053,0xE2),(0x0054,0xE3),(0x0055,0xE4),(0x0056,0xE5),(0x0057,0xE6),
    (0x0058,0xE7),(0x0059,0xE8),(0x005A,0xE9),(0x005B,0x90),(0x005C,0x48),(0x005D,0xB5),(0x005E,0x5F),(0x005F,0x6D),
    (0x0060,0xA0),(0x0061,0x81),(0x0062,0x82),(0x0063,0x83),(0x0064,0x84),(0x0065,0x85),(0x0066,0x86),(0x0067,0x87),
    (0x0068,0x88),(0x0069,0x89),(0x006A,0x91),(0x006B,0x92),(0x006C,0x93),(0x006D,0x94),(0x006E,0x95),(0x006F,0x96),
    (0x0070,0x97),(0x0071,0x98),(0x0072,0x99),(0x0073,0xA2),(0x0074,0xA3),(0x0075,0xA4),(0x0076,0xA5),(0x0077,0xA6),
    (0x0078,0xA7),(0x0079,0xA8),(0x007A,0xA9),(0x007B,0x51),(0x007C,0xBB),(0x007D,0x54),(0x007E,0xBD),(0x007F,0x07),
    (0x0080,0x20),(0x0081,0x21),(0x0082,0x22),(0x0083,0x23),(0x0084,0x24),(0x0085,0x15),(0x0086,0x06),(0x0087,0x17),
    (0x0088,0x28),(0x0089,0x29),(0x008A,0x2A),(0x008B,0x2B),(0x008C,0x2C),(0x008D,0x09),(0x008E,0x0A),(0x008F,0x1B),
    (0x0090,0x30),(0x0091,0x31),(0x0092,0x1A),(0x0093,0x33),(0x0094,0x34),(0x0095,0x35),(0x0096,0x36),(0x0097,0x08),
    (0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),
    (0x00A0,0x41),(0x00A1,0xAA),(0x00A2,0xB0),(0x00A3,0x7B),(0x00A4,0x9F),(0x00A5,0xB2),(0x00A6,0xDD),(0x00A7,0x5A),
    (0x00A8,0xA1),(0x00A9,0xB4),(0x00AA,0x9A),(0x00AB,0x8A),(0x00AC,0xBA),(0x00AD,0xCA),(0x00AE,0xAF),(0x00AF,0xBC),
    (0x00B0,0x4A),(0x00B1,0x8F),(0x00B2,0xEA),(0x00B3,0xFA),(0x00B4,0xBE),(0x00B5,0x79),(0x00B6,0xB6),(0x00B7,0xB3),
    (0x00B8,0x9D),(0x00B9,0xDA),(0x00BA,0x9B),(0x00BB,0x8B),(0x00BC,0xB7),(0x00BD,0xB8),(0x00BE,0xB9),(0x00BF,0xAB),
    (0x00C0,0x64),(0x00C1,0x65),(0x00C2,0x62),(0x00C3,0x66),(0x00C4,0x63),(0x00C5,0x67),(0x00C6,0x9E),(0x00C7,0x68),
    (0x00C8,0x74),(0x00C9,0x71),(0x00CA,0x72),(0x00CB,0x73),(0x00CC,0x78),(0x00CD,0x75),(0x00CE,0x76),(0x00CF,0x77),
    (0x00D0,0xAC),(0x00D1,0x69),(0x00D2,0xED),(0x00D3,0xEE),(0x00D4,0xEB),(0x00D5,0xEF),(0x00D6,0xEC),(0x00D7,0xBF),
    (0x00D8,0x80),(0x00D9,0xFD),(0x00DA,0xFE),(0x00DB,0xFB),(0x00DC,0xFC),(0x00DD,0xAD),(0x00DE,0xAE),(0x00DF,0x59),
    (0x00E0,0x7C),(0x00E1,0x45),(0x00E2,0x42),(0x00E3,0x46),(0x00E4,0x43),(0x00E5,0x47),(0x00E6,0x9C),(0x00E7,0xE0),
    (0x00E8,0xD0),(0x00E9,0xC0),(0x00EA,0x52),(0x00EB,0x53),(0x00EC,0x58),(0x00ED,0x55),(0x00EE,0x56),(0x00EF,0x57),
    (0x00F0,0x8C),(0x00F1,0x49),(0x00F2,0xCD),(0x00F3,0xCE),(0x00F4,0xCB),(0x00F5,0xCF),(0x00F6,0xCC),(0x00F7,0xE1),
    (0x00F8,0x70),(0x00F9,0x6A),(0x00FA,0xDE),(0x00FB,0xDB),(0x00FC,0xDC),(0x00FD,0x8D),(0x00FE,0x8E),(0x00FF,0xDF),
];

const CP871_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    ...
    (0x0030,0xF0),(0x0031,0xF1),(0x0032,0xF2),(0x0033,0xF3),(0x0034,0xF4),(0x0035,0xF5),(0x0036,0xF6),(0x0037,0xF7),
    (0x0038,0xF8),(0x0039,0xF9),(0x003A,0x7A),(0x003B,0x5E),(0x003C,0x4C),(0x003D,0x7E),(0x003E,0x6E),(0x003F,0x6F),
    (0x0040,0xAC),(0x0041,0xC1),(0x0042,0xC2),(0x0043,0xC3),(0x0044,0xC4),(0x0045,0xC5),(0x0046,0xC6),(0x0047,0xC7),
    (0x0048,0xC8),(0x0049,0xC9),(0x004A,0xD1),(0x004B,0xD2),(0x004C,0xD3),(0x004D,0xD4),(0x004E,0xD5),(0x004F,0xD6),
    (0x0050,0xD7),(0x0051,0xD8),(0x0052,0xD9),(0x0053,0xE2),(0x0054,0xE3),(0x0055,0xE4),(0x0056,0xE5),(0x0057,0xE6),
    (0x0058,0xE7),(0x0059,0xE8),(0x005A,0xE9),(0x005B,0xAE),(0x005C,0xBE),(0x005D,0x9E),(0x005E,0xEC),(0x005F,0x6D),
    (0x0060,0x8C),(0x0061,0x81),(0x0062,0x82),(0x0063,0x83),(0x0064,0x84),(0x0065,0x85),(0x0066,0x86),(0x0067,0x87),
    (0x0068,0x88),(0x0069,0x89),(0x006A,0x91),(0x006B,0x92),(0x006C,0x93),(0x006D,0x94),(0x006E,0x95),(0x006F,0x96),
    (0x0070,0x97),(0x0071,0x98),(0x0072,0x99),(0x0073,0xA2),(0x0074,0xA3),(0x0075,0xA4),(0x0076,0xA5),(0x0077,0xA6),
    (0x0078,0xA7),(0x0079,0xA8),(0x007A,0xA9),(0x007B,0x8E),(0x007C,0xBB),(0x007D,0x9C),(0x007E,0xCC),(0x007F,0x07),
    (0x0080,0x20),(0x0081,0x21),(0x0082,0x22),(0x0083,0x23),(0x0084,0x24),(0x0085,0x15),(0x0086,0x06),(0x0087,0x17),
    (0x0088,0x28),(0x0089,0x29),(0x008A,0x2A),(0x008B,0x2B),(0x008C,0x2C),(0x008D,0x09),(0x008E,0x0A),(0x008F,0x1B),
    (0x0090,0x30),(0x0091,0x31),(0x0092,0x1A),(0x0093,0x33),(0x0094,0x34),(0x0095,0x35),(0x0096,0x36),(0x0097,0x08),
    (0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),
    (0x00A0,0x41),(0x00A1,0xAA),(0x00A2,0xB0),(0x00A3,0xB1),(0x00A4,0x9F),(0x00A5,0xB2),(0x00A6,0x6A),(0x00A7,0xB5),
    (0x00A8,0xBD),(0x00A9,0xB4),(0x00AA,0x9A),(0x00AB,0x8A),(0x00AC,0xBA),(0x00AD,0xCA),(0x00AE,0xAF),(0x00AF,0xBC),
    (0x00B0,0x90),(0x00B1,0x8F),(0x00B2,0xEA),(0x00B3,0xFA),(0x00B4,0xE0),(0x00B5,0xA0),(0x00B6,0xB6),(0x00B7,0xB3),
    (0x00B8,0x9D),(0x00B9,0xDA),(0x00BA,0x9B),(0x00BB,0x8B),(0x00BC,0xB7),(0x00BD,0xB8),(0x00BE,0xB9),(0x00BF,0xAB),
    (0x00C0,0x64),(0x00C1,0x65),(0x00C2,0x62),(0x00C3,0x66),(0x00C4,0x63),(0x00C5,0x67),(0x00C6,0x5A),(0x00C7,0x68),
    (0x00C8,0x74),(0x00C9,0x71),(0x00CA,0x72),(0x00CB,0x73),(0x00CC,0x78),(0x00CD,0x75),(0x00CE,0x76),(0x00CF,0x77),
    (0x00D0,0x7C),(0x00D1,0x69),(0x00D2,0xED),(0x00D3,0xEE),(0x00D4,0xEB),(0x00D5,0xEF),(0x00D6,0x5F),(0x00D7,0xBF),
    (0x00D8,0x80),(0x00D9,0xFD),(0x00DA,0xFE),(0x00DB,0xFB),(0x00DC,0xFC),(0x00DD,0xAD),(0x00DE,0xC0),(0x00DF,0x59),
    (0x00E0,0x44),(0x00E1,0x45),(0x00E2,0x42),(0x00E3,0x46),(0x00E4,0x43),(0x00E5,0x47),(0x00E6,0xD0),(0x00E7,0x48),
    (0x00E8,0x54),(0x00E9,0x51),(0x00EA,0x52),(0x00EB,0x53),(0x00EC,0x58),(0x00ED,0x55),(0x00EE,0x56),(0x00EF,0x57),
    (0x00F0,0x79),(0x00F1,0x49),(0x00F2,0xCD),(0x00F3,0xCE),(0x00F4,0xCB),(0x00F5,0xCF),(0x00F6,0xA1),(0x00F7,0xE1),
    (0x00F8,0x70),(0x00F9,0xDD),(0x00FA,0xDE),(0x00FB,0xDB),(0x00FC,0xDC),(0x00FD,0x8D),(0x00FE,0x4A),(0x00FF,0xDF),
];

const CP870_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    ...
    (0x0068,0x88),(0x0069,0x89),(0x006A,0x91),(0x006B,0x92),(0x006C,0x93),(0x006D,0x94),(0x006E,0x95),(0x006F,0x96),
    (0x0070,0x97),(0x0071,0x98),(0x0072,0x99),(0x0073,0xA2),(0x0074,0xA3),(0x0075,0xA4),(0x0076,0xA5),(0x0077,0xA6),
    (0x0078,0xA7),(0x0079,0xA8),(0x007A,0xA9),(0x007B,0xC0),(0x007C,0x6A),(0x007D,0xD0),(0x007E,0xA1),(0x007F,0x07),
    (0x0080,0x20),(0x0081,0x21),(0x0082,0x22),(0x0083,0x23),(0x0084,0x24),(0x0085,0x15),(0x0086,0x06),(0x0087,0x17),
    (0x0088,0x28),(0x0089,0x29),(0x008A,0x2A),(0x008B,0x2B),(0x008C,0x2C),(0x008D,0x09),(0x008E,0x0A),(0x008F,0x1B),
    (0x0090,0x30),(0x0091,0x31),(0x0092,0x1A),(0x0093,0x33),(0x0094,0x34),(0x0095,0x35),(0x0096,0x36),(0x0097,0x08),
    (0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),
    (0x00A0,0x41),(0x00A4,0x9F),(0x00A7,0xB5),(0x00A8,0xBD),(0x00AD,0xCA),(0x00B0,0x90),(0x00B4,0xBE),(0x00B7,0xB0),
    (0x00B8,0x9D),(0x00C1,0x65),(0x00C2,0x62),(0x00C4,0x63),(0x00C7,0x68),(0x00C9,0x71),(0x00CB,0x73),(0x00CD,0x75),
    (0x00CE,0x76),(0x00D3,0xEE),(0x00D4,0xEB),(0x00D6,0xEC),(0x00D7,0xBF),(0x00DA,0xFE),(0x00DC,0xFC),(0x00DD,0xAD),
    (0x00DF,0x59),(0x00E1,0x45),(0x00E2,0x42),(0x00E4,0x43),(0x00E7,0x48),(0x00E9,0x51),(0x00EB,0x53),(0x00ED,0x55),
    (0x00EE,0x56),(0x00F3,0xCE),(0x00F4,0xCB),(0x00F6,0xCC),(0x00F7,0xE1),(0x00FA,0xDE),(0x00FC,0xDC),(0x00FD,0x8D),
    (0x0102,0x66),(0x0103,0x46),(0x0104,0xB1),(0x0105,0xA0),(0x0106,0x69),(0x0107,0x49),(0x010C,0x67),(0x010D,0x47),
    (0x010E,0xFA),(0x010F,0xEA),(0x0110,0xAC),(0x0111,0x8C),(0x0118,0x72),(0x0119,0x52),(0x011A,0xDA),(0x011B,0xDF),
    (0x0139,0x78),(0x013A,0x58),(0x013D,0x77),(0x013E,0x57),(0x0141,0xBA),(0x0142,0x9A),(0x0143,0xBB),(0x0144,0x9B),
    (0x0147,0xAB),(0x0148,0x8B),(0x0150,0xEF),(0x0151,0xCF),(0x0154,0xED),(0x0155,0xCD),(0x0158,0xAE),(0x0159,0x8E),
    (0x015A,0xAA),(0x015B,0x8A),(0x015E,0xAF),(0x015F,0x8F),(0x0160,0xBC),(0x0161,0x9C),(0x0162,0xB3),(0x0163,0x44),
    (0x0164,0xFD),(0x0165,0xDD),(0x016E,0x74),(0x016F,0x54),(0x0170,0xFB),(0x0171,0xDB),(0x0179,0xB9),(0x017A,0xB7),
    (0x017B,0xB4),(0x017C,0xB2),(0x017D,0xB8),(0x017E,0xB6),(0x02C7,0x70),(0x02D8,0x80),(0x02DB,0x9E),(0x02DD,0x64),
];

const CP875_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    ...
    (0x0068,0x88),(0x0069,0x89),(0x006A,0x91),(0x006B,0x92),(0x006C,0x93),(0x006D,0x94),(0x006E,0x95),(0x006F,0x96),
    (0x0070,0x97),(0x0071,0x98),(0x0072,0x99),(0x0073,0xA2),(0x0074,0xA3),(0x0075,0xA4),(0x0076,0xA5),(0x0077,0xA6),
    (0x0078,0xA7),(0x0079,0xA8),(0x007A,0xA9),(0x007B,0xC0),(0x007D,0xD0),(0x007E,0xA1),(0x007F,0x07),(0x0080,0x20),
    (0x0081,0x21),(0x0082,0x22),(0x0083,0x23),(0x0084,0x24),(0x0085,0x15),(0x0086,0x06),(0x0087,0x17),(0x0088,0x28),
    (0x0089,0x29),(0x008A,0x2A),(0x008B,0x2B),(0x008C,0x2C),(0x008D,0x09),(0x008E,0x0A),(0x008F,0x1B),(0x0090,0x30),
    (0x0091,0x31),(0x0092,0x1A),(0x0093,0x33),(0x0094,0x34),(0x0095,0x35),(0x0096,0x36),(0x0097,0x08),(0x0098,0x38),
    (0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),(0x00A3,0xB0),
    (0x00A6,0xDF),(0x00A7,0xEB),(0x00A8,0x70),(0x00A9,0xFB),(0x00AB,0xEE),(0x00AC,0xEF),(0x00AD,0xCA),(0x00B0,0x90),
    (0x00B1,0xDA),(0x00B2,0xEA),(0x00B3,0xFA),(0x00B4,0xA0),(0x00B7,0xDD),(0x00BB,0xFE),(0x00BD,0xDB),(0x0385,0x80),
    (0x0386,0x71),(0x0388,0x72),(0x0389,0x73),(0x038A,0x75),(0x038C,0x76),(0x038E,0x77),(0x038F,0x78),(0x0390,0xCC),
    (0x0391,0x41),(0x0392,0x42),(0x0393,0x43),(0x0394,0x44),(0x0395,0x45),(0x0396,0x46),(0x0397,0x47),(0x0398,0x48),
    (0x0399,0x49),(0x039A,0x51),(0x039B,0x52),(0x039C,0x53),(0x039D,0x54),(0x039E,0x55),(0x039F,0x56),(0x03A0,0x57),
    (0x03A1,0x58),(0x03A3,0x59),(0x03A4,0x62),(0x03A5,0x63),(0x03A6,0x64),(0x03A7,0x65),(0x03A8,0x66),(0x03A9,0x67),
    (0x03AA,0x68),(0x03AB,0x69),(0x03AC,0xB1),(0x03AD,0xB2),(0x03AE,0xB3),(0x03AF,0xB5),(0x03B0,0xCD),(0x03B1,0x8A),
    (0x03B2,0x8B),(0x03B3,0x8C),(0x03B4,0x8D),(0x03B5,0x8E),(0x03B6,0x8F),(0x03B7,0x9A),(0x03B8,0x9B),(0x03B9,0x9C),
    (0x03BA,0x9D),(0x03BB,0x9E),(0x03BC,0x9F),(0x03BD,0xAA),(0x03BE,0xAB),(0x03BF,0xAC),(0x03C0,0xAD),(0x03C1,0xAE),
    (0x03C2,0xBA),(0x03C3,0xAF),(0x03C4,0xBB),(0x03C5,0xBC),(0x03C6,0xBD),(0x03C7,0xBE),(0x03C8,0xBF),(0x03C9,0xCB),
    (0x03CA,0xB4),(0x03CB,0xB8),(0x03CC,0xB6),(0x03CD,0xB7),(0x03CE,0xB9),(0x2015,0xCF),(0x2018,0xCE),(0x2019,0xDE),
    (0x2207,0x74),
];

const EBCDIC_CP_DK_ENC: &[(u16, u8)] = &[
    (0x0000,0x00),(0x0001,0x01),(0x0002,0x02),(0x0003,0x03),(0x0004,0x37),(0x0005,0x2D),(0x0006,0x2E),(0x0007,0x2F),
    (0x0008,0x16),(0x0009,0x05),(0x000A,0x25),(0x000B,0x0B),(0x000C,0x0C),(0x000D,0x0D),(0x000E,0x0E),(0x000F,0x0F),
    (0x0010,0x10),(0x0011,0x11),(0x0012,0x12),(0x0013,0x13),(0x0014,0x3C),(0x0015,0x3D),(0x0016,0x32),(0x0017,0x26),
    (0x0018,0x18),(0x0019,0x19),(0x001A,0x3F),(0x001B,0x27),(0x001C,0x1C),(0x001D,0x1D),(0x001E,0x1E),(0x001F,0x1F),
    (0x0020,0x40),(0x0021,0x4F),(0x0022,0x7F),(0x0023,0x4A),(0x0024,0x67),(0x0025,0x6C),(0x0026,0x50),(0x0027,0x7D),
    (0x0028,0x4D),(0x0029,0x5D),(0x002A,0x5C),(0x002B,0x4E),(0x002C,0x6B),(0x002D,0x60),(0x002E,0x4B),(0x002F,0x61),
    (0x0030,0xF0),(0x0031,0xF1),(0x0032,0xF2),(0x0033,0xF3),(0x0034,0xF4),(0x0035,0xF5),(0x0036,0xF6),(0x0037,0xF7),
    (0x0038,0xF8),(0x0039,0xF9),(0x003A,0x7A),(0x003B,0x5E),(0x003C,0x4C),(0x003D,0x7E),(0x003E,0x6E),(0x003F,0x6F),
    (0x0040,0x80),(0x0041,0xC1),(0x0042,0xC2),(0x0043,0xC3),(0x0044,0xC4),(0x0045,0xC5),(0x0046,0xC6),(0x0047,0xC7),
    (0x0048,0xC8),(0x0049,0xC9),(0x004A,0xD1),(0x004B,0xD2),(0x004C,0xD3),(0x004D,0xD4),(0x004E,0xD5),(0x004F,0xD6),
    (0x0050,0xD7),(0x0051,0xD8),(0x0052,0xD9),(0x0053,0xE2),(0x0054,0xE3),(0x0055,0xE4),(0x0056,0xE5),(0x0057,0xE6),
    (0x0058,0xE7),(0x0059,0xE8),(0x005A,0xE9),(0x005B,0x9E),(0x005C,0xE0),(0x005D,0x9F),(0x005E,0x5F),(0x005F,0x6D),
    (0x0060,0x79),(0x0061,0x81),(0x0062,0x82),(0x0063,0x83),(0x0064,0x84),(0x0065,0x85),(0x0066,0x86),(0x0067,0x87),
    (0x0068,0x88),(0x0069,0x89),(0x006A,0x91),(0x006B,0x92),(0x006C,0x93),(0x006D,0x94),(0x006E,0x95),(0x006F,0x96),
    (0x0070,0x97),(0x0071,0x98),(0x0072,0x99),(0x0073,0xA2),(0x0074,0xA3),(0x0075,0xA4),(0x0076,0xA5),(0x0077,0xA6),
    (0x0078,0xA7),(0x0079,0xA8),(0x007A,0xA9),(0x007B,0x9C),(0x007C,0xBB),(0x007D,0x47),(0x007E,0xDC),(0x007F,0x07),
    (0x0080,0x20),(0x0081,0x21),(0x0082,0x22),(0x0083,0x23),(0x0084,0x24),(0x0085,0x15),(0x0086,0x06),(0x0087,0x17),
    (0x0088,0x28),(0x0089,0x29),(0x008A,0x2A),(0x008B,0x2B),(0x008C,0x2C),(0x008D,0x09),(0x008E,0x0A),(0x008F,0x1B),
    (0x0090,0x30),(0x0091,0x31),(0x0092,0x1A),(0x0093,0x33),(0x0094,0x34),(0x0095,0x35),(0x0096,0x36),(0x0097,0x08),
    (0x0098,0x38),(0x0099,0x39),(0x009A,0x3A),(0x009B,0x3B),(0x009C,0x04),(0x009D,0x14),(0x009E,0x3E),(0x009F,0xFF),
    (0x00A0,0x41),(0x00A1,0xAA),(0x00A2,0xB0),(0x00A3,0xB1),(0x00A4,0x5A),(0x00A5,0xB2),(0x00A6,0x70),(0x00A7,0xB5),
    (0x00A8,0xBD),(0x00A9,0xB4),(0x00AA,0x9A),(0x00AB,0x8A),(0x00AC,0xBA),(0x00AD,0xCA),(0x00AE,0xAF),(0x00AF,0xBC),
    (0x00B0,0x90),(0x00B1,0x8F),(0x00B2,0xEA),(0x00B3,0xFA),(0x00B4,0xBE),(0x00B5,0xA0),(0x00B6,0xB6),(0x00B7,0xB3),
    (0x00B8,0x9D),(0x00B9,0xDA),(0x00BA,0x9B),(0x00BB,0x8B),(0x00BC,0xB7),(0x00BD,0xB8),(0x00BE,0xB9),(0x00BF,0xAB),
    (0x00C0,0x64),(0x00C1,0x65),(0x00C2,0x62),(0x00C3,0x66),(0x00C4,0x63),(0x00C5,0x5B),(0x00C6,0x7B),(0x00C7,0x68),
    (0x00C8,0x74),(0x00C9,0x71),(0x00CA,0x72),(0x00CB,0x73),(0x00CC,0x78),(0x00CD,0x75),(0x00CE,0x76),(0x00CF,0x77),
    (0x00D0,0xAC),(0x00D1,0x69),(0x00D2,0xED),(0x00D3,0xEE),(0x00D4,0xEB),(0x00D5,0xEF),(0x00D6,0xEC),(0x00D7,0xBF),
    (0x00D8,0x7C),(0x00D9,0xFD),(0x00DA,0xFE),(0x00DB,0xFB),(0x00DC,0xFC),(0x00DD,0xAD),(0x00DE,0xAE),(0x00DF,0x59),
    (0x00E0,0x44),(0x00E1,0x45),(0x00E2,0x42),(0x00E3,0x46),(0x00E4,0x43),(0x00E5,0xD0),(0x00E6,0xC0),(0x00E7,0x48),
    (0x00E8,0x54),(0x00E9,0x51),(0x00EA,0x52),(0x00EB,0x53),(0x00EC,0x58),(0x00ED,0x55),(0x00EE,0x56),(0x00EF,0x57),
    (0x00F0,0x8C),(0x00F1,0x49),(0x00F2,0xCD),(0x00F3,0xCE),(0x00F4,0xCB),(0x00F5,0xCF),(0x00F6,0xCC),(0x00F7,0xE1),
    (0x00F8,0x6A),(0x00F9,0xDD),(0x00FA,0xDE),(0x00FB,0xDB),(0x00FC,0xA1),(0x00FD,0x8D),(0x00FE,0x8E),(0x00FF,0xDF),
];
...
fn decode_ibm943(input: &[u8]) -> Result<(char, usize), DecodeError> {
    ...
    decode_dbcs2(
        ...
        &ibm943_tables::IBM943_IS_LEAD,
        direct,
    )
}

fn encode_ibm943(ch: char, out: &mut [u8]) -> Result<usize, EncodeError> {
    static DIRECT: std::sync::OnceLock<Vec<u32>> = std::sync::OnceLock::new();
    let direct = DIRECT.get_or_init(|| build_enc_direct(&ibm943_tables::IBM943_ENC));
    encode_dbcs2(ch, out, direct)
}
...
fn decode_char(enc: Encoding, input: &[u8]) -> Result<(char, usize), DecodeError> {
    match enc {
        ...
        Encoding::Gost1976874 => decode_gost_19768_74(input),
        Encoding::Iso10367Box => decode_sbcs128(input, &ISO_10367_BOX_TO_UNICODE),
        Encoding::IecP271 => decode_sbcs128(input, &IEC_P27_1_TO_UNICODE),
        Encoding::WinSami2 => decode_sbcs128(input, &WIN_SAMI_2_TO_UNICODE),
        Encoding::IsoIr209 => decode_sbcs128(input, &ISO_IR_209_TO_UNICODE),
        Encoding::MacIs => decode_sbcs128(input, &MAC_IS_TO_UNICODE),
        Encoding::MacUk => decode_sbcs128(input, &MAC_UK_TO_UNICODE),
        Encoding::MsMacCyrillic => decode_sbcs128(input, &MS_MAC_CYRILLIC_TO_UNICODE),
        Encoding::Cp904 => decode_sbcs128(input, &CP904_TO_UNICODE),
        Encoding::Cp922 => decode_sbcs128(input, &CP922_TO_UNICODE),
        Encoding::Cp4909 => decode_sbcs128(input, &CP4909_TO_UNICODE),
        Encoding::Cp5347 => decode_sbcs128(input, &CP5347_TO_UNICODE),
        Encoding::Cp037 => decode_sbcs_full(input, &CP037_TO_UNICODE),
        Encoding::Cp500 => decode_sbcs_full(input, &CP500_TO_UNICODE),
        Encoding::Cp1047 => decode_sbcs_full(input, &CP1047_TO_UNICODE),
        Encoding::Cp1140 => decode_sbcs_full(input, &CP1140_TO_UNICODE),
        Encoding::Cp273 => decode_sbcs_full(input, &CP273_TO_UNICODE),
        Encoding::Cp278 => decode_sbcs_full(input, &CP278_TO_UNICODE),
        Encoding::Cp280 => decode_sbcs_full(input, &CP280_TO_UNICODE),
        Encoding::Cp284 => decode_sbcs_full(input, &CP284_TO_UNICODE),
        Encoding::Cp285 => decode_sbcs_full(input, &CP285_TO_UNICODE),
        Encoding::Cp297 => decode_sbcs_full(input, &CP297_TO_UNICODE),
        Encoding::Cp871 => decode_sbcs_full(input, &CP871_TO_UNICODE),
        Encoding::Cp870 => decode_sbcs_full(input, &CP870_TO_UNICODE),
        Encoding::Cp875 => decode_sbcs_full(input, &CP875_TO_UNICODE),
        Encoding::EbcdicCpDk => decode_sbcs_full(input, &EBCDIC_CP_DK_TO_UNICODE),
...
fn encode_char(enc: Encoding, ch: char, out: &mut [u8]) -> Result<usize, EncodeError> {
    match enc {
        ...
        Encoding::Gost1976874 => encode_gost_19768_74(ch, out),
        Encoding::Iso10367Box => encode_sbcs128(ch, out, &ISO_10367_BOX_TO_UNICODE),
        Encoding::IecP271 => encode_sbcs128(ch, out, &IEC_P27_1_TO_UNICODE),
        Encoding::WinSami2 => encode_sbcs128(ch, out, &WIN_SAMI_2_TO_UNICODE),
        Encoding::IsoIr209 => encode_sbcs128(ch, out, &ISO_IR_209_TO_UNICODE),
        Encoding::MacIs => encode_sbcs128(ch, out, &MAC_IS_TO_UNICODE),
        Encoding::MacUk => encode_sbcs128(ch, out, &MAC_UK_TO_UNICODE),
        Encoding::MsMacCyrillic => encode_sbcs128(ch, out, &MS_MAC_CYRILLIC_TO_UNICODE),
        Encoding::Cp904 => encode_sbcs128(ch, out, &CP904_TO_UNICODE),
        Encoding::Cp922 => encode_sbcs128(ch, out, &CP922_TO_UNICODE),
        Encoding::Cp4909 => encode_sbcs128(ch, out, &CP4909_TO_UNICODE),
        Encoding::Cp5347 => encode_sbcs128(ch, out, &CP5347_TO_UNICODE),
        Encoding::Cp037 => encode_sbcs_full(ch, out, CP037_ENC),
        Encoding::Cp500 => encode_sbcs_full(ch, out, CP500_ENC),
        Encoding::Cp1047 => encode_sbcs_full(ch, out, CP1047_ENC),
        Encoding::Cp1140 => encode_sbcs_full(ch, out, CP1140_ENC),
        Encoding::Cp273 => encode_sbcs_full(ch, out, CP273_ENC),
        Encoding::Cp278 => encode_sbcs_full(ch, out, CP278_ENC),
        Encoding::Cp280 => encode_sbcs_full(ch, out, CP280_ENC),
        Encoding::Cp284 => encode_sbcs_full(ch, out, CP284_ENC),
        Encoding::Cp285 => encode_sbcs_full(ch, out, CP285_ENC),
        Encoding::Cp297 => encode_sbcs_full(ch, out, CP297_ENC),
        Encoding::Cp871 => encode_sbcs_full(ch, out, CP871_ENC),
        Encoding::Cp870 => encode_sbcs_full(ch, out, CP870_ENC),
        Encoding::Cp875 => encode_sbcs_full(ch, out, CP875_ENC),
        Encoding::EbcdicCpDk => encode_sbcs_full(ch, out, EBCDIC_CP_DK_ENC),
