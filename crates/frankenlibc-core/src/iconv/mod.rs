...
const PHASE1_CODEC_TABLE: [CodecSpec; 129] = [
    ...
    CodecSpec {
        ...
        normalized: "ISO88592",
        aliases: &["ISO88592", "LATIN2", "CSISOLATIN2", "CP912", "IBM912", "8859_2", "ISOIR101"],
    },
    CodecSpec {
        encoding: Encoding::Iso88593,
        canonical: "ISO-8859-3",
        normalized: "ISO88593",
        aliases: &["ISO88593", "LATIN3", "CSISOLATIN3", "CP913", "IBM913", "8859_3", "ISOIR109"],
    },
    CodecSpec {
        encoding: Encoding::Iso88594,
        canonical: "ISO-8859-4",
        normalized: "ISO88594",
        aliases: &["ISO88594", "LATIN4", "CSISOLATIN4", "BALTIC", "CP914", "IBM914", "8859_4", "ISOIR110"],
    },
    CodecSpec {
        encoding: Encoding::Iso88595,
        canonical: "ISO-8859-5",
        normalized: "ISO88595",
        aliases: &["ISO88595", "CYRILLIC", "CSISOLATINCYRILLIC", "CP915", "IBM915", "8859_5", "ISOIR144"],
    },
    CodecSpec {
        encoding: Encoding::Iso88596,
        canonical: "ISO-8859-6",
        normalized: "ISO88596",
        aliases: &["ISO88596", "ARABIC", "CSISOLATINARABIC", "ASMO708", "ECMA114", "CP1089", "IBM1089", "8859_6", "ISOIR127"],
    },
    CodecSpec {
        encoding: Encoding::Iso88597,
        canonical: "ISO-8859-7",
        normalized: "ISO88597",
        aliases: &["ISO88597", "GREEK", "GREEK8", "CSISOLATINGREEK", "ELOT928", "ECMA118", "8859_7", "ISOIR126"],
    },
    CodecSpec {
        encoding: Encoding::Iso88598,
        canonical: "ISO-8859-8",
        normalized: "ISO88598",
        aliases: &["ISO88598", "HEBREW", "CSISOLATINHEBREW", "8859_8", "ISOIR138"],
    },
    CodecSpec {
    ...
    CodecSpec {
        ...
        aliases: &["ISO885913", "LATIN7", "CSISOLATIN7", "BALTICRIM", "ISOIR179"],
    },
    CodecSpec {
        encoding: Encoding::Iso885914,
        canonical: "ISO-8859-14",
        normalized: "ISO885914",
        aliases: &["ISO885914", "LATIN8", "CSISOLATIN8", "CELTIC", "ISOCELTIC", "ISOIR199"],
    },
    CodecSpec {
    ...
    CodecSpec {
        ...
        aliases: &["ISO885916", "LATIN10", "CSISOLATIN10", "ROMANIAN", "ISOIR226"],
    },
    CodecSpec {
...
const GEORGIAN_PS_TO_UNICODE: [u16; 128] = [
    ...
    0x10D7, 0x10D8, 0x10D9, 0x10DA, 0x10DB, 0x10DC, 0x10F2, 0x10DD, // C8-CF (თ-ნ, ჲ, ო)
    0x10DE, 0x10DF, 0x10E0, 0x10E1, 0x10E2, 0x10F3, 0x10E3, 0x10E4, // D0-D7 (პ-ტ, ჳ, უ-ფ)
    0x10E5, 0x10E6, 0x10E7, 0x10E8, 0x10E9, 0x10EA, 0x10EB, 0x10EC, // D8-DF (ქ-წ)
    0x10ED, 0x10EE, 0x10F4, 0x10EF, 0x10F0, 0x10F5, 0x00E6, 0x00E7, // E0-E7 (ჭ-ხ, ჴ, ჯ-ჰ, ჵ, æç)
    0x00E8, 0x00E9, 0x00EA, 0x00EB, 0x00EC, 0x00ED, 0x00EE, 0x00EF, // E8-EF (è-ï)
    0x00F0, 0x00F1, 0x00F2, 0x00F3, 0x00F4, 0x00F5, 0x00F6, 0x00F7, // F0-F7 (ð-÷)
    0x00F8, 0x00F9, 0x00FA, 0x00FB, 0x00FC, 0x00FD, 0x00FE, 0x00FF, // F8-FF (ø-ÿ)
];
...
const MACICELAND_TO_UNICODE: [u16; 128] = [
    ...
    0x00F2, 0x00F4, 0x00F6, 0x00F5, 0x00FA, 0x00F9, 0x00FB, 0x00FC, // 98-9F (ò,ô,ö,õ,ú,ù,û,ü)
    // 0xA0-0xAF
    0x00DD, 0x00B0, 0x00A2, 0x00A3, 0x00A7, 0x2022, 0x00B6, 0x00DF, // A0-A7 (Ý,°,¢,£,§,•,¶,ß)
    0x00AE, 0x00A9, 0x2122, 0x00B4, 0x00A8, 0x2260, 0x00C6, 0x00D8, // A8-AF (®,©,™,´,¨,≠,Æ,Ø)
    // 0xB0-0xBF
    0x221E, 0x00B1, 0x2264, 0x2265, 0x00A5, 0x00B5, 0x2202, 0x2211, // B0-B7 (∞,±,≤,≥,¥,µ,∂,∑)
    0x220F, 0x03C0, 0x222B, 0x00AA, 0x00BA, 0x03A9, 0x00E6, 0x00F8, // B8-BF (∏,π,∫,ª,º,Ω,æ,ø)
    ...
    // 0xD0-0xDF
    0x2013, 0x2014, 0x201C, 0x201D, 0x2018, 0x2019, 0x00F7, 0x25CA, // D0-D7 (–,—,",",',',÷,◊)
    0x00FF, 0x0178, 0x2044, 0x00A4, 0x00D0, 0x00F0, 0x00DE, 0x00FE, // D8-DF (ÿ,Ÿ,⁄,¤,Ð,ð,Þ,þ)
    // 0xE0-0xEF
    0x00FD, 0x00B7, 0x201A, 0x201E, 0x2030, 0x00C2, 0x00CA, 0x00C1, // E0-E7 (ý,·,‚,„,‰,Â,Ê,Á)
    0x00CB, 0x00C8, 0x00CD, 0x00CE, 0x00CF, 0x00CC, 0x00D3, 0x00D4, // E8-EF (Ë,È,Í,Î,Ï,Ì,Ó,Ô)
    // 0xF0-0xFF
...
const MACROMANIAN_TO_UNICODE: [u16; 128] = [
    ...
    // 0xA0-0xAF
    0x2020, 0x00B0, 0x00A2, 0x00A3, 0x00A7, 0x2022, 0x00B6, 0x00DF, // A0-A7 (†,°,¢,£,§,•,¶,ß)
    0x00AE, 0x00A9, 0x2122, 0x00B4, 0x00A8, 0x2260, 0x0102, 0x0218, // A8-AF (®,©,™,´,¨,≠,Ă,Ș)
    // 0xB0-0xBF
    0x221E, 0x00B1, 0x2264, 0x2265, 0x00A5, 0x00B5, 0x2202, 0x2211, // B0-B7 (∞,±,≤,≥,¥,µ,∂,∑)
    0x220F, 0x03C0, 0x222B, 0x00AA, 0x00BA, 0x03A9, 0x0103, 0x0219, // B8-BF (∏,π,∫,ª,º,Ω,ă,ș)
    // 0xC0-0xCF
    0x00BF, 0x00A1, 0x00AC, 0x221A, 0x0192, 0x2248, 0x2206, 0x00AB, // C0-C7 (¿,¡,¬,√,ƒ,≈,∆,«)
    0x00BB, 0x2026, 0x00A0, 0x00C0, 0x00C3, 0x00D5, 0x0152, 0x0153, // C8-CF (»,…,NBSP,À,Ã,Õ,Œ,œ)
    // 0xD0-0xDF
    0x2013, 0x2014, 0x201C, 0x201D, 0x2018, 0x2019, 0x00F7, 0x25CA, // D0-D7 (–,—,",",',',÷,◊)
    0x00FF, 0x0178, 0x2044, 0x00A4, 0x021A, 0x021B, 0x2039, 0x203A, // D8-DF (ÿ,Ÿ,⁄,¤,Ț,ț,‹,›)
    // 0xE0-0xEF
    0x2021, 0x00B7, 0x201A, 0x201E, 0x2030, 0x00C2, 0x00CA, 0x00C1, // E0-E7 (‡,·,‚,„,‰,Â,Ê,Á)
    0x00CB, 0x00C8, 0x00CD, 0x00CE, 0x00CF, 0x00CC, 0x00D3, 0x00D4, // E8-EF (Ë,È,Í,Î,Ï,Ì,Ó,Ô)
    // 0xF0-0xFF
