...
| R9 | Six-class ledger resurrection audit | bd-3ollh0 | 130 screened sections, all hand-read | 47 classifiable experiments: VALID-PROFILE 0, VALID-MECHANISM 1, VALID-AB 9, VOID-CV 8, VOID-ZEROSELF 0, VOID-NONULL 29; 29 non-experiments and 54 triage-unresolved. Of the 37 VOID rows, 29 (78.4%) are VOID-NONULL. 13/130 contain any 64-hex digest, but only one explicitly self-reports the executing ELF. | Top five by target-frame self-time are L17797 (99.56%), L17758 (98.83%), L17903 (96.67%), L18455 (20.23%), and L18406 (19.75%); all are one allocator family superseded by later corrected evidence. See `LEDGER_RESURRECTION.md`. |
