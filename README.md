...
Canonical checked smoke artifact: `tests/conformance/ld_preload_smoke_summary.v1.json` (run `rc0923-corpus-20260924T170521Z`, checked September 24, 2026) reports 186 passes / 0 fails / 4 skips overall, with strict 93/0/2 and hardened 93/0/2 across the curated preload smoke battery.
...
- The preload smoke battery currently has 186 pass / 0 fail / 4 optional skips across strict and hardened modes; see `docs/planning/COMPATIBILITY.md` for workload status details.
...
| Curated `LD_PRELOAD` smoke battery | 186 pass / 0 fail / 4 optional skip; strict and hardened green |
