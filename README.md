...
- The preload smoke battery currently has 162 pass / 0 fail / 4 optional skips plus 2 tracked xfail across strict and hardened modes; see `docs/planning/COMPATIBILITY.md` for workload status details.
...
| Curated `LD_PRELOAD` smoke battery | 162 pass / 0 fail / 4 optional skip + 2 tracked xfail; both modes red on that one case |
