...
Reality snapshot: total_exported=323, implemented=202, raw_syscall=113, glibc_call_through=8, stub=0.
...
|---|---:|---:|---|
| `Implemented` | 202 | 63% | Native Rust implementation owns behavior |
| `RawSyscall` | 113 | 35% | ABI entrypoint marshals directly to Linux syscalls |
| `GlibcCallThrough` | 8 | 2% | Delegates to host glibc after membrane checks |
| `Stub` | 0 | 0% | Deterministic fallback contract (documented) |

Total currently classified exports: **323**.
