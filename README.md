...
Canonical checked smoke artifact: `tests/conformance/ld_preload_smoke_summary.v1.json` (run `rc0923-corpus-20260924T045148Z`, checked September 24, 2026) reports 115 passes / 0 fails / 4 skips overall, with strict 58/0/2 and hardened 57/0/2 across the curated preload smoke battery. One further hardened case, `sed_substitute`, is a tracked known failure (xfail, `bd-rc0923-epic-eeuy4f.20`): hardened mode corrupts GNU sed output whenever a regex is used.
...
- The preload smoke battery currently has 115 pass / 0 fail / 4 optional skips plus 1 tracked hardened xfail across strict and hardened modes; see `docs/planning/COMPATIBILITY.md` for workload status details.
...
| Curated `LD_PRELOAD` smoke battery | 115 pass / 0 fail / 4 optional skip + 1 tracked hardened xfail; strict green, hardened red on that xfail |
