...
Source of truth: `tests/conformance/reality_report.v1.json` (generated `2026-02-11T19:17:31Z`).
...
|---|---:|---:|---|
| `Implemented` | 118 | 47% | Native Rust implementation owns behavior |
| `RawSyscall` | 83 | 33% | ABI entrypoint marshals directly to Linux syscalls |
| `GlibcCallThrough` | 49 | 20% | Delegates to host glibc after membrane checks |
